...
export const metadata: Metadata = {
  title: "プライバシーポリシー | 鍵トラブルナビ",
  description: "鍵トラブルナビのプライバシーポリシーです。個人情報の取り扱いについてご説明します。",
};
          ...
          <div className="space-y-8 text-foreground">
            <section>
              <p className="leading-relaxed text-text-muted">
                株式会社MediaX（以下「当社」）は、本ウェブサイト「鍵トラブルナビ」（以下「本サービス」）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」）を定めます。
              </p>
            </section>
