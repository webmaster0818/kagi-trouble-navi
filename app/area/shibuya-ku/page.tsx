...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】渋谷区の鍵開け・鍵交換業者おすすめ5選！終電後の締め出しとスマートロック電池切れの対処も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "渋谷区で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、終電後の締め出しの動き方とスマートロックの電池切れ対策まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】渋谷区の鍵開け・鍵交換業者おすすめ5選！終電後の締め出しとスマートロック電池切れの対処も分かる鍵屋比較",
    description:
      "渋谷区で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。終電後に締め出された夜の入室手段を確保する順番と、スマートロックの電池切れで締め出されないための備えも解説しています。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、渋谷区内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（東京都対応）", note: "東京都対応の一次確認値。渋谷区での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 状況と鍵の種類を整理する",
    b: "「どこで落としたか分からない」場合こそ、立ち寄り先を新しい順に書き出すことから始めましょう。書き出したメモは、店舗・交通機関への問い合わせにも、業者への状況説明にも役立ちます。賃貸の場合は、業者より先に管理会社・大家への連絡が基本です。",
  },
  {
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "締め出しなどの緊急時以外は、2〜3社から見積もりを取って総額・条件を比較するのがおすすめです。今回の5社はいずれも全国対応型で、渋谷区からも依頼できます（対応エリアは「東京都」としての一次確認値のため、詳細条件は各社へ確認を）。金額に納得できない場合は、その場で契約せず一度断る選択肢もあります。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "渋谷区の鍵開け料金の相場はいくらですか？",
  ...
  {
    q: "深夜や早朝でも渋谷区に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。ただし深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「東京都」としての一次確認値のため、渋谷区での詳細は依頼時に各社へご確認ください。",
  },
  {
    q: "終電後に締め出されました。鍵業者を呼ぶ前に確認すべきことはありますか？",
    a: "まず、同居家族や合鍵を預けた相手に連絡できないかを確認しましょう。賃貸の場合は管理会社の緊急窓口が24時間対応していることも多く、業者より先に連絡するのが基本です。それでも入れない場合に24時間受付の鍵業者へ依頼します。依頼時は深夜割増を含めた総額と到着目安を電話で確認し、解錠時には身分証などで居住確認を求められるのが一般的なので手元に用意しておきましょう。",
    link: { href: "/shimedashi/", label: "締め出し時の対処法はこちら" },
  },
  {
    q: "スマートロックの電池が切れて家に入れません。どうすればいいですか？",
    a: "多くのスマートロックには、非常用の物理鍵や外部給電端子などのバックアップ手段が用意されています。まず自分の機種の取扱説明書やメーカー公式サイトでバックアップ手段を確認しましょう。非常用の物理鍵を持っていればそのまま解錠でき、外部給電対応の機種ならモバイルバッテリー等で一時的に起動できる場合があります。どちらも難しければ鍵業者へ相談を。復旧後は、残量通知が出たらすぐ電池交換する運用に切り替えるのが再発防止の近道です。",
    link: { href: "/denshijou-denchigire/", label: "電子錠の電池切れ対処はこちら" },
  },
  {
    q: "深夜に鍵業者を呼ぶと、料金はどのくらい割増になりますか？",
    a: "深夜・早朝の割増の有無や金額は業者ごとに異なり、一律の相場を示すことはできません。当サイトの一次確認値は各社の基本料金（最低価格・目安）で、深夜帯は割増や出張費が加わって総額が変わる場合があります。依頼前の電話で「深夜料金を含めた総額」と到着目安を確認し、納得してから依頼しましょう。",
    link: { href: "/ryokin/", label: "料金相場の詳細はこちら" },
  },
  {
...
export default function AreaShibuyaKuPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】渋谷区の鍵開け・鍵交換業者おすすめ5選！終電後の締め出しとスマートロック電池切れの対処も分かる鍵屋比較",
    description:
      "渋谷区で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "渋谷区の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜渋谷区で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "渋谷区の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#tips", label: "6｜渋谷区で鍵業者を呼ぶ前に確認したいこと（終電後の締め出しとスマートロックの電池切れ対策）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜渋谷区の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">渋谷区の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              「終電で最寄り駅まで帰り着いたのに、ポケットにもかばんにも鍵がない」——飲食や娯楽の場が集まる渋谷区では、深夜の帰宅後に締め出しへ気づくトラブルが典型です。さらに近年は、スマートロックの電池切れによる締め出しという新しいパターンも増えています。どちらも、事前に手順と備えを知っているかどうかで、その夜の過ごし方が大きく変わります。
            </p>
            <p>
              本記事では、渋谷区内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、終電後に締め出されたときの動き方と、スマートロックの電池切れで締め出されないための備えもまとめています。ぜひ鍵業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="top5" num="1">渋谷区で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            渋谷区内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「東京都」としての一次確認値のため、渋谷区での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">渋谷区の鍵業者をとにかく急いで開けてほしいなら</H2>
          ...
          <p className="leading-loose mb-4">
            渋谷区でも、深夜の締め出しや帰宅後に紛失へ気づくトラブルは起こり得ます。この時間帯に頼れるのは24時間受付の業者で、一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、夜間の緊急依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          {/* 6｜区特有 */}
          <H2 id="tips" num="6">渋谷区で鍵業者を呼ぶ前に確認したいこと（終電後の締め出しとスマートロックの電池切れ対策）</H2>
          <p className="leading-loose mb-4">
            終電後の締め出しでまず整理したいのは、<Hl>「今夜どうやって家に入るか」の選択肢の順番</Hl>です。①同居家族や合鍵を預けた相手に連絡する、②賃貸なら管理会社・大家の緊急窓口に連絡する（24時間の緊急ダイヤルを設けている管理会社は少なくありません）、③それでも難しければ24時間受付の鍵業者に依頼する、の順で確保しましょう。深夜に屋外で朝まで待つのは安全面でおすすめできません。業者を呼ぶ場合は、<Hl>深夜割増を含めた総額と到着目安を電話で確認してから</Hl>依頼を（<Link href="/shimedashi/" className="text-primary underline">締め出されたときの対処</Link>）。
          </p>
          <p className="leading-loose mb-4">
            近年増えているのが、<Hl>スマートロックの電池切れによる締め出し</Hl>です。多くの機種は電池残量の低下を事前に通知する仕組みを備え、非常用の物理鍵や外部給電端子などのバックアップ手段も用意されています。最大の予防策は、<Hl>締め出される前に自分の機種のバックアップ手段を確認しておくこと</Hl>。非常用の物理鍵は自宅に保管せず、財布やパスケースなど鍵束と別の場所に1本携行しておくと、機器の電池切れでもスマホの電池切れでも家に入れます（<Link href="/smart-lock/" className="text-primary underline">スマートロックの基礎知識</Link>・<Link href="/denshijou-denchigire/" className="text-primary underline">電子錠の電池切れ対処</Link>）。
          </p>
          <p className="leading-loose mb-4">
            また、オートロック機能つきのスマートロックには、<Hl>「鍵もスマホも持たないゴミ出し」で締め出される典型パターン</Hl>があります。どんな短時間の外出でも解錠手段を持って出ることを習慣化しましょう（<Link href="/autolock-shimedashi-yobou/" className="text-primary underline">オートロック締め出しの予防</Link>）。なお、締め出しで業者に解錠を依頼すると、身分証などによる居住確認を求められるのが一般的です。これは第三者による不正解錠を防ぐためのもので、確認を丁寧に行う業者はむしろ信頼の材料になります。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">渋谷区の鍵業者の失敗しない選び方</H2>
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">渋谷区の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            渋谷区で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝のトラブルならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            終電後の締め出しは、合鍵を預けた相手→管理会社の緊急窓口→24時間受付の鍵業者、の順で入室手段を確保するのが基本です。スマートロック利用者は、バックアップ手段の事前確認・物理鍵の分散携行・残量通知への即応という3つの備えで、締め出しのリスクを大きく減らせます。業者を呼ぶ場合は、深夜料金を含む総額の確認を忘れずに。本記事の一次確認値を出発点に、状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["渋谷区", "東京23区", "鍵開け", "鍵交換", "24時間対応", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-3">
              {[
                ...
                { href: "/area/toshima-ku/", label: "渋谷区の鍵開け・鍵交換業者おすすめ5選" },
                { href: "/area/meguro-ku/", label: "目黒区の鍵開け・鍵交換業者おすすめ5選" },
                { href: "/area/bunkyo-ku/", label: "文京区の鍵開け・鍵交換業者おすすめ5選" },
                { href: "/area/minato-ku/", label: "港区の鍵開け・鍵交換業者おすすめ5選" },
                { href: "/area/chuo-ku/", label: "中央区の鍵開け・鍵交換業者おすすめ5選" },
                { href: "/area/chiyoda-ku/", label: "千代田区の鍵開け・鍵交換業者おすすめ5選" },
                { href: "/area/taito-ku/", label: "台東区の鍵開け・鍵交換業者おすすめ5選" },
                { href: "/area/sumida-ku/", label: "墨田区の鍵開け・鍵交換業者おすすめ5選" },
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/denshijou-denchigire/", label: "電子錠の電池切れ対処" },
                { href: "/autolock-shimedashi-yobou/", label: "オートロック締め出しの予防" },
