...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】平塚市の鍵開け・鍵交換業者おすすめ5選！身分証の住所が今の住まいと違うときの本人確認も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "平塚市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、免許証やマイナンバーカードの住所が今の住まいと違うときに鍵開けを断られないための備えまで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】平塚市の鍵開け・鍵交換業者おすすめ5選！身分証の住所が今の住まいと違うときの本人確認も分かる鍵屋比較",
    description:
      "平塚市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。身分証の住所が今の住まいと違うときの本人確認、代わりになる書類、賃貸での連絡順も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、平塚市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（神奈川県対応）", note: "神奈川県対応の一次確認値。平塚市での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 本人確認に使えるものを電話の前にそろえる",
    b: "身分証（免許証・マイナンバーカード・パスポートなど）に加えて、その住所宛の郵便物、賃貸借契約書、公共料金の領収書や検針票を探しておきます。身分証の住所が今の住まいと違う場合は、その点を電話の最初に伝えてください。何があれば作業できるかは業者ごとに違うため、受付で確認して、用意できるものを玄関前にそろえておくと到着後が早くなります。",
  },
  {
    t: "② 出張費・夜間料金を含めた総額の見積もりを取る",
    b: "広告の「◯◯円〜」は最低価格で、実際は錠の種類・出張距離・時間帯で変わります。本人確認が絡む依頼では、もうひとつ聞いておきたいことがあります。確認が取れずに作業に至らなかった場合、出張費がかかるのかどうかです。見積もり無料・キャンセル無料の業者なら負担は小さくなりますが、扱いは会社ごとに違うので先に確認しましょう。",
  },
  {
    t: "③ 運営会社を確認する",
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "緊急でなければ、2〜3社に同じ事情を伝えて、対応できると答えた業者を選ぶほうが確実です。今回の5社はいずれも全国対応型で、平塚市からも依頼できます（対応エリアは「神奈川県」としての一次確認値のため、詳細条件は各社へ確認を）。住所の食い違いという条件を最初にそろえて伝えれば、受け付ける業者とそうでない業者がはっきり分かれ、到着後に断られる展開を避けられます。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "平塚市の鍵開け料金の相場はいくらですか？",
    a: "当サイトが一次確認した各社の公式表示では、鍵開けの基本料金はカギ110番6,600円〜、鍵のレスキュー8,000円〜、鍵の生活救急車・JBR8,800円〜（いずれも税込）、カギの救急車は公式目安11,000〜44,000円です。ただしこれは最低価格や目安で、鍵の種類（ディンプルキー等）・時間帯・出張距離で総額は変わります。本人確認が取れずに作業に至らなかった場合の出張費の扱いも、あわせて確認しておきましょう。",
    link: { href: "/ryokin/", label: "料金相場の詳細はこちら" },
  },
  {
    q: "免許証の住所が前の家のままです。鍵を開けてもらえますか？",
    a: "多くの業者は、身分証だけでなく、その住所に住んでいることが分かる別の資料と組み合わせて判断します。住所が一致しないという一点だけで必ず断られるわけではありませんが、扱いは業者ごとに違います。到着してから揉めないよう、電話の最初に「身分証の住所が今の家と違う」と伝え、何があれば作業できるかを聞いておくのが確実です。",
  },
  {
    q: "身分証の代わりになるものは何ですか？",
    a: "その住所宛に届いた郵便物、賃貸借契約書、公共料金の領収書や検針票などが使われます。表札やポストの名義、玄関前に届いている宅配便の伝票が補強になることもあります。ただし何を認めるかは業者ごとに違うため、電話の段階で確認してください。用意できるものを玄関前にそろえておくと、到着後の時間が短くなります。",
  },
  {
    q: "引っ越したばかりで郵便物もありません。どうすればいいですか？",
    a: "賃貸なら、管理会社や大家に連絡するのが一番早い方法です。入居者名簿で本人確認ができるうえ、スペアキーを預かっている物件なら業者を呼ばずに済むこともあります。契約書の控えがスマートフォンの中にあれば、それを見せて対応できる場合もあります。分譲や持ち家で書類が家の中にしかないときは、その事情も含めて受付に相談してください。",
    link: { href: "/chintai-kagi-koukan-hiyou/", label: "賃貸の鍵まわりの費用はこちら" },
  },
  {
    q: "実家や家族の家の鍵を開けてもらうことはできますか？",
    a: "できる場合がありますが、条件が付きます。名義人（契約者・所有者）に電話口で確認を取れるか、名義人が立ち会えるかが分かれ目です。連絡が取れない事情があるなら、その事情も含めて受付の段階で相談してください。作業後に「頼んでいない」と言われる事態を避けるため、業者側も慎重に確認します。事前に相談しておけば、必要な段取りを教えてもらえます。",
    link: { href: "/kagi-funshitsu/", label: "鍵をなくしたときの対処はこちら" },
  },
  {
    q: "深夜や早朝でも平塚市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「神奈川県」としての一次確認値のため、平塚市での詳細は依頼時に各社へご確認ください。",
  },
];
...
export default function AreaPageHiratsuka() {
  const articleSchema = {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "平塚市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜平塚市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "平塚市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#hiratsuka-tips", label: "6｜平塚市で鍵業者を呼ぶ前に確認したいこと（身分証の住所が今の住まいと違うときの本人確認）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜平塚市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">平塚市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <header className="grid gap-4">
            ...
            <ul className="flex flex-wrap gap-2">
              {["平塚市", "本人確認", "身分証の住所", "引っ越し直後", "業者比較"].map((t) => (
                <li
                  key={t}
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              平塚市は神奈川県の中南部、相模湾に面したまちです。相模川の河口に広がる市街地に住宅地が連なり、東海道線で都心へ通う人も、市内や近隣の事業所へ通う人もいます。転入や転出のある暮らしでは、免許証やマイナンバーカードに書かれた住所が、いま住んでいる家と違ったままになっている期間が生まれます。ふだんは困らないこの食い違いが、鍵を開けてもらう場面ではそのまま足止めの原因になります。
            </p>
            <p>
              本記事では、平塚市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、鍵業者が到着したときに求められる本人確認について、身分証の住所が今の住まいと違う場合に何を用意し、電話の段階で何を伝えておけばよいかを整理しています。
            </p>
          </div>
          ...
          {/* 1｜業者一覧 */}
          <H2 id="top5" num="1">平塚市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            平塚市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「神奈川県」としての一次確認値のため、平塚市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※近隣エリアの比較は<Link href="/area/fujisawa/" className="text-primary underline">藤沢市版</Link>・<Link href="/area/chigasaki/" className="text-primary underline">茅ヶ崎市版</Link>・<Link href="/area/atsugi/" className="text-primary underline">厚木市版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">平塚市の鍵業者をとにかく急いで開けてほしいなら</H2>
          <p className="leading-loose mb-4">
            鍵が開かない状態は、扉の前で待っている時間がそのまま積み上がります。ただし、急いで呼んだ業者が到着してから本人確認で止まると、その時間はまるごと無駄になります。駆けつけスピードの目安を公表している業者としては、<Hl>鍵の生活救急車が最短15分の駆けつけと全国約2,270店の拠点網</Hl>をうたっており、拠点数の多さは到着スピードの裏付けになります。また、<Hl>カギ110番は電話一本で最短5分の手配</Hl>（全国47都道府県の加盟店ネットワークから近隣の業者を手配）を掲げています。
          </p>
          ...
          <p className="leading-loose mb-4">
            家に入れないまま夜を越すかどうかは、早い時間に決めたい判断です。夜間は管理会社の窓口が閉まっていることが多く、本人確認の裏取りを頼める相手が減ります。身分証の住所が違う場合ほど、明るいうちに動いたほうが選択肢が残ります。一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、遅い時間の依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          <p className="leading-loose mb-4">
            出張してもらったのに本人確認が通らず作業に至らなかった場合、出張費だけが残るのかどうかは業者によって扱いが違います。ここを電話で確認できるかどうかが効いてきます。<Hl>鍵のレスキューは料金をホームページで明示し、現場での追加費用がない</Hl>と掲げています（鍵開け8,000円〜＋出張料0円〜8,800円）。また、<Hl>鍵の生活救急車は出張・見積もり・キャンセルが無料</Hl>のため、提示された金額を見てから依頼するかどうかを判断できます。
          </p>
          <p className="leading-loose mb-4">
          ...
          <p className="leading-loose mb-4">
            鍵業者には、依頼を受けて加盟店を手配する「紹介型」と、自社のスタッフが直接対応する「自社対応型」があります。紹介型は対応範囲が広い一方、店舗によって技術・対応に差が出ることがあります。今回の紹介では、<Hl>鍵のレスキューが全国約20拠点を自社社員で対応する自社対応型</Hl>で、女性スタッフの指名にも対応しています。本人確認の運用は会社の方針で決まる部分が大きいため、受付で聞いた内容が現場でそのまま通るかどうかは、受付と現場が同じ会社かどうかにも左右されます。紹介型に頼むときは、受付で確認した条件を現場の担当にも伝わるようにしておくと行き違いが減ります。
          </p>

          {/* 6｜エリア特有 */}
          <H2 id="hiratsuka-tips" num="6">平塚市で鍵業者を呼ぶ前に確認したいこと（身分証の住所が今の住まいと違うときの本人確認）</H2>
          <p className="leading-loose mb-4">
            鍵開けは、扉を開ける技術の話であると同時に、<Hl>その家に入る権利がある人かどうかを確かめてから作業する</Hl>仕事です。誰にでも開けてしまえば、空き巣の道具と変わらなくなります。そのため多くの業者が、作業の前に身分証の提示を求め、そこに書かれた住所と作業場所が一致するかを見ます。ここで止まりやすいのが、引っ越して間もない人、単身赴任や下宿で住民票を移していない人、実家から出たばかりの人です。免許証やマイナンバーカードの住所が前の家のままだと、一致の確認ができません。裏を返せば、本人確認をまったくしない業者は、第三者にも同じように開けてしまうということでもあります。業者の見分け方は<Link href="/kagishi-shikaku/" className="text-primary underline">鍵屋の資格と見分け方</Link>で扱っています。
          </p>
          <p className="leading-loose mb-4">
            住所が一致しないときに代わりになるのは、<Hl>その住所宛に届いた郵便物、賃貸借契約書、公共料金の領収書や検針票、管理会社の連絡先</Hl>です。表札やポストの名義、玄関前の宅配便の伝票が使えることもあります。ただし、何を認めるかは業者ごとに違います。だからこそ、現場で揉めるより、電話の段階で「身分証の住所が今の家と違う」と先に言ってしまうのが確実です。そのうえで、何があれば作業できるのかを聞き、用意できるものを玄関前にそろえておく。到着してから探し始めると、そのぶん時間も出張の拘束時間も延びます。締め出し全般の動き方は<Link href="/shimedashi/" className="text-primary underline">締め出されたときの対処</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4">
            借りている住まいなら、業者より先に管理会社・大家へ連絡するほうが早いことがあります。<Hl>管理会社がスペアキーを預かっている物件では、開けてもらうだけで済み、費用もかかりません</Hl>。管理会社が指定の業者を持っている場合もあり、そちらに頼めば本人確認は入居者名簿で済みます。費用の負担者も、貸主側の都合で交換が必要になるのか、入居者の紛失なのかで変わります。夜間の緊急連絡先が契約書に書かれていることが多いので、まずそこを見てください。入居・退去に絡む鍵の扱いは<Link href="/taikyo-kagi-trouble/" className="text-primary underline">退去時の鍵トラブル</Link>、費用の考え方は<Link href="/chintai-kagi-koukan-hiyou/" className="text-primary underline">賃貸の鍵交換費用</Link>で整理しています。
          </p>
          <p className="leading-loose mb-4">
            自分以外の家を開けてもらう場合は、もう一段むずかしくなります。実家や親族の家、家族が住む部屋を、名義人でない人が呼んで開けてもらう形です。この場合は、<Hl>名義人に電話口で確認を取ってもらえるか、名義人が立ち会えるか</Hl>が分かれ目になります。電話がつながらない、本人が入院中といった事情があるなら、その事情も含めて受付の段階で相談してください。作業後に「頼んでいない」と言われる展開を避けるため、業者側も慎重になります。引っ越しの前後で住所と身分証をそろえる段取りは<Link href="/hikkoshi-kagi-checklist/" className="text-primary underline">引っ越しの鍵チェックリスト</Link>、なくした鍵そのものの扱いは<Link href="/kagi-funshitsu/" className="text-primary underline">鍵をなくしたときの対処</Link>で扱っています。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">平塚市の鍵業者の失敗しない選び方</H2>
          <p className="leading-loose mb-6">
            鍵業者選びで後悔しないためには、次の4つのステップを踏むことが大切です。本人確認が絡む依頼では、先に伝えておくかどうかで到着後の流れがまるごと変わります。
          </p>
          {steps.map((s) => (
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">平塚市の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            平塚市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝の受付ならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            鍵開けは、扉を開ける前に「入る権利がある人か」を確かめる仕事です。身分証の住所が今の住まいと違うなら、電話の最初にそう伝える。郵便物・契約書・検針票など代わりになるものを玄関前にそろえておく。賃貸なら管理会社・大家に先に連絡する。家族の家なら名義人の確認を取れる段取りをつけておく。この4つを押さえたうえで、本記事の一次確認値を出発点に、目的と予算に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["平塚市", "本人確認書類", "住所が違う身分証", "賃貸の連絡順", "鍵開け", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/hikkoshi-kagi-checklist/", label: "引っ越しの鍵チェックリスト" },
                { href: "/shimedashi/", label: "締め出されたときの対処" },
                { href: "/kagishi-shikaku/", label: "鍵屋の資格と見分け方" },
              ].map((l) => (
                <li key={l.href}>
                  <Link
                    href={l.href}
