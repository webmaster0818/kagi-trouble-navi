...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】柏市の鍵開け・鍵交換業者おすすめ5選！同居人が入れ替わるときの鍵の回収と交換判断・費用の分担も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "柏市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、ルームシェアや二人暮らしで同居人が出ていくときの鍵の回収・交換の判断、賃貸での手続きと費用の分担まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】柏市の鍵開け・鍵交換業者おすすめ5選！同居人が入れ替わるときの鍵の回収と交換判断・費用の分担も分かる鍵屋比較",
    description:
      "柏市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。同居人が入れ替わるときの鍵の回収と交換の判断、賃貸での手続きと費用の分担の決め方も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、柏市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（千葉県対応）", note: "千葉県対応の一次確認値。柏市での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 対象と契約の形を整理する",
    b: "まず、交換したいのが玄関の錠なのか、部屋ごとの錠なのかをはっきりさせます。次に、そこが賃貸か持ち家か、賃貸なら契約の名義が誰かを確認します。名義人と実際に住んでいる人が違う場合、手続きの相手が変わります。錠のメーカー名・型番は扉側面の金属プレートで確認でき、鍵の形（刻みキーかディンプルキーか）とあわせて伝えると話が早く進みます。",
  },
  {
    t: "② 出張費・夜間料金を含めた総額の見積もりを取る",
    b: "広告の「◯◯円〜」は最低価格で、実際は錠の種類・出張距離・時間帯で変わります。費用を分担する相談をするなら、総額が確定していないと話が進みません。見積もり無料・キャンセル無料の業者なら、金額を出してもらってから依頼するかどうかを決められます。",
  },
  {
    t: "③ 運営会社を確認する",
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "同居人の入れ替わりに合わせた交換は日程に余裕を持てる依頼なので、2〜3社から見積もりを取って総額・提案内容を比較する価値があります。今回の5社はいずれも全国対応型で、柏市からも依頼できます（対応エリアは「千葉県」としての一次確認値のため、詳細条件は各社へ確認を）。メーカー名・型番を同じ条件で伝えれば、取り扱いの可否と金額の差が見えやすくなります。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "柏市の鍵開け料金の相場はいくらですか？",
  ...
  {
    q: "同居人が出ていきます。鍵は交換したほうがいいですか？",
    a: "鍵を返してもらえたかどうかだけでは判断できません。合鍵は本人が返した本数のほかに作られている可能性があり、それを確かめる方法はないためです。関係が円満で本人が「作っていない」と言っている場合でも、その人が友人や家族に渡した1本があったかどうかまでは分かりません。不安が残るなら交換、そうでなければ当面はそのまま、という判断になりますが、賃貸では自分だけで決められない点に注意してください。",
    link: { href: "/kagi-koukan-timing/", label: "鍵交換のタイミングはこちら" },
  },
  {
    q: "賃貸で勝手に鍵を交換してもいいですか？",
    a: "借りている住まいの錠は貸主の所有物なので、入居者の判断だけで交換することはできません。管理会社・貸主に事情を伝え、交換してよいか、業者を自分で手配してよいか、退去時に元の錠へ戻す必要があるかを確認してください。無断で交換すると、退去時の原状回復や鍵の返却本数で問題になることがあります。",
    link: { href: "/chintai-kagi-koukan-hiyou/", label: "賃貸の鍵交換費用はこちら" },
  },
  {
    q: "交換費用は、出ていく人と残る人のどちらが払いますか？",
    a: "決まりはなく、当事者間の取り決めになります。契約の名義人が残るのか出ていくのか、交換したい理由が相手側の事情によるものかどうかで、納得しやすい分け方は変わります。話がまとまらないまま作業を先に入れると、あとで揉めやすくなります。総額の見積もりを出してもらい、どちらがいくら持つかを書き残してから頼むほうが確実です。",
    link: { href: "/ryokin/", label: "料金相場の詳細はこちら" },
  },
  {
    q: "鍵を返してもらえないまま連絡がつきません。",
    a: "賃貸なら、まず管理会社・貸主に状況を伝えてください。鍵が回収できていないことは貸主側にとっても管理上の問題で、交換の相談に応じてもらえる場合があります。持ち家で、身の安全に関わる心配があるときは、鍵の話として抱え込まず、警察や自治体の相談窓口に相談することを優先してください。",
    link: { href: "/taikyo-kagi-trouble/", label: "退去時の鍵トラブルはこちら" },
  },
  {
    q: "深夜や早朝でも柏市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「千葉県」としての一次確認値のため、柏市での詳細は依頼時に各社へご確認ください。",
  },
];
...
export default function AreaPageKashiwa() {
  const articleSchema = {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "柏市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜柏市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "柏市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#kashiwa-tips", label: "6｜柏市で鍵業者を呼ぶ前に確認したいこと（同居人が入れ替わるときの鍵は、出ていく日より前に決めておく）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜柏市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">柏市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <header className="grid gap-4">
            ...
            <ul className="flex flex-wrap gap-2">
              {["柏市", "ルームシェア", "同居人の鍵", "賃貸の鍵交換", "業者比較"].map((t) => (
                <li
                  key={t}
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              柏市は千葉県の北西部にあり、JR常磐線とつくばエクスプレスが通る柏駅の周りに商業地が、その周囲に住宅地が広がるまちです。都心にも県内の職場にも通いやすい立地から進学や就職での転入・転出が多く、ルームシェアや二人暮らしといった、家族以外と同じ家に住む形も珍しくありません。人が入れ替わるとき、いちばん後回しになりやすいのが鍵の扱いです。
            </p>
            <p>
              本記事では、柏市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、同居人が出ていくときに鍵をどう回収し、交換するかどうかをどう決め、費用を誰が持つのかを整理しています。
            </p>
          </div>
          ...
          {/* 1｜業者一覧 */}
          <H2 id="top5" num="1">柏市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            柏市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「千葉県」としての一次確認値のため、柏市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※近隣エリアの比較は<Link href="/area/matsudo/" className="text-primary underline">松戸市版</Link>・<Link href="/area/funabashi/" className="text-primary underline">船橋市版</Link>・<Link href="/area/chiba/" className="text-primary underline">千葉版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">柏市の鍵業者をとにかく急いで開けてほしいなら</H2>
          <p className="leading-loose mb-4">
            家に入れない状態は、同居している相手の帰りを待てば解決することもあれば、相手も持っていないと分かって振り出しに戻ることもあります。連絡がつかないまま外で粘るより、早い段階で手配したほうが結果的に短く済みます。駆けつけスピードの目安を公表している業者としては、<Hl>鍵の生活救急車が最短15分の駆けつけと全国約2,270店の拠点網</Hl>をうたっており、拠点数の多さは到着スピードの裏付けになります。また、<Hl>カギ110番は電話一本で最短5分の手配</Hl>（全国47都道府県の加盟店ネットワークから近隣の業者を手配）を掲げています。
          </p>
          ...
          <p className="leading-loose mb-4">
            深夜に家に入れないとき、同居している相手を起こすかどうかで迷う人は少なくありません。相手も鍵を持っていないと分かっている場合や、すでに引き払ったあとであれば、その夜のうちに手配するほうが早く片づきます。一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、遅い時間の依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          <p className="leading-loose mb-4">
            鍵の交換は、誰が費用を持つかを決めてから頼む作業です。出ていく人と残る人のどちらが払うのかを話し合う前提として、総額がいくらになるのかを先に示してもらう必要があります。<Hl>鍵のレスキューは料金をホームページで明示し、現場での追加費用がない</Hl>と掲げています（鍵開け8,000円〜＋出張料0円〜8,800円）。また、<Hl>鍵の生活救急車は出張・見積もり・キャンセルが無料</Hl>のため、提示された金額を見てから依頼するかどうかを判断できます。
          </p>
          <p className="leading-loose mb-4">
          ...
          <p className="leading-loose mb-4">
            鍵業者には、依頼を受けて加盟店を手配する「紹介型」と、自社のスタッフが直接対応する「自社対応型」があります。紹介型は対応範囲が広い一方、店舗によって技術・対応に差が出ることがあります。今回の紹介では、<Hl>鍵のレスキューが全国約20拠点を自社社員で対応する自社対応型</Hl>で、女性スタッフの指名にも対応しています。同居人の入れ替わりに合わせた交換は日程を決めて頼む作業になるため、依頼時に「自社スタッフか協力店か」とあわせて、希望する日に作業できるかも確認してみましょう。
          </p>

          {/* 6｜エリア特有 */}
          <H2 id="kashiwa-tips" num="6">柏市で鍵業者を呼ぶ前に確認したいこと（同居人が入れ替わるときの鍵は、出ていく日より前に決めておく）</H2>
          <p className="leading-loose mb-4">
            家族以外と住む家では、<Hl>鍵は「何本あるか」ではなく「誰が持っているか」で管理する</Hl>ものになります。入居のときに渡された本数、あとから作った合鍵、実家や交際相手に預けた1本。同居人が入れ替わるタイミングは、この全体像を作り直せる数少ない機会です。出ていく日が決まったら、その日より前に「返してもらう本数」を双方で確認しておきましょう。当日にまとめて渡す約束にすると、引っ越しのあわただしさで抜けが出ます。合鍵の考え方は<Link href="/aikagi/" className="text-primary underline">合鍵の作り方と考え方</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4">
            迷いやすいのが、<Hl>鍵が返ってきたら交換しなくてよいのか</Hl>という点です。返された本数が合っていても、その人が合鍵を作っていたかどうかを確かめる方法はありません。円満に出ていく場合でも、その人が友人や家族に渡した1本があるかもしれない、という可能性は残ります。不安が残るなら交換する、当面はそのままにしておくという判断は人それぞれですが、材料は「本数が合ったか」ではなく「鍵が渡った範囲が分かるか」に置いたほうが実態に合います。替えどきの目安は<Link href="/kagi-koukan-timing/" className="text-primary underline">鍵交換のタイミング</Link>で扱っています。
          </p>
          <p className="leading-loose mb-4">
            賃貸では、そもそも<Hl>入居者の判断だけで錠を交換することはできません</Hl>。借りている住まいの錠は貸主の所有物だからです。交換したい事情があるなら、管理会社・貸主に伝えて、交換してよいか、業者は自分で手配してよいか、退去時に元へ戻す必要があるかを先に決めてください。契約の名義人が出ていく側で、残る人が住み続ける場合は、名義の変更や再契約が必要になることもあります。鍵の話と契約の話は同時に片づけておくと二度手間になりません。費用の考え方は<Link href="/chintai-kagi-koukan-hiyou/" className="text-primary underline">賃貸の鍵交換費用</Link>、退去時の扱いは<Link href="/taikyo-kagi-trouble/" className="text-primary underline">退去時の鍵トラブル</Link>で解説しています。
          </p>
          <p className="leading-loose mb-4">
            費用をどちらが持つかは、<Hl>作業を頼む前に決めて書き残しておく</Hl>のが安全です。総額の見積もりを取り、出ていく側と残る側でいくらずつ負担するのかを合意してから作業に進めば、あとで請求の話がこじれにくくなります。番号式の錠やスマートロックを使っている家なら、錠そのものを替えなくても、番号の変更や利用権限の取り消しで足りることがあります。そのぶん費用も時間もかかりません。仕組みは<Link href="/smart-lock/" className="text-primary underline">スマートロックの解説</Link>で整理しています。なお、鍵を返してもらえないまま連絡がつかない、身の安全に不安があるといった場合は、鍵の問題として抱え込まず、管理会社や警察・自治体の相談窓口に相談することを優先してください。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">柏市の鍵業者の失敗しない選び方</H2>
          <p className="leading-loose mb-6">
            鍵業者選びで後悔しないためには、次の4つのステップを踏むことが大切です。同居人の入れ替わりに伴う交換は、契約の名義や費用の分担が絡むぶん、伝える情報と決めておくことの精度が結果を左右します。
          </p>
          {steps.map((s) => (
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">柏市の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            柏市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝の受付ならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            家族以外と住む家の鍵は、本数ではなく「誰に渡ったか」で管理するものです。出ていく日より前に返す本数を決めておく、返ってきても渡った範囲が分からないなら交換を検討する、賃貸なら管理会社・貸主への確認が先、費用の分担は作業前に書き残す。この4つを押さえておけば、入れ替わりの前後で困ることが減ります。そのうえで、本記事の一次確認値を出発点に、目的と予算に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["柏市", "同居人の入れ替わり", "合鍵の回収", "賃貸の鍵交換", "費用の分担", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/smart-lock/", label: "スマートロックの解説" },
