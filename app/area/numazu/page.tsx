...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】沼津市の鍵開け・鍵交換業者おすすめ5選！海や川のあとで鍵が水にぬれた・落ちたときの扱いも分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "沼津市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、海や川で過ごしたあとに鍵が水にぬれたときの扱いと、水に落として見つからないときの動き方まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】沼津市の鍵開け・鍵交換業者おすすめ5選！海や川のあとで鍵が水にぬれた・落ちたときの扱いも分かる鍵屋比較",
    description:
      "沼津市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。海や川で過ごしたあとに鍵が水にぬれたときの扱いと、水に落として見つからないときの動き方も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、沼津市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
...
const steps = [
  {
    t: "① 状況と鍵の種類を整理する",
    b: "「水にぬれた」「水に落とした」「回らない」「なくした」など状況と、車・玄関・物置といった対象、金属の鍵か電子キーかをメモしておくと、電話での見積もり精度が上がります。車の鍵の場合は車種・年式も聞かれることが多いため、車検証を手元に用意しておくとスムーズです。賃貸住まいで家の鍵のトラブルなら、業者より先に管理会社・大家への連絡が基本です。",
  },
  {
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "締め出しなどの緊急時以外は、2〜3社から見積もりを取って総額・条件を比較するのがおすすめです。水に落として見つからない鍵の交換のように、その日のうちに開ける必要がない依頼なら、総額と条件を比べる余地があります。今回の5社はいずれも全国対応型で沼津市から依頼できます。金額に納得できない場合は、その場で契約せず一度断る選択肢もあります。",
  },
];

const faqs = [
  {
    q: "沼津市の鍵開け料金の相場はいくらですか？",
  ...
  {
    q: "深夜や早朝でも沼津市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。ただし深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「静岡県」としての一次確認値のため、沼津市での詳細な対応可否は依頼時にご確認ください。",
  },
  {
    q: "海水や雨でぬれた鍵は、そのまま使っても大丈夫ですか？",
    a: "ぬれたまま鍵穴に差すと、水分や砂を錠の内部へ持ち込むことになります。持ち帰ったら乾いた布で水気を拭き、溝の中まで乾かしてから使いましょう。動きが重いと感じても、一般的な機械油や食用油を差すのは避けてください。ほこりを抱き込んで、かえって動きが悪くなることがあります。乾かしても回りにくさが残る場合は、無理に回さず点検を依頼してください。力任せに回すと鍵が折れ、解錠だけで済んだはずの作業が広がります。",
  },
  {
    q: "スマートキーが水にぬれました。どうすればいいですか？",
    a: "ぬれた直後は動いても、あとから反応しなくなることがあります。自分で分解したり、ドライヤーの熱風で乾かしたりする方法は内部の部品を傷める恐れがあるため避け、まずは取扱説明書の記載を確認してください。判断がつかないときは、メーカーや取り扱い店に相談するのが確実です。あわせて、スマートキーに内蔵されたメカニカルキーでドアを開ける手順を平時に確かめておくと、反応しなくなった場面でも動けます。",
  },
  {
    q: "海や川に鍵を落として見つかりません。何から動けばいいですか？",
    a: "水の中に落ちた鍵は探し直すのが難しいため、見つからない前提で考えるほうが現実的です。まず、今日家に入る手段と帰る手段があるかを確かめます。車の鍵ならスペアキーの所在、家の鍵なら賃貸か持ち家かで連絡先が変わり、賃貸なら業者より先に管理会社・大家へ連絡します。住所の分かるものと一緒になくした場合は、解錠だけで終えるか交換まで進めるかもあわせて相談しましょう。",
  },
  {
...
export default function AreaNumazuPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】沼津市の鍵開け・鍵交換業者おすすめ5選！海や川のあとで鍵が水にぬれた・落ちたときの扱いも分かる鍵屋比較",
    description:
      "沼津市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "沼津市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#numazu5",
      label: "1｜沼津市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "沼津市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#numazu-tips", label: "6｜沼津市で鍵業者を呼ぶ前に確認したいこと（水にぬれた鍵・水に落とした鍵の扱い）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜沼津市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">沼津市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              「釣りから帰って上着のポケットを探ったら、鍵が海水でびしょぬれになっていた」「岸壁で鍵を落とした音がしたのに、どこにも見当たらない」——港や川、海辺で過ごす時間が暮らしの近くにある沼津市では、鍵が水にぬれる、水の中に落ちるという場面が起こり得ます。ぬれた鍵をそのまま使い続けると鍵穴の中へ水分や砂を運び込むことになり、水に落ちた鍵は探し出すのが難しく、見つからない前提で動いたほうが早く片が付きます。
            </p>
            <p>
              本記事では、沼津市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、水にぬれた鍵や電子キーの扱いと、水に落として回収できないときに何から動くかを整理しています。ぜひ鍵業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="numazu5" num="1">沼津市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            沼津市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「静岡県」としての一次確認値のため、沼津市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※他の都市の比較は、<Link href="/area/shizuoka/" className="text-primary underline">沼津市版</Link>・<Link href="/area/hamamatsu/" className="text-primary underline">浜松版</Link>・<Link href="/area/fuji/" className="text-primary underline">富士市版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">沼津市の鍵業者をとにかく急いで開けてほしいなら</H2>
          ...
          <p className="leading-loose mb-4">
            帰省中の夜に実家で締め出される、深夜の帰宅時に鍵がないと気づく——鍵トラブルは時間帯を選びません。深夜・早朝に頼れるのは24時間受付の業者で、一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、夜間の緊急依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          {/* 6｜エリア特有 */}
          <H2 id="numazu-tips" num="6">沼津市で鍵業者を呼ぶ前に確認したいこと（水にぬれた鍵・水に落とした鍵の扱い）</H2>
          <p className="leading-loose mb-4">
            金属の鍵が水にぬれたときは、<Hl>ぬれたまま鍵穴に差さないこと</Hl>が基本です。鍵に付いた水分は、そのまま錠の内部へ運ばれます。海水や砂を浴びたあとなら、細かい砂粒も一緒に入り込みます。持ち帰ったら乾いた布で水気を拭き、溝の中まで乾かしてから使いましょう。動きが重く感じても、<Hl>一般的な機械油や食用油を差すのは避けてください</Hl>。ほこりを抱き込んで、かえって動きが悪くなることがあります。乾かしても回りにくさが残るなら、無理に回さず点検を依頼するのが安全です。症状の切り分けは<Link href="/kagi-mawaranai/" className="text-primary underline">鍵が回らないときの対処法</Link>、交換の目安は<Link href="/kagi-jumyou/" className="text-primary underline">鍵の寿命の解説記事</Link>で扱っています。
          </p>
          <p className="leading-loose mb-4">
            電子キー・スマートキー・リモコンキーは、<Hl>ぬれた直後は動いても、あとから反応しなくなることがある</Hl>と考えて扱うのが無難です。自分で分解する、ドライヤーの熱風で乾かすといった方法は、内部の部品を傷める恐れがあります。防水をうたう製品でも条件があるため、まずは取扱説明書の記載を確認し、判断がつかないときはメーカーや取り扱い店に相談してください。あわせて、<Hl>スマートキーに内蔵されたメカニカルキーでドアを開ける手順</Hl>を平時に確かめておくと、反応しなくなった場面で慌てずに済みます。手順の考え方は<Link href="/smart-key-denchi/" className="text-primary underline">スマートキーの電池切れ対処法</Link>、車の鍵の仕組みは<Link href="/immobilizer/" className="text-primary underline">イモビライザーの解説記事</Link>をご覧ください。
          </p>
          <p className="leading-loose mb-4">
            水の中に落としてしまった鍵は、<Hl>見つからない前提で次の手を決める</Hl>ほうが結果的に早く動けます。岸壁や川底に落ちた鍵は、陸の上で落としたときのように順路をたどって探し直すことができません。その場で決めたいのは、今日家に入る手段があるか、帰る手段があるかの2点です。車の鍵なら、スペアキーが自宅にあるか、誰かに届けてもらえるかを先に確かめてください。備えの考え方は<Link href="/kuruma-spare-key/" className="text-primary underline">車のスペアキー作成の解説</Link>と<Link href="/junsei-key-saihakkou/" className="text-primary underline">純正キー再発行の解説</Link>にまとめています。賃貸にお住まいなら、家の鍵は業者より先に管理会社・大家へ連絡するのが基本です。初動の流れは<Link href="/kagi-funshitsu/" className="text-primary underline">鍵をなくしたときの対処</Link>で確認できます。
          </p>
          <p className="leading-loose mb-4">
            出かける前にできる備えもあります。鍵を上着のポケットに直接入れず、<Hl>ジッパー付きの袋や防水のケースにまとめ、落としても水に入らない位置に留めておく</Hl>だけで、ぬれる場面と落とす場面の両方が減ります。車体のバンパー裏やタイヤまわりに鍵を隠す方法は、第三者に見つけられる前提で考えると避けたい選択です。複数人で出かけるなら、鍵を持つ人を決めて手渡しの回数を減らすほうが、取り落としが起きにくくなります。なくした鍵に住所の分かるものが付いていた場合は、解錠だけで終えるか交換まで進めるかという判断が加わります。目安は<Link href="/kagi-koukan-timing/" className="text-primary underline">鍵交換のタイミング</Link>で解説しています。
          </p>


          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">沼津市の鍵業者の失敗しない選び方</H2>
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">沼津市の鍵業者でよくある質問</H2>
                ...
                <p className="flex gap-3 px-5 py-4 text-sm leading-relaxed">
                  ...
                  <span>
                    ...
                    {f.q.includes("ぬれた鍵") && (
                      <>
                        {" "}
                        <Link href="/kagi-mawaranai/" className="text-primary underline">鍵が回らないときの対処法はこちら</Link>
                      </>
                    )}
                    {f.q.includes("スマートキー") && (
                      <>
          ...
          <p className="leading-loose mb-4">
            沼津市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝のトラブルならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            水にぬれた鍵は乾かしてから使う、電子キーは自分で分解せず取扱説明書とメーカーの案内に従う、水に落とした鍵は見つからない前提で今日の手段から決める。この3つを押さえておけば、海や川で過ごしたあとの鍵のトラブルでも順番を間違えずに動けます。依頼時は作業前に総額の見積もりを確認することが失敗しないための共通ルールです。本記事の一次確認値を出発点に、状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["沼津市", "ぬれた鍵", "鍵の紛失", "鍵開け", "鍵交換", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-3">
              {[
                ...
                { href: "/area/fuji/", label: "富士市の鍵開け・鍵交換業者おすすめ5選" },
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/kuruma-spare-key/", label: "車のスペアキー作成" },
