...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】川越市の鍵開け・鍵交換業者おすすめ5選！古い戸建ての引き戸や勝手口の錠を替えるときの防犯性の考え方も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "川越市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、古い戸建ての引き戸や勝手口に付いた昔の錠前を替えるとき、防犯性をどう考え業者に何を伝えればよいかまで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】川越市の鍵開け・鍵交換業者おすすめ5選！古い戸建ての引き戸や勝手口の錠を替えるときの防犯性の考え方も分かる鍵屋比較",
    description:
      "川越市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。古い戸建ての引き戸や勝手口の錠を替えるときの防犯性の考え方と、業者に伝えておきたい情報も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、川越市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（埼玉県対応）", note: "埼玉県対応の一次確認値。川越市での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 状況と鍵の種類を整理する",
    b: "「開かない」「なくした」のか、それとも古い錠前を防犯目的で替えたいのかを整理してから電話しましょう。交換であれば、玄関が開き戸か引き戸か、勝手口の扉の材質は何か、扉の厚みはどれくらいかを把握しておくと話が早く進みます。扉側面の金属プレートに刻印された錠前のメーカー名・型番と、必要な鍵の本数も控えておきましょう。親の家など自分名義でない住まいなら、所有者と相談したうえで進めるのが基本です。",
  },
  {
    t: "② 出張費・夜間料金を含めた総額の見積もりを取る",
    b: "広告の「◯◯円〜」は最低価格で、実際は鍵の種類・出張距離・時間帯で変わります。鍵交換は作業費に加えて錠前やシリンダーの部材費がかかり、防犯性の高い製品ほど部材費は上がります。古い錠前は後継品がなく、扉の加工が必要になることもあるため、作業前に出張費・部材費・加工費まで含めた総額を必ず確認しましょう。見積もり無料・キャンセル無料の業者なら、金額を見てから断ることもできます。",
  },
  {
    t: "③ 運営会社を確認する",
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "防犯目的の交換は日程に余裕があることが多いため、2〜3社から見積もりを取って総額・提案内容を比較する価値があります。同じ扉の写真と寸法を伝えれば、提案される錠前の違いと金額の差が見えやすくなります。今回の5社はいずれも全国対応型で、川越市からも依頼できます（対応エリアは「埼玉県」としての一次確認値のため、詳細条件は各社へ確認を）。金額に納得できなければ、その場で断る選択肢も残しておきましょう。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "川越市の鍵開け料金の相場はいくらですか？",
    a: "当サイトが一次確認した各社の公式表示では、鍵開けの基本料金はカギ110番6,600円〜、鍵のレスキュー8,000円〜、鍵の生活救急車・JBR8,800円〜（いずれも税込）、カギの救急車は公式目安11,000〜44,000円です。ただしこれは最低価格や目安で、鍵の種類（ディンプルキー等）・時間帯・出張距離で総額は変わります。交換まで進める場合は錠前の部材費が別途かかるため、作業前に総額の見積もりを取りましょう。",
    link: { href: "/ryokin/", label: "料金相場の詳細はこちら" },
  },
  {
    q: "玄関が引き戸です。引き戸の鍵も交換できますか？",
    a: "引き戸の錠も交換できます。引き違い戸の中央に付く召し合わせ錠や、戸の端に付く戸先錠など、開き戸とは構造が異なるため、引き戸用の製品から選ぶことになります。引き戸用の錠にも防犯性を高めた製品はあり、既存の錠と寸法が合う後継品があるかどうかで工事の手間が変わります。扉の厚みと既存の錠のメーカー名・型番を伝えると、見積もりの精度が上がります。",
    link: { href: "/hikido-kagi/", label: "引き戸の鍵の詳細はこちら" },
  },
  {
    q: "玄関の鍵は替えましたが、勝手口は古いままです。替えたほうがいいですか？",
    a: "玄関だけ防犯性を上げても、勝手口や窓が古いままだと、そちらが弱点として残ります。勝手口は人目に付きにくい位置にあることが多く、防犯の面では玄関と同じかそれ以上に気を配りたい場所です。錠の交換だけでなく、補助錠を足して二重にする方法もあります。家全体でどこが弱いかを見たうえで、優先順位を決めるのがおすすめです。",
    link: { href: "/katteguchi-mado-bouhan/", label: "勝手口・窓の防犯はこちら" },
  },
  {
    q: "昔からの錠前をそのまま使い続けても問題ありませんか？",
    a: "開け閉めに支障がなければ使い続けること自体はできますが、古い錠前は現在の防犯性能の基準と差が出ていることがあります。鍵の種類が単純なものや、部品が摩耗して動きが渋くなっているものは、不調と防犯の両面から交換を検討する材料になります。目安として、CPマークの付いた製品やディンプルキーなど、防犯性の目安が示された製品から選ぶと判断しやすくなります。",
    link: { href: "/cp-nintei-jou/", label: "CP認定錠の詳細はこちら" },
  },
  {
    q: "深夜や早朝でも川越市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「埼玉県」としての一次確認値のため、川越市での詳細は依頼時に各社へご確認ください。",
  },
  {
    q: "急いでいるときでも確認しておくべきことはありますか？",
    a: "広告の最低価格だけで決めず、作業前に出張費・部材費・深夜割増まで含めた総額を提示してもらってください。承諾のない追加請求がない方針かどうかと、運営会社がどこかの2点も押さえておくと安心です。鍵業界には名前のよく似た別会社のサービスが複数あり、サービス名だけでは取り違えが起こります。解錠と交換を同じ日に決める必要はなく、防犯目的の交換は落ち着いてから複数社を比較しても構いません。",
  },
];
...
export default function AreaPageKawagoe() {
  const articleSchema = {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "川越市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜川越市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "川越市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#tips", label: "6｜川越市で鍵業者を呼ぶ前に確認したいこと（古い戸建ての引き戸・勝手口の錠と防犯性の考え方）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜川越市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">川越市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              川越市は埼玉県の南西部にあり、蔵造りの町並みで知られる歴史のあるまちです。市内には昔ながらの戸建てが多く残り、玄関が引き戸だったり、勝手口の錠が建てた当時のままだったりする住まいも見られます。古い錠前は、開け閉めの不調だけでなく、防犯の面でも今の基準と差が出ていることがあり、替えるかどうかを迷う人は少なくありません。
            </p>
            <p>
              本記事では、川越市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、古い戸建ての引き戸や勝手口の錠を替えるときに防犯性をどう考えればよいか、業者に何を伝えると見積もりの精度が上がるかを整理しています。
            </p>
          </div>
          ...
          {/* 1｜業者一覧 */}
          <H2 id="top5" num="1">川越市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            川越市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「埼玉県」としての一次確認値のため、川越市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※近隣エリアの比較は<Link href="/area/saitama/" className="text-primary underline">さいたま・埼玉版</Link>・<Link href="/area/saitama-omiya/" className="text-primary underline">さいたま市大宮区版</Link>・<Link href="/area/kawaguchi/" className="text-primary underline">川口市版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">川越市の鍵業者をとにかく急いで開けてほしいなら</H2>
          <p className="leading-loose mb-4">
            古い錠前は、ある日突然回らなくなることがあります。防犯目的の交換は落ち着いて進められますが、締め出しは待ってくれません。駆けつけスピードの目安を公表している業者としては、<Hl>鍵の生活救急車が最短15分の駆けつけと全国約2,270店の拠点網</Hl>をうたっており、拠点数の多さは到着スピードの裏付けになります。また、<Hl>カギ110番は電話一本で最短5分の手配</Hl>（全国47都道府県の加盟店ネットワークから近隣の業者を手配）を掲げています。
          </p>
          ...
          <p className="leading-loose mb-4">
            戸建ての多い住宅地では、夜になると人通りが減り、屋外で長く待つのは避けたい時間帯になります。一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、遅い時間の依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          <p className="leading-loose mb-4">
            鍵交換は、作業費に加えて錠前やシリンダーの部材費がかかり、古い扉では加工が必要になることもあります。どこまでが見積もりに含まれるのかを先に示す方針かどうかが効いてきます。<Hl>鍵のレスキューは料金をホームページで明示し、現場での追加費用がない</Hl>と掲げています（鍵開け8,000円〜＋出張料0円〜8,800円）。また、<Hl>鍵の生活救急車は出張・見積もり・キャンセルが無料</Hl>のため、提示された金額を見てから依頼するかどうかを判断できます。
          </p>
          <p className="leading-loose mb-4">
          ...
          {/* 6｜エリア特有 */}
          <H2 id="tips" num="6">川越市で鍵業者を呼ぶ前に確認したいこと（古い戸建ての「引き戸・勝手口の錠」と「防犯性の考え方」）</H2>
          <p className="leading-loose mb-4">
            古い戸建てで最初に確かめたいのが、<Hl>玄関が開き戸か引き戸か</Hl>です。引き戸には、引き違い戸の中央に付く召し合わせ錠や、戸の端に付く戸先錠など、開き戸とは構造の異なる錠が使われています。昔からの引き戸用の錠は鍵の種類が単純なものも多く、交換するなら引き戸用の製品の中から、防犯性の目安が示されたものを選ぶことになります。既存の錠と寸法の合う後継品があるかどうかで工事の手間が変わるため、扉の厚みと既存の錠のメーカー名・型番を控えておきましょう。引き戸の錠の種類と替え方は<Link href="/hikido-kagi/" className="text-primary underline">引き戸の鍵</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4">
            次に見ておきたいのが<Hl>勝手口と窓</Hl>です。玄関の錠を替えても、勝手口が建てた当時のままだと、そちらが家全体の弱点として残ります。勝手口は人目に付きにくい位置にあることが多く、防犯の面では玄関と同じかそれ以上に気を配りたい場所です。錠を替える方法のほかに、補助錠を足して二重にする方法もあり、扉の材質や状態によって向き不向きがあります。家全体でどこが弱いかを見たうえで優先順位を決めると、費用のかけ方に納得しやすくなります。勝手口と窓の考え方は<Link href="/katteguchi-mado-bouhan/" className="text-primary underline">勝手口・窓の防犯</Link>、補助錠の選び方は<Link href="/hojo-jou/" className="text-primary underline">補助錠の基礎知識</Link>で扱っています。
          </p>
          <p className="leading-loose mb-4">
            防犯性をどう判断するかは、<Hl>製品に示された目安を手がかりにする</Hl>のが現実的です。防犯性能の高い建物部品として認められた製品にはCPマークが付いており、鍵の種類ではピッキングに強いとされるディンプルキーが一つの目安になります。錠を一つ替えるだけでなく、1つの扉に2つの錠を付ける考え方も、侵入に時間をかけさせるうえで有効とされています。侵入の手口を知っておくと、自宅のどこを優先すべきかが見えやすくなります。基準の見方は<Link href="/cp-nintei-jou/" className="text-primary underline">CP認定錠</Link>と<Link href="/dimple-key/" className="text-primary underline">ディンプルキー</Link>、手口の傾向は<Link href="/akisu-shinnyu-teguchi/" className="text-primary underline">空き巣の侵入手口</Link>で確認できます。
          </p>
          <p className="leading-loose mb-4">
            業者に電話するときは、<Hl>扉の種類・材質・厚み、既存の錠のメーカー名・型番、必要な鍵の本数</Hl>を伝えると、見積もりの精度が上がります。古い錠前は後継品がなく、扉に加工が必要になったり、現地での採寸が必要になったりすることがあるため、写真を用意しておくと話が早く進みます。親の家など自分名義でない住まいの場合は、所有者と相談したうえで進めるのが基本です。錠前の型の見分け方は<Link href="/joumae-type-zukan/" className="text-primary underline">錠前タイプ図鑑</Link>、替えどきの目安は<Link href="/kagi-jumyou/" className="text-primary underline">鍵の寿命</Link>と<Link href="/kagi-koukan-timing/" className="text-primary underline">鍵交換のタイミング</Link>にまとめています。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">川越市の鍵業者の失敗しない選び方</H2>
          <p className="leading-loose mb-6">
            鍵業者選びで後悔しないためには、次の4つのステップを踏むことが大切です。防犯目的の交換は時間に余裕があることが多いぶん、比較の手間をかける価値があります。
          </p>
          {steps.map((s) => (
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">川越市の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            川越市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝の受付ならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            昔ながらの戸建てが多い川越市では、引き戸や勝手口の古い錠前をどうするかが、鍵まわりの見直しの入り口になります。玄関だけでなく勝手口や窓まで含めて家全体の弱点を見て、CPマークやディンプルキーといった目安を手がかりに製品を選び、扉の種類と既存の錠の情報を添えて複数社に見積もりを取る。この順番を押さえておけば、費用と防犯性のバランスに納得しやすくなります。そのうえで、本記事の一次確認値を出発点に、目的と予算に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["川越市", "引き戸の錠", "勝手口", "防犯性", "鍵交換", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                { href: "/hikido-kagi/", label: "引き戸の鍵" },
                { href: "/katteguchi-mado-bouhan/", label: "勝手口・窓の防犯" },
                { href: "/hojo-jou/", label: "補助錠の基礎知識" },
