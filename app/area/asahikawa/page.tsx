...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】旭川市の鍵開け・鍵交換業者おすすめ5選！鍵穴が凍って回らないときの対処と冬季の到着時間の確かめ方も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "旭川市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、厳しい寒さで鍵穴が凍って鍵が回らないときにやってよいこと・いけないこと、冬季に到着時間をどう確かめるかまで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】旭川市の鍵開け・鍵交換業者おすすめ5選！鍵穴が凍って回らないときの対処と冬季の到着時間の確かめ方も分かる鍵屋比較",
    description:
      "旭川市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。鍵穴が凍って回らないときの対処と、冬季の到着時間の確かめ方も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、旭川市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（北海道対応）", note: "北海道対応の一次確認値。旭川市での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 状況と鍵の種類を整理する",
    b: "「鍵が差さらない」「差さるが回らない」「回そうとして折れた」「鍵をなくした」のどれに当たるかを整理してから電話しましょう。冬季は凍結が原因のことが多く、症状によって対処が変わります。あわせて、玄関か勝手口か、鍵がギザギザの刻みキーかディンプルキーかも伝えるポイントです。屋外で待つことになる場合は、近くに屋内で待てる場所があるか、車で待てるかも先に考えておいてください。賃貸の場合は、業者より先に管理会社・大家への連絡が基本です。",
  },
  {
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "締め出しなどの緊急時以外は、2〜3社から見積もりを取って総額・条件を比較するのがおすすめです。凍結を繰り返す錠の交換や、冬に入る前の予備の鍵の作製は日程に余裕を持てる依頼なので、じっくり比較する価値があります。今回の5社はいずれも全国対応型で、旭川市からも依頼できます（対応エリアは「北海道」としての一次確認値のため、詳細条件は各社へ確認を）。冬季は路面状況で到着時間が変わりやすいため、電話の際に「今日の道路状況での到着目安」を聞いてから決めましょう。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "旭川市の鍵開け料金の相場はいくらですか？",
    a: "当サイトが一次確認した各社の公式表示では、鍵開けの基本料金はカギ110番6,600円〜、鍵のレスキュー8,000円〜、鍵の生活救急車・JBR8,800円〜（いずれも税込）、カギの救急車は公式目安11,000〜44,000円です。ただしこれは最低価格や目安で、鍵の種類（ディンプルキー等）・時間帯・出張距離で総額は変わります。凍結で鍵が折れて鍵穴に残った場合は、折れた鍵の抜き取りが別の作業になることがあるため、作業前に総額の見積もりを取りましょう。",
    link: { href: "/ryokin/", label: "料金相場の詳細はこちら" },
  },
  {
    q: "鍵穴が凍って鍵が差さりません。お湯をかけてもいいですか？",
    a: "お湯をかけるのは避けてください。かけた瞬間は溶けても、残った水分がすぐに再び凍り、前より強く固まることがあります。錠の内部に水が入ると、春以降のさびや動作不良の原因にもなります。鍵穴用の解氷剤を使う、鍵そのものを手のひらやポケットで温めてから差す、といった方法が現実的です。息を吹きかけるのも、湿気を送り込むことになるため避けたほうが無難です。",
    link: { href: "/kagiana-touketsu/", label: "鍵穴の凍結の対処はこちら" },
  },
  {
    q: "凍った鍵を無理に回したら折れました。どうすればいいですか？",
    a: "折れた鍵が鍵穴に残った場合は、それ以上触らないでください。針金やピンで取ろうとすると、内部で奥に押し込んでしまい、抜き取りの作業が難しくなります。折れた鍵の残りの部分は業者に見せるために保管しておきましょう。鍵の抜き取りだけで済むのか、シリンダーの交換になるのかは状態によって変わるため、電話の際に「凍結で鍵が折れて鍵穴に残っている」と伝えてください。",
    link: { href: "/kagi-ore/", label: "鍵が折れたときの対処はこちら" },
  },
  {
    q: "冬季は到着までどのくらいかかりますか？",
    a: "各社が公表しているのは「最短」の目安で、積雪や路面の凍結、吹雪のときは実際の到着時間が大きく延びることがあります。電話の際に、その日の道路状況を踏まえた到着目安を聞き、それが自分の待てる時間に収まるかで判断してください。屋外で長く待つのは体に負担がかかるため、到着までの間に屋内で待てる場所や車があるかも先に考えておきましょう。",
    link: { href: "/shimedashi/", label: "締め出されたときの対処はこちら" },
  },
  {
    q: "深夜や早朝でも旭川市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「北海道」としての一次確認値のため、旭川市での詳細は依頼時に各社へご確認ください。",
  },
  {
    q: "鍵穴の凍結を防ぐ備えはありますか？",
    a: "凍結は鍵穴に入り込んだ水分が凍ることで起きるため、日中に溶けた雪や雨が鍵穴に入らないよう、鍵穴の周りをこまめに拭いておくことが基本です。鍵穴に使ってよいとされる専用の潤滑剤で内部の水分をはじく方法もありますが、油分を含む一般的な潤滑剤はほこりを抱き込んで動きを悪くすることがあるため、鍵穴用かどうかを確かめてから使ってください。予備の鍵を家族や職場に預けておくと、凍結で開かない日に別の入口から入る選択肢が残ります。",
...
export default function AreaPageAsahikawa() {
  const articleSchema = {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "旭川市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜旭川市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "旭川市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#tips", label: "6｜旭川市で鍵業者を呼ぶ前に確認したいこと（凍った鍵穴にやってよいこと・いけないこと）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜旭川市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">旭川市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <header className="grid gap-4">
            ...
            <ul className="flex flex-wrap gap-2">
              {["旭川市", "鍵穴の凍結", "鍵が回らない", "冬季の到着時間", "業者比較"].map((t) => (
                <li
                  key={t}
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              旭川市は北海道のほぼ中央、上川盆地に位置する中核市で、冬の冷え込みの厳しさで知られるエリアです。冷え込んだ朝や帰宅した夜に、鍵穴に鍵が差さらない、差さっても回らないという場面は、寒冷地ならではの鍵トラブルです。日中に溶けた雪が鍵穴に入り、夜のうちに凍って固まる。原因は単純でも、対処を誤ると鍵が折れて鍵穴に残り、事態がかえって大きくなります。加えて、冬季は路面状況で業者の到着時間も読みにくくなります。
            </p>
            <p>
              本記事では、旭川市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、鍵穴が凍って回らないときにやってよいこと・いけないこと、冬季に到着時間をどう確かめればよいかを整理しています。
            </p>
          </div>
          ...
          {/* 1｜業者一覧 */}
          <H2 id="top5" num="1">旭川市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            旭川市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「北海道」としての一次確認値のため、旭川市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※近隣エリアの比較は<Link href="/area/sapporo/" className="text-primary underline">札幌版</Link>・<Link href="/area/sapporo-chuo/" className="text-primary underline">札幌市中央区版</Link>・<Link href="/area/sapporo-kita/" className="text-primary underline">札幌市北区版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">旭川市の鍵業者をとにかく急いで開けてほしいなら</H2>
          <p className="leading-loose mb-4">
            冷え込んだ夜に玄関が開かないと、待つ時間がそのまま体への負担になります。急ぎで開けてほしい場面に備えて、駆けつけの目安は押さえておきましょう。駆けつけスピードの目安を公表している業者としては、<Hl>鍵の生活救急車が最短15分の駆けつけと全国約2,270店の拠点網</Hl>をうたっており、拠点数の多さは到着スピードの裏付けになります。また、<Hl>カギ110番は電話一本で最短5分の手配</Hl>（全国47都道府県の加盟店ネットワークから近隣の業者を手配）を掲げています。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
            ※いずれも「最短」の目安であり、拠点からの距離・交通状況・繁忙状況で到着時間は変わります。冬季は積雪や路面の凍結で到着が延びやすいため、電話の際にその日の道路状況での到着目安を確認してから依頼しましょう。
          </p>

          {/* 3｜深夜 */}
          <H2 id="shinya" num="3">深夜・早朝の鍵トラブルなら</H2>
          <p className="leading-loose mb-4">
            鍵穴の凍結に気づくのは、冷え込みが最も厳しい早朝や深夜であることがほとんどです。一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、遅い時間の依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          <p className="leading-loose mb-4">
            凍結のトラブルは、解氷と解錠で済むのか、折れた鍵の抜き取りやシリンダーの交換まで必要になるのかで金額の幅が大きく変わります。だからこそ内訳を示す方針かどうかが効いてきます。<Hl>鍵のレスキューは料金をホームページで明示し、現場での追加費用がない</Hl>と掲げています（鍵開け8,000円〜＋出張料0円〜8,800円）。また、<Hl>鍵の生活救急車は出張・見積もり・キャンセルが無料</Hl>のため、提示された金額を見てから依頼するかどうかを判断できます。
          </p>
          <p className="leading-loose mb-4">
          ...
          {/* 6｜エリア特有 */}
          <H2 id="tips" num="6">旭川市で鍵業者を呼ぶ前に確認したいこと（凍った鍵穴に「やってよいこと」と「いけないこと」）</H2>
          <p className="leading-loose mb-4">
            鍵穴が凍って鍵が差さらない、差さっても回らないというとき、真っ先に避けたいのが<Hl>お湯をかけることと、無理に力を入れて回すこと</Hl>です。お湯はかけた瞬間こそ溶けますが、残った水分がすぐに再び凍り、前より強く固まることがあります。錠の内部に入った水は、春以降のさびや動作不良の原因にもなります。力任せに回すと鍵が折れて鍵穴に残り、解氷だけで済んだはずの作業が、折れた鍵の抜き取りやシリンダー交換にまで広がります。息を吹きかけるのも湿気を送り込むことになるため、避けたほうが無難です。対処の詳細は<Link href="/kagiana-touketsu/" className="text-primary underline">鍵穴の凍結の対処</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4">
            やってよいのは、<Hl>鍵穴用の解氷剤を使うこと、鍵そのものを手のひらやポケットで温めてから差すこと</Hl>です。鍵を温めて差し込み、少し待ってから軽く動かす、を繰り返すと氷が緩むことがあります。それでも動かないときは、そこで手を止めて業者に相談するのが結果的に早道です。すでに鍵が折れてしまった場合は、針金やピンで取ろうとせず、折れた鍵の残りを保管したまま連絡してください。自分で触ると奥に押し込んでしまい、抜き取りが難しくなります。手順は<Link href="/kagi-ore/" className="text-primary underline">鍵が折れたときの対処</Link>で扱っています。
          </p>
          <p className="leading-loose mb-4">
            冬季の依頼で見落としがちなのが、<Hl>到着時間を「その日の道路状況で」確かめること</Hl>です。各社が公表するのは「最短」の目安で、積雪や路面の凍結、吹雪のときは実際の到着が大きく延びることがあります。電話の際に、今日の状況での到着目安を聞き、それが自分の待てる時間に収まるかで判断してください。屋外で長く待つのは体に負担がかかるため、近くに屋内で待てる場所があるか、車で待てるかも先に考えておきましょう。締め出されたときの動き方は<Link href="/shimedashi/" className="text-primary underline">締め出されたときの対処</Link>で確認できます。
          </p>
          <p className="leading-loose mb-4">
            平時にできる備えは、<Hl>鍵穴に水分を入れないこと</Hl>に尽きます。日中に溶けた雪や雨が鍵穴に入らないよう、鍵穴の周りをこまめに拭き、鍵穴に使ってよいとされる専用の潤滑剤で内部の水分をはじく方法もあります。油分を含む一般的な潤滑剤はほこりを抱き込んで動きを悪くすることがあるため、鍵穴用かどうかを確かめてから使ってください。凍結に関わらず鍵が回りにくい状態が続くなら、錠そのものの摩耗が疑われます。考え方は<Link href="/kagi-mawaranai/" className="text-primary underline">鍵が回らないときの対処</Link>と<Link href="/kagi-jumyou/" className="text-primary underline">鍵の寿命</Link>で扱っています。予備の鍵を家族や職場に預けておくと、凍結で開かない日に別の入口から入る選択肢が残ります。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">旭川市の鍵業者の失敗しない選び方</H2>
          <p className="leading-loose mb-6">
            鍵業者選びで後悔しないためには、次の4つのステップを踏むことが大切です。冬季のトラブルは屋外で待つ時間がそのまま負担になるため、順番を決めておく価値があります。
          </p>
          {steps.map((s) => (
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">旭川市の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            旭川市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝の受付ならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            冬の冷え込みが厳しい旭川市では、鍵穴の凍結が身近なトラブルです。お湯をかけない・無理に回さない、鍵を温めて解氷剤で緩める、動かなければ手を止めて業者へ、到着時間はその日の道路状況で確かめる。この流れを知っておけば、凍った玄関の前で立ち尽くす時間を短くできます。そのうえで、本記事の一次確認値を出発点に、状況と予算に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["旭川市", "鍵穴の凍結", "鍵が折れた", "寒冷地", "冬季の到着時間", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                { href: "/kagiana-touketsu/", label: "鍵穴の凍結の対処" },
