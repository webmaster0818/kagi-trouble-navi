...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】中野区の鍵開け・鍵交換業者おすすめ5選！アパートの鍵紛失で大家・管理会社へ連絡する手順も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "中野区で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、アパートの鍵をなくしたときの大家・管理会社への連絡の仕方と費用負担の考え方まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】中野区の鍵開け・鍵交換業者おすすめ5選！アパートの鍵紛失で大家・管理会社へ連絡する手順も分かる鍵屋比較",
    description:
      "中野区で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。一人暮らしのアパートで鍵をなくしたとき、大家・管理会社へ何をどう連絡すべきか、勝手にやってはいけないことも解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、中野区内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（東京都対応）", note: "東京都対応の一次確認値。中野区での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 状況と鍵の種類を整理する",
    b: "「なくした」「締め出された」など状況と、契約書類にある管理会社の連絡先・24時間緊急窓口の有無をメモしておくと、その後の動きがスムーズです。賃貸の場合は、鍵業者より先に管理会社・大家への連絡が基本です。",
  },
  {
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "締め出しなどの緊急時以外は、2〜3社から見積もりを取って総額・条件を比較するのがおすすめです。今回の5社はいずれも全国対応型で、中野区からも依頼できます（対応エリアは「東京都」としての一次確認値のため、詳細条件は各社へ確認を）。金額に納得できない場合は、その場で契約せず一度断る選択肢もあります。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "中野区の鍵開け料金の相場はいくらですか？",
  ...
  {
    q: "深夜や早朝でも中野区に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。ただし深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「東京都」としての一次確認値のため、中野区での詳細は依頼時に各社へご確認ください。",
  },
  {
    q: "アパートの鍵をなくしました。大家さんや管理会社への連絡は必須ですか？",
    a: "連絡すべきです。賃貸の鍵は貸主からの貸与物で、紛失は報告事項にあたります。黙っていると、退去時の鍵の本数不足や万一の盗難時の対応でトラブルになりやすくなります。報告の際に、遺失届を出したこと・当面の入室手段の有無を伝えると、その後の相談（開錠や交換）もスムーズです。管理会社が預かり鍵で対応してくれる場合は、業者を呼ぶ費用がかからないこともあります。",
    link: { href: "/kagi-funshitsu/", label: "鍵をなくしたときの対処はこちら" },
  },
  {
    q: "大家さんに知らせずに、自分で鍵を交換してもいいですか？",
    a: "無断での交換は避けてください。シリンダーの交換は物件の設備に手を加える行為で、貸主の承諾が必要とされるのが一般的です。無断交換は契約違反となり得るほか、退去時の原状回復でもめる原因になります。防犯上交換したい事情がある場合は、その旨を管理会社・大家に伝えて、承諾を得たうえで進めましょう。",
    link: { href: "/chintai-kagi-koukan-hiyou/", label: "賃貸の鍵交換費用はこちら" },
  },
  {
    q: "紛失したときの鍵交換の費用は誰が負担しますか？",
    a: "入居者の紛失が原因の場合、交換費用は入居者負担とされるのが一般的です（金額や取り扱いは契約・物件によります）。鍵の種類によって費用は変わり、防犯性の高いシリンダーほど高くなる傾向があります。管理会社指定の業者で交換するケースも多いため、自分で業者を手配する前に、段取りを管理会社へ確認しましょう。",
  },
  {
...
export default function AreaNakanoKuPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】中野区の鍵開け・鍵交換業者おすすめ5選！アパートの鍵紛失で大家・管理会社へ連絡する手順も分かる鍵屋比較",
    description:
      "中野区で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "中野区の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜中野区で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "中野区の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#tips", label: "6｜中野区で鍵業者を呼ぶ前に確認したいこと（アパートの鍵をなくしたら大家・管理会社へ）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜中野区の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">中野区の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              「アパートの鍵をなくしたけれど、大家さんに知らせたら叱られそうで言い出せない」——単身者向けのアパート・マンションが多い中野区で典型的なのが、一人暮らしの鍵の紛失です。合鍵を持つ家族が遠方だと頼れる相手が少なく、しかも賃貸の鍵は自分の持ち物ではありません。勝手に進めてよいことといけないことの線引きを、先に知っておきましょう。
            </p>
            <p>
              本記事では、中野区内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、アパートの鍵をなくしたときの大家・管理会社への連絡の仕方と順番も整理しています。ぜひ鍵業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="top5" num="1">中野区で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            中野区内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「東京都」としての一次確認値のため、中野区での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">中野区の鍵業者をとにかく急いで開けてほしいなら</H2>
          ...
          <p className="leading-loose mb-4">
            中野区でも、深夜の締め出しや帰宅後に紛失へ気づくトラブルは起こり得ます。この時間帯に頼れるのは24時間受付の業者で、一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、夜間の緊急依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          {/* 6｜区特有 */}
          <H2 id="tips" num="6">中野区で鍵業者を呼ぶ前に確認したいこと（アパートの鍵の紛失は「報告」がセット）</H2>
          <p className="leading-loose mb-4">
            まず押さえたいのは、<Hl>賃貸の鍵は貸主からの貸与物であり、紛失は管理会社・大家への報告事項</Hl>だということです。「叱られそうだから」と黙ってやり過ごすと、退去時の精算や万一の盗難時の話がこじれる原因になります。連絡の際は「いつ・どこでなくした可能性があるか」「遺失届を出したか」「スペアで当面は入れるか」を伝えると話が早く進みます。管理会社によっては、預かり鍵やマスターキーで当面の入室に対応してもらえる場合もあります。紛失時の基本手順は<Link href="/kagi-funshitsu/" className="text-primary underline">鍵をなくしたときの対処</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4">
            深夜の締め出しなどで管理会社が営業時間外の場合は、契約書類や物件の掲示で<Hl>24時間の緊急窓口の有無</Hl>を確認しましょう。窓口がなく今夜入れないなら鍵業者の出番ですが、<Hl>依頼するのは「開けてもらう」まで。シリンダーの交換や鍵穴の破壊をともなう作業を、貸主の承諾なしに進めてはいけません</Hl>。深夜帯は割増料金があり得るため、総額と到着目安の確認も忘れずに（<Link href="/shimedashi/" className="text-primary underline">締め出されたときの対処</Link>）。
          </p>
          <p className="leading-loose mb-4">
            鍵が見つからないままの場合、防犯上はシリンダー交換が望ましく、<Hl>紛失が原因の交換費用は入居者負担とされるのが一般的</Hl>です（負担の詳細は契約によります）。費用感は<Link href="/chintai-kagi-koukan-hiyou/" className="text-primary underline">賃貸の鍵交換費用</Link>を参考にしてください。再発防止には、鍵に住所の分かる物を付けない・かばんの中の定位置を決める・スマートタグを付けるといった小さな工夫が効きます。一人暮らしの防犯全般は<Link href="/chintai-bouhan/" className="text-primary underline">賃貸の防犯対策</Link>もあわせてどうぞ。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">中野区の鍵業者の失敗しない選び方</H2>
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">中野区の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            中野区で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝のトラブルならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            一人暮らしの鍵の紛失は、「管理会社・大家への報告」を軸に動けば大きくこじれません。深夜にまず入りたいときも、依頼は開錠までにとどめ、交換は承諾を得てから。費用負担のルールは契約書で確認できます。言い出しにくくても、早い報告が結果的に費用も時間も抑えられます。本記事の一次確認値を出発点に、状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["中野区", "東京23区", "鍵開け", "鍵交換", "24時間対応", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
