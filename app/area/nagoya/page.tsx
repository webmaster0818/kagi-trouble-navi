...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】名古屋の鍵開け・鍵交換業者おすすめ5選！24時間対応の鍵屋を徹底比較｜鍵トラブルナビ",
  },
  description:
    "名古屋で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。名古屋市に本社を置くシェアリングテクノロジー運営のカギ110番（鍵開け6,600円〜）をはじめ、鍵の生活救急車・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、賃貸で業者を呼ぶ前の確認事項まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】名古屋の鍵開け・鍵交換業者おすすめ5選！24時間対応の鍵屋を徹底比較",
    description:
      "名古屋で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。名古屋に本社を置く運営会社の情報や、業者を呼ぶ前の確認事項も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    slug: "kagi110ban",
    num: "1-1",
    catch: "運営会社が名古屋本社・最短5分手配",
    name: "カギ110番",
    intro: (
      <>
        カギ110番は、東証グロース上場の
        <Hl>シェアリングテクノロジー株式会社（本社：名古屋市）が運営する加盟店紹介型の鍵トラブル解決サービス</Hl>
        です。<Hl>鍵開け6,600円〜（税込・公式表示）</Hl>
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、名古屋市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
      "深夜・早朝など緊急で鍵トラブルを解決したい人",
      "名古屋に本社を置く上場企業運営のサービスに依頼したい人",
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（愛知県対応）" },
      { k: "見積もり", v: "無料", note: "交通費・キャンセル料は別途発生する場合ありと公式記載" },
      { k: "運営会社", v: "シェアリングテクノロジー株式会社（本社：名古屋市）" },
    ],
    memo:
      "公式サイトで鍵開け6,600円〜（税込）の表示を確認。運営のシェアリングテクノロジー株式会社は名古屋市に本社を置く東証グロース上場企業です。公式にも「対応エリア・加盟店により記載価格や条件では対応できない場合がある」と明記されており、実際の金額は現地の無料見積もりで確定します。加盟店紹介型のため、対応品質は店舗により差が出ることがあります。",
  ...
  },
  {
    ...
    intro: (
      <>
        鍵の生活救急車は、株式会社生活救急車（本社：名古屋市）が運営する鍵トラブル解決サービスです。
    ...
    table: [
      ...
      { k: "運営会社", v: "株式会社生活救急車（本社：名古屋市）" },
    ],
    memo:
      "公式サイトで鍵開け8,800円〜、出張・見積もり・キャンセル無料の記載を確認。運営の株式会社生活救急車も名古屋市に本社を置く企業です。名称の似た「カギの生活救急車（JBR）」とは別のサービスのため、混同にご注意ください。",
    memoDate: "2026年7月4日確認",
  },
  {
    id: "jbr",
...
const steps = [
  ...
  {
    t: "③ 運営会社を確認する",
    b: "鍵業界には「カギ110番」「鍵の110番救急車」「カギの救急車」「カギの生活救急車」など名前のよく似たサービスが複数あり、運営会社はそれぞれ別です。今回の5社でも、カギ110番と鍵の生活救急車は運営会社がどちらも名古屋市本社ですが、互いに別の会社です。依頼前にサービス名だけでなく運営会社名まで確認すると取り違えを防げます。",
  },
  {
    t: "④ 急ぎでなければ複数社を比較する",
...
const faqs = [
  ...
  {
    q: "名古屋に本社のある鍵業者はありますか？",
    a: "今回の5社では、カギ110番を運営するシェアリングテクノロジー株式会社（東証グロース上場）と、鍵の生活救急車を運営する株式会社生活救急車が、いずれも名古屋市に本社を置いています。ただし両社とも全国対応のサービスで、実際に駆けつけるのは各地の加盟店・拠点です。なお両社は名称が紛らわしい別会社のため、依頼時は運営会社名まで確認しましょう。",
  },
  {
    q: "深夜や早朝でも名古屋に来てくれますか？",
  ...
  {
    q: "車の鍵の閉じ込み（インロック）にも対応してもらえますか？",
    a: "今回紹介した5社は、いずれも玄関の鍵だけでなく車の鍵にも対応しています（カギ110番・生活救急車・JBR・鍵のレスキューは車の鍵、カギの救急車は車・バイクのインロックが公式目安11,000〜55,000円）。ただしイモビライザー搭載車など車種によっては対応できない場合があるため、電話時に車種と状況を伝えて対応可否と総額を確認しましょう。",
  },
];
...
export default function AreaNagoyaPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】名古屋の鍵開け・鍵交換業者おすすめ5選！24時間対応の鍵屋を徹底比較",
    description:
      "名古屋で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "名古屋の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#nagoya5",
      label: "1｜名古屋で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "名古屋の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#nagoya-tips", label: "6｜名古屋で鍵業者を呼ぶ前に確認したいこと" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜名古屋の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">名古屋の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              「帰宅したら鍵が見当たらない」「車に鍵を閉じ込めてしまった」——名古屋で鍵トラブルにあったとき、どの業者に頼めばよいか迷う方は多いはずです。実は名古屋は、カギ110番を運営するシェアリングテクノロジー株式会社と、鍵の生活救急車を運営する株式会社生活救急車という、鍵トラブル業界の主要2社が本社を置く街でもあります。ただし両社とも実際に駆けつけるのは各地の加盟店・拠点であり、料金体系や運営形態は各社で異なります。
            </p>
            <p>
              本記事では、名古屋市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。急ぎ・深夜・料金重視といった目的別の選び方や、車の鍵トラブルを含む「業者を呼ぶ前に確認すべきこと」もまとめています。ぜひ鍵業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="nagoya5" num="1">名古屋で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            名古屋市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※東京・大阪・横浜の業者比較は、<Link href="/area/tokyo/" className="text-primary underline">東京版</Link>・<Link href="/area/osaka/" className="text-primary underline">大阪版</Link>・<Link href="/area/yokohama/" className="text-primary underline">横浜版</Link>をご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">名古屋の鍵業者をとにかく急いで開けてほしいなら</H2>
          <p className="leading-loose mb-4">
            締め出しなどで一刻も早く開けてほしい場合は、駆けつけスピードの目安を公表している業者が候補になります。<Hl>鍵の生活救急車は最短15分の駆けつけと全国約2,270店の拠点網</Hl>をうたっており、拠点数の多さは到着スピードの裏付けになります。また、<Hl>カギ110番は電話一本で最短5分の手配</Hl>（全国47都道府県の加盟店ネットワークから近隣の業者を手配）を掲げています。どちらも運営会社は名古屋市に本社を置く企業です。
          </p>
          ...
          <p className="leading-loose mb-4">
            鍵業者には、依頼を受けて加盟店を手配する「紹介型」と、自社のスタッフが直接対応する「自社対応型」があります。名古屋本社のカギ110番は前者の紹介型で、対応範囲が広い一方、店舗によって技術・対応に差が出ることがあります。今回の5社では、<Hl>鍵のレスキューが全国約20拠点を自社社員で対応する自社対応型</Hl>で、女性スタッフの指名にも対応しています。担当者の所属まで気になる方は、依頼時に「自社スタッフか協力店か」を確認してみましょう。
          </p>

          {/* 6｜名古屋特有 */}
          <H2 id="nagoya-tips" num="6">名古屋で鍵業者を呼ぶ前に確認したいこと</H2>
          <p className="leading-loose mb-4">
          ...
          <p className="leading-loose mb-4">
            日常的に車を使う方は、玄関の鍵と並んで<Hl>車の鍵の閉じ込み（インロック）や紛失</Hl>も起こりやすいトラブルです。今回の5社はいずれも車の鍵に対応していますが、イモビライザー搭載車など車種によっては対応できない場合があります。詳しくは<Link href="/car-inlock/" className="text-primary underline">車のインロックの対処法</Link>をご覧ください。
          </p>
          <p className="leading-loose mb-4">
            鍵をなくした場合は、<Hl>最寄りの警察署・交番への遺失届の提出</Hl>も忘れずに行いましょう。届け出ておくと、鍵が拾得物として届いた際に連絡を受けられます。詳しくは<Link href="/kagi-funshitsu/" className="text-primary underline">鍵をなくしたときの対処法</Link>、料金の目安は<Link href="/ryokin/" className="text-primary underline">料金相場</Link>で解説しています。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">名古屋の鍵業者の失敗しない選び方</H2>
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">名古屋の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            名古屋で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。名古屋はカギ110番（シェアリングテクノロジー）と鍵の生活救急車（株式会社生活救急車）の運営会社2社が本社を置く街ですが、実際の対応は各地の加盟店・拠点が行うため、選ぶ基準はほかのエリアと同じく「総額・受付時間・運営形態」です。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝ならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキューが候補になります。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["名古屋", "鍵開け", "鍵交換", "24時間対応", "業者比較", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
