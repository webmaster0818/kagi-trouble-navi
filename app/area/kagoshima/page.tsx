...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】鹿児島の鍵開け・鍵交換業者おすすめ5選！24時間対応の鍵屋を徹底比較｜鍵トラブルナビ",
  },
  description:
    "鹿児島で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、火山灰や砂ぼこりで鍵穴が渋くなったときの一般的な手入れ（鍵穴専用潤滑剤・鉛筆の黒鉛）と油さしNGの注意まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】鹿児島の鍵開け・鍵交換業者おすすめ5選！24時間対応の鍵屋を徹底比較",
    description:
      "鹿児島で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。火山灰・砂ぼこりで渋くなった鍵穴の一般的な手入れと、やってはいけない油さしの注意も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、鹿児島市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
...
const steps = [
  {
    t: "① 状況と鍵の種類を整理する",
    b: "「開かない」「なくした」「ジャリジャリして回りにくい」など状況と、玄関・勝手口・車といった対象、刻みキーかディンプルキーかなど鍵の種類をメモしておくと、電話での見積もり精度が上がります。回りにくさが降灰の多かった時期から始まったのか、以前から徐々に進んでいたのかも伝えられると、原因の見当がつきやすくなります。賃貸の場合は、業者より先に管理会社・大家への連絡が基本です。",
  },
  {
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "締め出しなどの緊急時以外は、2〜3社から見積もりを取って総額・条件を比較するのがおすすめです。手入れをしても改善しない鍵穴の交換のように日程に余裕がある依頼なら、じっくり比較する価値があります。今回の5社はいずれも全国対応型で鹿児島から依頼できます。金額に納得できない場合は、その場で契約せず一度断る選択肢もあります。",
  },
];

const faqs = [
  {
    q: "鹿児島の鍵開け料金の相場はいくらですか？",
  ...
  {
    q: "火山灰が入って鍵が回りにくいとき、油をさしてもいいですか？",
    a: "食用油や一般的な防錆潤滑スプレーを鍵穴にさすのは避けてください。油分が灰やホコリを吸着して内部で固まり、症状をかえって悪化させることがあります。潤滑には鍵穴専用のパウダースプレーか鉛筆の黒鉛を使うのが一般的な方法です。改善しない場合は無理に回さず、業者に相談しましょう。",
  },
  {
    q: "鍵穴に入った灰や砂ぼこりは自分で掃除できますか？",
    a: "掃除機で鍵穴の入り口から吸い出す、エアダスターで吹き飛ばすといった「内部に何も足さない」方法なら自分でも試せます。爪楊枝や針金でかき出すのは、部品を傷つけたり異物を奥に押し込んだりする恐れがあるためやめましょう。掃除のあとは鍵穴専用潤滑剤か鉛筆の黒鉛で潤滑するのが一般的です。",
  },
  {
    q: "手入れしても鍵が回りにくいままです。交換したほうがいいですか？",
    a: "掃除と専用潤滑剤で改善しない場合、内部部品の摩耗などシリンダー自体の劣化が原因の可能性があります。錠前の耐用年数は一般に10年程度が目安とされ、無理に使い続けると鍵穴の中で鍵が折れるトラブルにつながりかねません。症状を伝えたうえで業者に点検・見積もりを依頼し、修理か交換かを判断するのがおすすめです。",
  },
  {
...
export default function AreaKagoshimaPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】鹿児島の鍵開け・鍵交換業者おすすめ5選！24時間対応の鍵屋を徹底比較",
    description:
      "鹿児島で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "鹿児島の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#kagoshima5",
      label: "1｜鹿児島で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "鹿児島の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#kagoshima-tips", label: "6｜鹿児島で鍵業者を呼ぶ前に確認したいこと（火山灰・砂ぼこりと鍵穴の手入れ）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜鹿児島の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">鹿児島の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              「鍵を差し込むとジャリッとした感触がする」「灰がひどかった日から、玄関の鍵が回りにくい」——桜島の降灰と付き合いながら暮らす鹿児島では、屋外に面した玄関や門扉の鍵穴に灰や砂ぼこりが入り込み、動作不良につながる相談が起こりやすい土地柄です。厄介なのは、このとき良かれと思って机の引き出しにある潤滑油をさしてしまうと、油分が灰やホコリを抱き込んで固着し、かえって症状を悪化させてしまう点です。
            </p>
            <p>
              本記事では、鹿児島市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、灰や砂ぼこりで渋くなった鍵穴に対して自分でできる一般的な手入れ（やってよいこと・いけないこと）もまとめています。ぜひ鍵業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="kagoshima5" num="1">鹿児島で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            鹿児島市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※他の都市の比較は、<Link href="/area/fukuoka/" className="text-primary underline">福岡版</Link>・<Link href="/area/kumamoto/" className="text-primary underline">熊本版</Link>・<Link href="/area/kitakyushu/" className="text-primary underline">北九州版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">鹿児島の鍵業者をとにかく急いで開けてほしいなら</H2>
          ...
          <p className="leading-loose mb-4">
            鹿児島でも、深夜の締め出しや、帰宅してから鍵が回らないことに気づくトラブルは起こり得ます。この時間帯に頼れるのは24時間受付の業者で、一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、夜間の緊急依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          {/* 6｜鹿児島特有 */}
          <H2 id="kagoshima-tips" num="6">鹿児島で鍵業者を呼ぶ前に確認したいこと（火山灰・砂ぼこりと鍵穴の手入れ）</H2>
          <p className="leading-loose mb-4">
            灰や砂ぼこりが鍵穴に入ると、「差し込みが渋い」「回すときにジャリつく」といった症状が出ることがあります。まず試したいのは、<Hl>掃除機で鍵穴の入り口から異物を吸い出す、エアダスターで吹き飛ばす</Hl>といった、内部に何も足さない掃除です。爪楊枝や針金を突っ込んでかき出すのは、内部の部品を傷つけたり異物を奥へ押し込んだりする恐れがあるため避けましょう。症状別の対処は<Link href="/kagi-mawaranai/" className="text-primary underline">鍵が回らないときの解説記事</Link>で詳しく説明しています。
          </p>
          <p className="leading-loose mb-4">
            掃除のあとの潤滑には、<Hl>鍵穴専用のパウダースプレー（乾式潤滑剤）か、鉛筆の黒鉛</Hl>を使います。鉛筆を使う場合は、鍵の溝を芯で軽くなぞって黒鉛を付け、数回抜き差しするのが一般的な方法です。逆に<Hl>食用油や一般的な防錆潤滑スプレーを鍵穴にさすのはNG</Hl>です。油分が灰やホコリを吸着して内部で粘土状に固まり、分解清掃やシリンダー交換が必要になるまで悪化させてしまうことがあります。鍵が抜けない・抜き差しが渋いときの注意点は<Link href="/kagi-nukenai/" className="text-primary underline">鍵が抜けないときの解説記事</Link>もご覧ください。
          </p>
          <p className="leading-loose mb-4">
            手入れをしても改善しない場合は、内部部品の摩耗など<Hl>シリンダー自体の寿命</Hl>が近づいているサインかもしれません。一般に錠前の耐用年数は10年程度が目安とされ、寿命が近い鍵を力任せに回すと、鍵穴の中で鍵が折れる二次トラブルにつながります。判断の目安は<Link href="/kagi-jumyou/" className="text-primary underline">鍵の寿命の解説記事</Link>を、万が一折れてしまったときの対処は<Link href="/kagi-ore/" className="text-primary underline">鍵が折れたときの解説記事</Link>を参考に、無理をせず業者に相談しましょう。費用の相場感は<Link href="/ryokin/" className="text-primary underline">料金相場ページ</Link>で解説しています。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">鹿児島の鍵業者の失敗しない選び方</H2>
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">鹿児島の鍵業者でよくある質問</H2>
              ...
              <div key={f.q} className="rounded-[2px] border border-border">
                ...
                <p className="flex gap-3 px-5 py-4 text-sm leading-relaxed">
                  ...
                  <span>
                    ...
                    {f.q.includes("掃除できますか") && (
                      <>
                        {" "}
                        <Link href="/kagi-nukenai/" className="text-primary underline">鍵が抜けない・渋いときの解説はこちら</Link>
                      </>
                    )}
                    {f.q.includes("回りにくいまま") && (
                      <>
                        {" "}
          ...
          <p className="leading-loose mb-4">
            鹿児島で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝のトラブルならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            灰や砂ぼこりによる鍵穴の不調は、掃除機・エアダスターでの掃除と鍵穴専用潤滑剤（または鉛筆の黒鉛）での手入れで改善することがあります。一方で、油さしは固着を招く逆効果の代表例です。手入れで直らないときは寿命のサインと考え、力任せに回さず業者に点検を頼みましょう。その際も、作業前に総額の見積もりを取り、複数社を比較することが失敗しないための共通ルールです。本記事の一次確認値を出発点に、状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["鹿児島", "鍵開け", "鍵交換", "24時間対応", "業者比較", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/kagi-nukenai/", label: "鍵が抜けないときの対処法" },
