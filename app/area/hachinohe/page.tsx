...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】八戸市の鍵開け・鍵交換業者おすすめ5選！家や店の金庫が開かないときの伝え方も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "八戸市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、家や店に置かれた金庫が開かないときに電話で伝えること、開いたあとの金庫の扱いまで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】八戸市の鍵開け・鍵交換業者おすすめ5選！家や店の金庫が開かないときの伝え方も分かる鍵屋比較",
    description:
      "八戸市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。金庫が開かないときに電話で伝えることと、使わなくなった金庫の扱いも解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、八戸市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（青森県対応）", note: "青森県対応の一次確認値。八戸市での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 状況と鍵の種類を整理する",
    b: "「金庫が開かない」「玄関の鍵をなくした」など状況と、対象（玄関・勝手口・金庫・車）をメモしておくと、電話での見積もり精度が上がります。金庫なら、鍵式かダイヤル式かテンキー式か、扉の内側や背面の表示にあるメーカー名と品番、手提げか据え置きかまで伝えると、対応できるかどうかが早く分かります。賃貸の場合は、業者より先に管理会社・大家への連絡が基本です。",
  },
  {
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "締め出しなどの緊急時以外は、2〜3社から見積もりを取って総額・条件を比較するのがおすすめです。金庫の開錠や、使わなくなった金庫の整理のように日程が読める依頼なら、じっくり比較する価値があります。今回の5社はいずれも全国対応型で八戸市から依頼できます（対応エリアは「青森県」としての一次確認値のため、詳細条件は各社へ確認を）。金額に納得できない場合は、その場で契約せず一度断る選択肢もあります。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "八戸市の鍵開け料金の相場はいくらですか？",
  ...
  {
    q: "金庫の鍵をなくして、ダイヤルの番号も分からないのですが開けてもらえますか？",
    a: "鍵も番号も手元にない状態からの開錠に対応する業者はありますが、金庫の種類や状態によって可否が変わります。電話の段階で、鍵式かダイヤル式かテンキー式か、メーカー名と品番、手提げか据え置きかを伝えて、対応できるかと料金の区分を確かめてください。メーカーへ問い合わせて番号の照会や鍵の再発行ができる場合もありますが、所有者であることを示す書類を求められ、日数もかかります。",
    link: { href: "/kinko-kaijo/", label: "金庫が開かないときの対処はこちら" },
  },
  {
    q: "金庫を開けてもらったあと、そのまま使い続けられますか？",
    a: "開け方によって変わります。錠を壊さずに開けられればそのまま使えることがある一方、扉や錠を壊して開けた金庫は、その後使えなくなるのが一般的です。中身を取り出せればよいのか、これからも使い続けたいのかで方法も費用も変わるため、作業前に希望を伝え、どちらの方法になるかと総額を確認してください。",
  },
  {
    q: "使わなくなった金庫は鍵業者が引き取ってくれますか？",
    a: "会社によって分かれます。開錠を請け負った業者がそのまま処分まで対応することもあれば、開けるところまでという場合もあります。金庫は重量があり、多くの自治体で通常のごみとして出せないため、引き取りを行う事業者や購入した販売店に相談する方法もあります。見積もりの段階で処分まで頼めるかを聞いておくと、二度手間になりません。",
    link: { href: "/kinko-shobun/", label: "金庫の処分方法はこちら" },
  },
  {
    q: "深夜や早朝でも八戸市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。ただし深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「青森県」としての一次確認値のため、八戸市での詳細な対応可否は依頼時にご確認ください。",
  },
  {
...
export default function AreaHachinohePage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】八戸市の鍵開け・鍵交換業者おすすめ5選！家や店の金庫が開かないときの伝え方も分かる鍵屋比較",
    description:
      "八戸市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "八戸市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#hachinohe5",
      label: "1｜八戸市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "八戸市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#hachinohe-tips", label: "6｜八戸市で鍵業者を呼ぶ前に確認したいこと（家や店の金庫が開かないときの伝え方と、開いたあとの扱い）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜八戸市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">八戸市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              「ダイヤルを合わせているのに金庫が開かない」「鍵は見つかったが、番号を書いた紙が見当たらない」——金庫は毎日使うものではないぶん、開けたい場面になって初めて困ります。八戸市は青森県の南東部にある港町で、商店や事業所を兼ねた住まいも街なかにあります。家庭用の手提げ金庫から据え置きの耐火金庫まで、玄関の鍵とは別の錠が家の中にあるという家は少なくありません。扱いも費用も玄関の鍵とは違うため、電話する前に押さえておきたい点があります。
            </p>
            <p>
              本記事では、八戸市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、金庫が開かないときに電話で何を伝えるか、開いたあとに使わなくなった金庫をどうするかまで整理しています。ぜひ鍵業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="hachinohe5" num="1">八戸市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            八戸市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「青森県」としての一次確認値のため、八戸市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※他の都市の比較は、<Link href="/area/aomori/" className="text-primary underline">青森版</Link>・<Link href="/area/morioka/" className="text-primary underline">盛岡版</Link>・<Link href="/area/akita/" className="text-primary underline">秋田版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">八戸市の鍵業者をとにかく急いで開けてほしいなら</H2>
          ...
          <p className="leading-loose mb-4">
            八戸市でも、深夜の締め出しや帰宅後に紛失へ気づくトラブルは起こり得ます。この時間帯に頼れるのは24時間受付の業者で、一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、夜間の緊急依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          {/* 6｜八戸市特有 */}
          <H2 id="hachinohe-tips" num="6">八戸市で鍵業者を呼ぶ前に確認したいこと（家や店の金庫が開かないときの伝え方と、開いたあとの扱い）</H2>
          <p className="leading-loose mb-4">
            金庫の相談は、玄関の鍵とは別の作業として扱われます。電話では<Hl>最初に「金庫です」と伝え、鍵式かダイヤル式かテンキー式か、扉の内側や背面の表示にあるメーカー名と品番、手提げか据え置きかの大きさ</Hl>を続けて伝えてください。対応できるかどうかも、料金の区分も、この情報で分かれます。八戸市のように商店や事業所を兼ねた住まいが街なかにある土地では、家庭用の手提げ金庫から据え置きの耐火金庫まで、玄関とは別の錠が家の中に置かれていることが珍しくありません。何を聞かれるかは<Link href="/kinko-kaijo/" className="text-primary underline">金庫が開かないときの対処</Link>で扱っています。
          </p>
          <p className="leading-loose mb-4">
            次に決めておきたいのが、<Hl>中身を取り出せればよいのか、その金庫をこれからも使いたいのか</Hl>です。金庫の開錠には、錠を壊さずに開ける方法と、扉や錠を壊して開ける方法があり、壊して開けた金庫はその後使えなくなるのが一般的です。鍵も番号も手元にない場合、メーカーへの問い合わせで番号の照会や鍵の再発行ができることもありますが、所有者であることを示す書類を求められ、日数もかかります。<Hl>バールやドリルで自分でこじ開けようとするのは避けてください</Hl>。けがのおそれがあるうえ、中の書類や品物を傷めます。
          </p>
          <p className="leading-loose mb-4">
            依頼の前に、<Hl>その金庫の持ち主が誰で、開けてよい立場の人が頼んでいるか</Hl>も整理しておきます。業者は持ち主以外からの依頼に慎重で、購入時の保証書や設置場所の住所が分かるもの、身分証の提示を求められることがあります。店や事業所の金庫であれば、その場にいる人の判断で開けさせず、経営者や責任者の同意を先に取っておきましょう。依頼先の見極め方は<Link href="/kagishi-shikaku/" className="text-primary underline">鍵師の資格と業者の見分け方</Link>でも触れています。
          </p>
          <p className="leading-loose mb-4">
            開いたあとの扱いまで考えておくと、二度手間になりません。<Hl>使わなくなった金庫は重量があり、多くの自治体で通常のごみとして出せません</Hl>。引き取りを行う事業者や購入した販売店に相談するのが現実的で、開錠を頼む業者が処分まで請け負うかどうかは会社によって分かれます。開錠の見積もりを取るときに、処分まで頼めるかもあわせて聞いておきましょう。使わなくなった金庫と鍵の始末は<Link href="/kinko-shobun/" className="text-primary underline">金庫の処分方法</Link>と<Link href="/kagi-shobun/" className="text-primary underline">不要になった鍵の処分</Link>で解説しています。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">八戸市の鍵業者の失敗しない選び方</H2>
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">八戸市の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            八戸市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝のトラブルならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            金庫は毎日使うものではないぶん、開けたい場面になってから困りがちです。電話では最初に「金庫」と伝えて鍵の方式・メーカー名と品番・大きさを続ける、中身を取り出したいのか使い続けたいのかを先に決める、開いたあとの処分まで頼めるかを見積もりの段階で聞いておく。この3点を押さえておけば、当日の作業が途中で止まりません。玄関の鍵の交換のように日程が読める依頼とあわせて、複数社から総額の見積もりを取って比較しましょう。本記事の一次確認値を出発点に、状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["八戸市", "金庫の鍵", "鍵開け", "鍵交換", "業者比較", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/kinko-shobun/", label: "金庫の処分方法" },
                { href: "/kagi-shobun/", label: "不要になった鍵の処分" },
                { href: "/kagishi-shikaku/", label: "鍵師の資格と業者の見分け方" },
