...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】豊橋市の鍵開け・鍵交換業者おすすめ5選！一戸建ての引き戸錠と古い門扉錠を替えるときの頼み先の切り分けと屋外の錠の手入れも分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "豊橋市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、一戸建ての玄関の引き戸錠と古い門扉錠が固くなったときに「錠の不調か、戸や扉の不調か」をどう切り分け、鍵業者と建具・外構の業者のどちらに頼むか、屋外の錠をどう手入れするかまで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】豊橋市の鍵開け・鍵交換業者おすすめ5選！一戸建ての引き戸錠と古い門扉錠を替えるときの頼み先の切り分けと屋外の錠の手入れも分かる鍵屋比較",
    description:
      "豊橋市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。引き戸錠と門扉錠の不調の切り分けと、鍵業者と建具・外構の業者のどちらに頼むか、屋外の錠の手入れも解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、豊橋市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（愛知県対応）", note: "愛知県対応の一次確認値。豊橋市での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 状況と鍵の種類を整理する",
    b: "「開かない」「固い」「交換したい」といった状況に加えて、対象が玄関の引き戸なのか、門扉なのか、開き戸の玄関や勝手口なのかを最初に伝えましょう。引き戸なら錠が戸の中央に付くのか端に付くのか、門扉なら扉の材質と錠の位置、鍵を差す穴があるのかつまみだけなのかを控えておくと相談が具体的になります。戸や扉そのものが下がっている、傾いているといった様子があれば、それも一緒に伝えてください。",
  },
  {
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "締め出しなどの緊急時以外は、2〜3社から見積もりを取って総額・条件を比較するのがおすすめです。引き戸錠や門扉錠の交換のように日程に余裕がある依頼なら、じっくり比較する価値があります。古い錠は後継品の有無で工事の内容が変わるため、既存の錠の写真とメーカー名・型番を同じ条件で各社に伝えると差が見えやすくなります。今回の5社はいずれも全国対応型で、豊橋市からも依頼できます（対応エリアは「愛知県」としての一次確認値のため、詳細条件は各社へ確認を）。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "豊橋市の鍵開け料金の相場はいくらですか？",
    a: "当サイトが一次確認した各社の公式表示では、鍵開けの基本料金はカギ110番6,600円〜、鍵のレスキュー8,000円〜、鍵の生活救急車・JBR8,800円〜（いずれも税込）、カギの救急車は公式目安11,000〜44,000円です。ただしこれは住宅の鍵開けを含む最低価格や目安で、鍵の種類・時間帯・出張距離で総額は変わります。引き戸錠や門扉錠は開き戸の玄関錠とは作業内容が異なるため、対象と錠の種類を伝えたうえで総額の見積もりを取りましょう。",
    link: { href: "/ryokin/", label: "料金相場の詳細はこちら" },
  },
  {
    q: "玄関の引き戸の鍵が固くなりました。鍵屋に頼めば直りますか？",
    a: "錠そのものが原因なら鍵業者の範囲です。ただし引き戸は、戸が下がったり傾いたりして錠の受け側とかみ合わなくなることがあり、その場合は錠を替えても解決しません。戸を持ち上げるとかかりやすくなる、戸の動きが重い、戸と枠のすき間が上下で違う、といった様子があれば戸側の不調が疑われます。電話で症状を伝え、錠の問題か戸の問題かを切り分けてもらい、戸側なら建具の業者に相談するのが近道です。",
    link: { href: "/hikido-kagi/", label: "引き戸の鍵の解説はこちら" },
  },
  {
    q: "門扉の錠が錆びて動きません。鍵業者と外構の業者、どちらに頼めばいいですか？",
    a: "錠の部分だけを替えたい、開けてほしいという依頼なら鍵業者に相談できます。一方、扉の蝶番が傷んでいる、門柱がぐらついている、扉が歪んで閉まらないといった扉や柱側の不調は、鍵を替えても直らず、外構やエクステリアの業者の範囲になります。錠の動きが悪いのか、扉の建て付けが悪いのかを見て、どちらが主な原因かを先に切り分けてください。両方に及ぶ場合は、どちらに頼んでも一度は「対応外」と言われることがあるため、写真を用意して両方に相談するのが確実です。",
    link: { href: "/kagi-mawaranai/", label: "鍵が回らないときの対処はこちら" },
  },
  {
    q: "門扉の錠を強くすれば、玄関の鍵は古いままでも大丈夫ですか？",
    a: "門扉は乗り越えたり脇から入ったりできることが多く、門扉の錠だけで侵入を防ぐことは期待しにくいのが実情です。防犯の本丸は玄関・勝手口・窓の錠で、門扉はあくまで敷地への出入りを区切る役割と考えたほうが現実に合います。門扉錠を替える予算があるなら、まず玄関や勝手口の錠が古くないか、窓の施錠が抜けていないかを見直すのが先です。",
    link: { href: "/katteguchi-mado-bouhan/", label: "勝手口・窓の鍵の防犯対策はこちら" },
  },
  {
    q: "深夜や早朝でも豊橋市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「愛知県」としての一次確認値のため、豊橋市での詳細は依頼時に各社へご確認ください。",
  },
  {
    q: "屋外の錠を長持ちさせる手入れはありますか？",
    a: "鍵穴に付いた砂ぼこりや潮気を乾いた布で拭き取り、鍵の抜き差しが重くなったら鍵穴専用の潤滑剤を少量使うのが基本です。油や汎用の潤滑スプレーは内部でほこりを抱き込み、かえって動きを悪くすることがあるため避けてください。動きが重い状態で力任せに回すと鍵が折れて鍵穴に残ります。手入れで戻らないなら、錠の寿命として交換を検討する時期です。",
    link: { href: "/kagi-jumyou/", label: "鍵の寿命と交換目安はこちら" },
  },
];
...
export default function AreaPageToyohashi() {
  const articleSchema = {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "豊橋市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜豊橋市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "豊橋市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#tips", label: "6｜豊橋市で鍵業者を呼ぶ前に確認したいこと（引き戸錠・門扉錠は「錠か、戸や扉か」の切り分けが先）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜豊橋市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">豊橋市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              豊橋市は愛知県の東端、東三河の中心にあたる海に近いまちで、古くからの住宅地に敷地の広い一戸建てが多く残っています。こうした住まいでは、玄関が引き戸であったり、敷地の入口に門扉が付いていたりと、開き戸の玄関錠とは違う種類の錠が使われています。長く使った引き戸錠は鍵が固くなり、屋外にさらされた門扉錠は錆びて動かなくなる。替えたいと思ったときに悩むのが、鍵業者に頼めばよいのか、それとも戸や扉そのものを直す業者なのか、という頼み先の問題です。
            </p>
            <p>
              本記事では、豊橋市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、引き戸錠と門扉錠の不調を「錠の問題か、戸や扉の問題か」でどう切り分けるか、鍵業者と建具・外構の業者のどちらに頼むか、屋外の錠をどう手入れすればよいかを整理しています。
            </p>
          </div>
          ...
          {/* 1｜業者一覧 */}
          <H2 id="top5" num="1">豊橋市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            豊橋市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「愛知県」としての一次確認値のため、豊橋市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※近隣エリアの比較は<Link href="/area/okazaki/" className="text-primary underline">岡崎市版</Link>・<Link href="/area/hamamatsu/" className="text-primary underline">浜松版</Link>・<Link href="/area/nagoya/" className="text-primary underline">名古屋版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">豊橋市の鍵業者をとにかく急いで開けてほしいなら</H2>
          <p className="leading-loose mb-4">
            引き戸の玄関が開かない、門扉の錠が固まって敷地から出入りできないといった場面では、その日の予定がまるごと止まります。急ぎで開けてほしい場面に備えて、駆けつけの目安は押さえておきましょう。駆けつけスピードの目安を公表している業者としては、<Hl>鍵の生活救急車が最短15分の駆けつけと全国約2,270店の拠点網</Hl>をうたっており、拠点数の多さは到着スピードの裏付けになります。また、<Hl>カギ110番は電話一本で最短5分の手配</Hl>（全国47都道府県の加盟店ネットワークから近隣の業者を手配）を掲げています。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
            ※いずれも「最短」の目安であり、拠点からの距離・交通状況・繁忙状況で到着時間は変わります。急ぎのときこそ、電話の際に到着目安と、引き戸錠・門扉錠に対応できるかを確認してから依頼しましょう。
          </p>

          {/* 3｜深夜 */}
          <H2 id="shinya" num="3">深夜・早朝の鍵トラブルなら</H2>
          <p className="leading-loose mb-4">
            遅い時間に帰宅して引き戸の鍵が回らない、早朝に出ようとして門扉が開かないといった場面では、時間帯を選ぶ余裕がありません。一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、遅い時間の依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          <p className="leading-loose mb-4">
            引き戸錠や門扉錠の交換は、後継品の有無や扉への加工の要否で金額の幅が変わります。だからこそ内訳を示す方針かどうかが重要です。<Hl>鍵のレスキューは料金をホームページで明示し、現場での追加費用がない</Hl>と掲げています（鍵開け8,000円〜＋出張料0円〜8,800円）。また、<Hl>鍵の生活救急車は出張・見積もり・キャンセルが無料</Hl>のため、提示された金額を見てから依頼するかどうかを判断できます。既存の錠の写真と型番を先に伝えて見積もりを取れば、比較の土台がそろいます。
          </p>
          <p className="leading-loose mb-4">
          ...
          <p className="leading-loose mb-4">
            鍵業者には、依頼を受けて加盟店を手配する「紹介型」と、自社のスタッフが直接対応する「自社対応型」があります。紹介型は対応範囲が広い一方、店舗によって技術・対応に差が出ることがあり、引き戸錠や門扉錠のように扱いに慣れが要る作業では、対応の可否を先に確かめることが大切です。今回の紹介では、<Hl>鍵のレスキューが全国約20拠点を自社社員で対応する自社対応型</Hl>で、女性スタッフの指名にも対応しています。依頼時に「自社スタッフか協力店か」を確認してみましょう。
          </p>

          {/* 6｜エリア特有 */}
          <H2 id="tips" num="6">豊橋市で鍵業者を呼ぶ前に確認したいこと（引き戸錠・門扉錠は「錠か、戸や扉か」の切り分けが先）</H2>
          <p className="leading-loose mb-4">
            引き戸の鍵が固くなったとき、最初に確かめたいのは<Hl>錠そのものの不調か、戸の建て付けの不調か</Hl>です。引き戸は長く使ううちに戸が下がったり傾いたりして、錠の受け側とかみ合わなくなることがあります。この状態で錠を替えても解決しません。戸を少し持ち上げると鍵がかかりやすくなる、戸の動きそのものが重い、戸と枠のすき間が上下で違う、といった様子があれば戸側が疑われます。逆に、戸は軽く動くのに鍵の抜き差しや回転だけが重いなら錠側です。錠側なら鍵業者の範囲で、戸側なら建具の業者に相談するのが近道です。電話で症状を伝えて切り分けてもらい、両方に及ぶなら順番を相談してください。引き戸錠の種類と替え方は<Link href="/hikido-kagi/" className="text-primary underline">引き戸の鍵の解説</Link>、錠の型の見分け方は<Link href="/joumae-type-zukan/" className="text-primary underline">錠前タイプ図鑑</Link>で扱っています。
          </p>
          <p className="leading-loose mb-4">
            門扉の錠は、同じ切り分けが<Hl>「錠か、扉や柱か」</Hl>という形になります。錠の部分だけを替えたい、開けてほしいという依頼なら鍵業者に相談できますが、蝶番が傷んで扉が下がっている、門柱がぐらついている、扉が歪んで閉まらないといった不調は、鍵を替えても直らず、外構やエクステリアの業者の範囲です。門扉はもともと屋外にあり、雨風や砂ぼこり、海に近い地域では潮気の影響も受けるため、錠の固着と扉の傷みが同時に進んでいることも珍しくありません。どちらに頼んでも一度は「対応外」と言われることがあるため、錠の位置と扉全体が分かる写真を用意して、両方に相談しておくと手戻りが減ります。錠を替えるか、いっそ門扉の施錠をやめるかも、この段階で考えておく価値があります。門扉を常に施錠すると、宅配や来客、緊急時の出入りに影響するためです。
          </p>
          <p className="leading-loose mb-4">
            屋外の錠は、<Hl>玄関錠より早く傷む</Hl>ものだと考えておいてください。鍵穴に砂ぼこりや潮気が入り込むと動きが重くなり、ここで思いつきの油や汎用の潤滑スプレーを注すと、内部でほこりを抱き込んでかえって動きを悪くすることがあります。乾いた布で鍵穴のまわりを拭き、抜き差しが重くなったら鍵穴専用の潤滑剤を少量使うのが基本です。動きが重い状態で力任せに回すと鍵が折れて鍵穴に残り、作業の手数が増えます。手入れで戻らないなら錠の寿命として交換を検討する時期で、扉ごと替えるかどうかの判断も含めて相談しましょう。症状ごとの対処は<Link href="/kagi-mawaranai/" className="text-primary underline">鍵が回らないときの対処</Link>、寿命の目安は<Link href="/kagi-jumyou/" className="text-primary underline">鍵の寿命と交換目安</Link>、扉ごと替える判断は<Link href="/door-koukan-vs-kagi-koukan/" className="text-primary underline">ドア交換と鍵交換の比較</Link>で解説しています。
          </p>
          <p className="leading-loose mb-4">
            最後に、門扉の錠を強くすれば安心と考えるのは避けてください。門扉は乗り越えたり脇から入ったりできることが多く、<Hl>防犯の本丸は玄関・勝手口・窓の錠</Hl>です。門扉錠に予算をかける前に、玄関や勝手口の錠が古くないか、窓の施錠が抜けていないかを見直すのが先です。引き戸の玄関は開き戸に比べて古い錠が残りやすく、補助錠を足して二重にする方法も有効です。侵入の手口と鍵の関係は<Link href="/akisu-shinnyu-teguchi/" className="text-primary underline">空き巣の侵入手口と鍵の関係</Link>、補助錠の考え方は<Link href="/hojo-jou/" className="text-primary underline">補助錠の選び方</Link>、勝手口と窓は<Link href="/katteguchi-mado-bouhan/" className="text-primary underline">勝手口・窓の鍵の防犯対策</Link>で扱っています。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">豊橋市の鍵業者の失敗しない選び方</H2>
          <p className="leading-loose mb-6">
            鍵業者選びで後悔しないためには、次の4つのステップを踏むことが大切です。引き戸錠や門扉錠の依頼は、錠と戸や扉のどちらが原因かを整理しておくことがそのまま頼み先の正しさにつながります。
          </p>
          {steps.map((s) => (
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">豊橋市の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            豊橋市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝の受付ならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            引き戸の玄関や門扉のある豊橋市の一戸建てでは、鍵の話が開き戸の玄関錠だけで終わりません。錠の不調か戸や扉の不調かを先に切り分ける、錠なら鍵業者・戸や扉なら建具や外構の業者と頼み先を分ける、屋外の錠は油を注さず専用の潤滑剤で手入れして寿命がきたら替える。この3つを押さえておけば、「来てもらったのに対応外だった」という手戻りを避けやすくなります。そのうえで、本記事の一次確認値を出発点に、対象と錠の種類に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["豊橋市", "引き戸錠", "門扉錠", "屋外の錠", "一戸建て", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
