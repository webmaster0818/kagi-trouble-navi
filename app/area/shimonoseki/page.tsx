...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】下関市の鍵開け・鍵交換業者おすすめ5選！船や関門をまたぐ移動の途中で鍵をなくしたときの問い合わせ先の順番も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "下関市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、船や鉄道で本州と九州を行き来する途中で鍵をなくしたときに問い合わせる順番、県をまたいで帰るときの段取りまで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】下関市の鍵開け・鍵交換業者おすすめ5選！船や関門をまたぐ移動の途中で鍵をなくしたときの問い合わせ先の順番も分かる鍵屋比較",
    description:
      "下関市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。移動の途中で鍵をなくしたときに問い合わせる順番と、県をまたいで帰るときの段取りも解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、下関市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（山口県対応）", note: "山口県対応の一次確認値。下関市での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 最後に鍵を触った場所と、そこから乗ったものを書き出す",
    b: "移動の途中で鍵が見当たらないときは、あわてて業者を探す前に、最後に鍵を手にした場所と、そこから先に乗った船・鉄道・バス・タクシーを順番に書き出しましょう。乗り物ごとに忘れ物の窓口が別なので、この順番がそのまま問い合わせの順番になります。そのうえで家に入れないことがはっきりしたら業者に相談します。賃貸の場合は、業者より先に管理会社・大家への連絡が基本です。",
  },
  {
    t: "② 出張費・夜間料金を含めた総額の見積もりを取る",
    b: "広告の「◯◯円〜」は最低価格で、実際は鍵の種類・出張距離・時間帯で変わります。移動の帰りに呼ぶ場合は到着が遅い時間になりやすく、深夜割増の有無が総額を左右します。作業前に、出張費・部材費・深夜割増まで含めた総額を必ず確認しましょう。見積もり無料・キャンセル無料の業者なら、金額を見てから断ることもできます。",
  },
  {
    t: "③ 運営会社を確認する",
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "締め出しなどの緊急時以外は、2〜3社から見積もりを取って総額・条件を比較するのがおすすめです。紛失した鍵の作り直しや、防犯のためのシリンダー交換は日程に余裕を持てる依頼なので、じっくり比較する価値があります。今回の5社はいずれも全国対応型で、下関市からも依頼できます（対応エリアは「山口県」としての一次確認値のため、詳細条件は各社へ確認を）。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "下関市の鍵開け料金の相場はいくらですか？",
    a: "当サイトが一次確認した各社の公式表示では、鍵開けの基本料金はカギ110番6,600円〜、鍵のレスキュー8,000円〜、鍵の生活救急車・JBR8,800円〜（いずれも税込）、カギの救急車は公式目安11,000〜44,000円です。ただしこれは最低価格や目安で、鍵の種類（ディンプルキー等）・時間帯・出張距離で総額は変わります。移動の帰りで到着が遅い時間になる場合は割増が乗ることもあるため、作業前に総額の見積もりを取りましょう。",
    link: { href: "/ryokin/", label: "料金相場の詳細はこちら" },
  },
  {
    q: "船やバスの中で鍵をなくしたかもしれません。どこに問い合わせればいいですか？",
    a: "忘れ物の窓口は乗り物ごとに分かれています。船なら乗船した航路を運航している会社、鉄道なら降りた駅、バスやタクシーなら運行している会社が問い合わせ先です。そのため、最後に鍵を触った場所から降りた順に一つずつたどるのが確実です。問い合わせるときは、乗った日時・区間・座席のあたり・鍵の見た目（キーホルダーの色や形）を伝えられるようにしておくと探してもらいやすくなります。",
    link: { href: "/kagi-funshitsu/", label: "鍵をなくしたときの対処法はこちら" },
  },
  {
    q: "落とした場所が県外かもしれません。遺失届はどこに出せばいいですか？",
    a: "落とした場所がはっきり分からない場合でも、一般には最寄りの交番・警察署で相談すれば遺失届を受け付けてもらえます。移動をまたいでいるときは、思い当たる場所の見当と、移動した区間をあわせて伝えましょう。届け出ておくと、鍵が拾得物として届いたときに連絡を受けられます。落としたのが自宅の鍵で、住所が分かるものと一緒だった場合は、その点も必ず伝えてください。",
  },
  {
    q: "鍵が見つからないまま帰宅しました。すぐ鍵を交換すべきですか？",
    a: "判断の分かれ目は「鍵から住所がたどれる状態だったか」です。定期券や免許証、宛名の書かれたものと一緒に落としていた場合は、拾った人に住所が分かってしまうため、交換を優先して検討する場面です。逆に、鍵だけが単独で、落とした先の見当も付いているなら、数日は届け出の連絡を待つ選択もあります。鍵に刻印された番号から合鍵が作られる仕組みもあるため、番号が見える状態だったかも確認しておきましょう。",
    link: { href: "/key-number-aikagi/", label: "キーナンバーと合鍵の基礎知識はこちら" },
  },
  {
    q: "深夜や早朝でも下関市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「山口県」としての一次確認値のため、下関市での詳細は依頼時に各社へご確認ください。",
  },
  {
    q: "移動中に鍵をなくさないための備えはありますか？",
    a: "まず、鍵に住所や氏名が分かるものを一緒に付けないこと。拾われたときに家の場所が知られてしまいます。次に、鍵に刻印された番号が見えないようにしておくこと。番号から鍵を作れる仕組みがあるためです。そのうえで、家族や近くに住む人と合鍵の預け先を決めておくと、帰宅してから開かないと分かったときの選択肢が増えます。",
...
export default function AreaPageShimonoseki() {
  const articleSchema = {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "下関市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜下関市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "下関市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#tips", label: "6｜下関市で鍵業者を呼ぶ前に確認したいこと（移動の途中でなくした鍵は「どこで降りたか」からたどる）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜下関市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">下関市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <header className="grid gap-4">
            ...
            <ul className="flex flex-wrap gap-2">
              {["下関市", "鍵開け", "鍵交換", "移動中の鍵紛失", "業者比較"].map((t) => (
                <li
                  key={t}
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              下関市は本州の西の端にあり、関門海峡をはさんで九州と向かい合うまちです。船や鉄道、バスで海峡を越えて働きに出る人、買い物や用事で行き来する人が日常的にいます。こうした移動の多い暮らしでやっかいなのが、鍵の紛失です。家を出てから何度も乗り換えていると、どこで落としたのかが分かりにくく、そのうえ乗り物ごとに忘れ物の窓口が別で、県をまたげば届け出の先も分かれます。気づいたときには、家の前で立ち尽くすことになりかねません。
            </p>
            <p>
              本記事では、下関市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、移動の途中で鍵をなくしたときにどの順番で問い合わせればよいか、県をまたいで帰ってくるときに何を先に決めておけばよいかを整理しています。
            </p>
          </div>
          ...
          {/* 1｜業者一覧 */}
          <H2 id="top5" num="1">下関市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            下関市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「山口県」としての一次確認値のため、下関市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※近隣エリアの比較は<Link href="/area/yamaguchi/" className="text-primary underline">山口版</Link>・<Link href="/area/kitakyushu/" className="text-primary underline">北九州版</Link>・<Link href="/area/fukuoka/" className="text-primary underline">福岡版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">下関市の鍵業者をとにかく急いで開けてほしいなら</H2>
          <p className="leading-loose mb-4">
            移動から帰り着いた玄関で開かないと分かったとき、待てる時間には限りがあります。駆けつけスピードの目安を公表している業者を先に押さえておきましょう。<Hl>鍵の生活救急車は最短15分の駆けつけと全国約2,270店の拠点網</Hl>をうたっており、拠点数の多さは到着スピードの裏付けになります。また、<Hl>カギ110番は電話一本で最短5分の手配</Hl>（全国47都道府県の加盟店ネットワークから近隣の業者を手配）を掲げています。
          </p>
          ...
          <p className="leading-loose mb-4">
            帰りの便が遅くなり、家に着いてから鍵がないと気づく——移動の多い暮らしでは十分に起こり得ます。深夜・早朝の依頼では、24時間受付かどうかがまず重要です。一次確認値では、<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、夜間の緊急依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          <p className="leading-loose mb-4">
            鍵の紛失は、開けてもらうだけで済むのか、防犯のためにシリンダーまで交換するのかで金額の幅が大きく変わります。だからこそ、内訳を示す方針の業者かどうかが効いてきます。<Hl>鍵のレスキューは料金をホームページで明示し、現場での追加費用がない</Hl>と掲げています（鍵開け8,000円〜＋出張料0円〜8,800円）。また、<Hl>鍵の生活救急車は出張・見積もり・キャンセルが無料</Hl>のため、提示された金額を見てから依頼するかどうかを判断できます。
          </p>
          <p className="leading-loose mb-4">
          ...
          {/* 6｜エリア特有 */}
          <H2 id="tips" num="6">下関市で鍵業者を呼ぶ前に確認したいこと（移動の途中でなくした鍵は「どこで降りたか」からたどる）</H2>
          <p className="leading-loose mb-4">
            海峡をまたいで行き来した日に鍵が見当たらないと気づいたら、最初にやるのは業者探しではなく、<Hl>最後に鍵を手にした場所と、そこから先に乗ったものを順番に書き出すこと</Hl>です。忘れ物の窓口は乗り物ごとに分かれています。船なら乗船した航路を運航している会社、鉄道なら降りた駅、バスやタクシーなら運行している会社。つまり、降りた順にたどることが、そのまま問い合わせの順番になります。問い合わせるときは、乗った日時と区間、座った場所のおおよその位置、鍵の見た目（キーホルダーの色や形）を伝えられるようにしておくと、探してもらいやすくなります。全体の流れは<Link href="/kagi-funshitsu/" className="text-primary underline">鍵をなくしたときの対処法</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4">
            移動が県をまたいでいると、<Hl>遺失届をどこに出せばよいのか</Hl>で迷いがちです。落とした場所がはっきり分からない場合でも、一般には最寄りの交番・警察署で相談すれば受け付けてもらえます。思い当たる場所の見当と、その日に移動した区間をあわせて伝えましょう。届け出ておけば、鍵が拾得物として届いたときに連絡を受けられます。落としたのが自宅の鍵で、定期券や宛名の書かれたものと一緒だったなら、住所が他人に分かってしまう状態だということも必ず伝えてください。ここは後の判断に効いてきます。
          </p>
          <p className="leading-loose mb-4">
            次に決めるのが、<Hl>今日のうちに家に入れるか</Hl>です。帰りの便の時刻から逆算して、家に着く時間がはっきりしたら、その時点で業者に電話して到着目安と深夜割増の有無を聞いておきましょう。玄関前に着いてから探し始めるより、移動中に段取りを済ませておいたほうが待つ時間は短くなります。賃貸にお住まいなら、業者より先に管理会社・大家の緊急連絡先へ。合鍵やマスターキーで開けてもらえれば費用がかからずに済む場合もあります。締め出されたときの動き方は<Link href="/shimedashi/" className="text-primary underline">鍵の閉じ込め・締め出しの対処法</Link>で確認できます。
          </p>
          <p className="leading-loose mb-4">
            見つからないまま帰宅した場合、<Hl>すぐ鍵を替えるかどうかの分かれ目は「鍵から住所がたどれる状態だったか」</Hl>です。住所の分かるものと一緒に落としていたなら交換を優先する場面ですし、鍵だけが単独で落とした先の見当も付いているなら、数日は届け出の連絡を待つ選択もあります。あわせて確認しておきたいのが、鍵に刻印された番号が見える状態だったかどうか。番号から鍵を作れる仕組みがあるためです。考え方は<Link href="/key-number-aikagi/" className="text-primary underline">キーナンバーと合鍵の基礎知識</Link>と<Link href="/kagi-koukan-timing/" className="text-primary underline">鍵交換のタイミング</Link>で扱っています。日ごろの備えとしては、鍵に住所や氏名が分かるものを付けないこと、家族や近くに住む人と合鍵の預け先を決めておくことが効きます。<Link href="/aikagi/" className="text-primary underline">合鍵の作り方と考え方</Link>もあわせてご覧ください。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">下関市の鍵業者の失敗しない選び方</H2>
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">下関市の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            下関市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝の受付ならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            海峡をまたいで行き来する暮らしでは、鍵をなくした場所が分かりにくくなります。最後に鍵を触った場所から降りた順にたどる、思い当たる場所の見当とともに最寄りの警察へ遺失届を出す、帰り着く時間から逆算して業者に到着目安を聞いておく、賃貸ならまず管理会社へ。そして、住所が分かる状態で落としたかどうかで交換の急ぎ具合を決める。この順番を覚えておけば、玄関の前で途方に暮れる時間を短くできます。本記事の一次確認値を出発点に、状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["下関市", "移動中の鍵紛失", "遺失届", "キーナンバー", "業者比較", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/key-number-aikagi/", label: "キーナンバーと合鍵の基礎知識" },
