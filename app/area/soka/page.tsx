...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】草加市の鍵開け・鍵交換業者おすすめ5選！トイレ・浴室・子ども部屋の室内錠が開かないときの非常解錠と頼み先も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "草加市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、トイレ・浴室・子ども部屋の室内錠が開かないときに先に探したい非常解錠の仕組みと、鍵屋に頼む前の切り分けまで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】草加市の鍵開け・鍵交換業者おすすめ5選！トイレ・浴室・子ども部屋の室内錠が開かないときの非常解錠と頼み先も分かる鍵屋比較",
    description:
      "草加市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。トイレ・浴室・子ども部屋の室内錠が開かないときに先に探す非常解錠の仕組みと、鍵屋に頼むときの伝え方も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、草加市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（埼玉県対応）", note: "埼玉県対応の一次確認値。草加市での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① どの扉の、どんな錠かを整理する",
    b: "対象がトイレなのか浴室なのか居室なのか、扉は開き戸か引き戸か折れ戸かを伝えます。錠の形も重要で、ドアノブやレバーの中心に小さな穴や溝があるか、内側のつまみを回す形か、外側に使用中を示す表示窓があるかを見てください。中に人がいるかどうか、応答があるかどうかは最初に伝えるべき情報です。",
  },
  {
    t: "② 出張費・夜間料金を含めた総額の見積もりを取る",
    b: "広告の「◯◯円〜」は最低価格で、実際は錠の種類・出張距離・時間帯で変わります。室内の錠は、開けるだけで済む場合と、ハンドルや錠を交換する場合とで金額の幅が出ます。作業前に、その場で開けるまでの費用と、交換まで進んだ場合の費用を分けて確認しておきましょう。",
  },
  {
    t: "③ 運営会社を確認する",
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "中に人がいない部屋の錠や、調子が悪いだけの錠の交換は日程に余裕を持てる依頼なので、2〜3社から見積もりを取って総額・提案内容を比較する価値があります。今回の5社はいずれも全国対応型で、草加市からも依頼できます（対応エリアは「埼玉県」としての一次確認値のため、詳細条件は各社へ確認を）。錠の形と扉の種類を同じ条件で伝えれば、取り扱いの可否と金額の差が見えやすくなります。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "草加市の鍵開け料金の相場はいくらですか？",
  ...
  {
    q: "トイレの中で鍵が回らなくなりました。まずどうすればいいですか？",
    a: "多くの室内錠には、外側から開けられる非常解錠の仕組みが備わっています。ドアノブやレバーの中心にある小さな穴や溝がそれで、コインやマイナスドライバーを差して回す、細い棒を押し込むといった操作で解錠できる製品が一般的です。まずはその穴や溝がないかを探してみてください。中にいる人が落ち着いていられるよう、声をかけながら進めるのも大切です。",
    link: { href: "/shitsunai-toilet-kagi/", label: "室内・トイレの鍵の解説はこちら" },
  },
  {
    q: "子どもが部屋の中で鍵をかけてしまい、出てこられません。",
    a: "まず声をかけて様子を確かめ、応答があるかどうかを確認してください。応答が乏しい、様子がおかしい、浴室で湯を張っているといった場合は、鍵屋を探すより先に119番を検討してください。応答があって落ち着いているなら、外側の非常解錠の穴や溝を探し、それでも開かないときに業者へ依頼するという順番になります。子ども部屋の錠は、平常時に外から開けられる仕組みがあるかを確かめておくと安心です。",
    link: { href: "/kodomo-pet-kagi-taisaku/", label: "子どもとペットの鍵対策はこちら" },
  },
  {
    q: "室内の錠も鍵屋に頼めますか？料金は玄関と同じですか？",
    a: "扱っている業者は多いものの、玄関の鍵開けとは料金の区分が別になっていることがあります。開けるだけで済むのか、レバーハンドルや錠ごとの交換になるのかでも金額が変わります。電話の時点で「玄関ではなく室内のトイレの錠」と対象をはっきり伝え、その作業の料金区分と総額の目安を確認してから依頼してください。",
    link: { href: "/ryokin/", label: "料金相場の詳細はこちら" },
  },
  {
    q: "浴室のドアが開きません。鍵屋とリフォーム業者のどちらですか？",
    a: "錠の部分だけの問題なら鍵業者、扉そのものや枠の側の問題なら建具・リフォームの業者という切り分けになります。見分け方の目安は、解錠した状態でもハンドルが動かない、扉が枠に引っかかるといった症状があるかどうかです。判断がつかないときは症状を具体的に伝えて対応できるかを先に聞いてください。対応外なら早めに別の頼み先へ切り替えられます。",
    link: { href: "/joumae-type-zukan/", label: "錠前タイプ図鑑はこちら" },
  },
  {
    q: "深夜や早朝でも草加市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「埼玉県」としての一次確認値のため、草加市での詳細は依頼時に各社へご確認ください。",
  },
];
...
export default function AreaPageSoka() {
  const articleSchema = {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "草加市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜草加市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "草加市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#soka-tips", label: "6｜草加市で鍵業者を呼ぶ前に確認したいこと（家の中の錠は「非常解錠の仕組み」を先に探す）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜草加市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">草加市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <header className="grid gap-4">
            ...
            <ul className="flex flex-wrap gap-2">
              {["草加市", "室内の錠", "トイレ・浴室", "非常解錠", "業者比較"].map((t) => (
                <li
                  key={t}
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              草加市は埼玉県の南東部にあり、東武スカイツリーラインで都心とつながるまちです。駅の周りにマンションが、その外側に戸建ての住宅地が広がり、子育て世帯から高齢の世帯まで幅広く暮らしています。鍵のトラブルというと玄関を思い浮かべますが、実際の困りごとには、トイレや浴室、子ども部屋といった家の中の錠が開かなくなるという種類のものもあります。
            </p>
            <p>
              本記事では、草加市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、家の中の錠が開かないときに最初に探したい非常解錠の仕組みと、それでも開かないときの頼み先の切り分けを整理しています。
            </p>
          </div>
          ...
          {/* 1｜業者一覧 */}
          <H2 id="top5" num="1">草加市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            草加市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「埼玉県」としての一次確認値のため、草加市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※近隣エリアの比較は<Link href="/area/koshigaya/" className="text-primary underline">越谷市版</Link>・<Link href="/area/kawaguchi/" className="text-primary underline">川口市版</Link>・<Link href="/area/saitama/" className="text-primary underline">さいたま版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">草加市の鍵業者をとにかく急いで開けてほしいなら</H2>
          <p className="leading-loose mb-4">
            家の中の錠で人が出られなくなっているときは、玄関のトラブルとは急ぎ方が変わります。中にいるのが小さな子どもや高齢の家族で、応答が乏しい・様子がおかしいという場合は、鍵屋を探すより先に119番を検討してください。駆けつけスピードの目安を公表している業者としては、<Hl>鍵の生活救急車が最短15分の駆けつけと全国約2,270店の拠点網</Hl>をうたっており、拠点数の多さは到着スピードの裏付けになります。また、<Hl>カギ110番は電話一本で最短5分の手配</Hl>（全国47都道府県の加盟店ネットワークから近隣の業者を手配）を掲げています。
          </p>
          ...
          <p className="leading-loose mb-4">
            夜のうちに閉じ込めが起きると、朝まで待つという選択肢が取りにくくなります。トイレや浴室の中に人がいる場合はもちろん、誰もいない部屋であっても、扉が開かないままでは翌朝の支度に差し支えます。一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、遅い時間の依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          <p className="leading-loose mb-4">
            室内の錠は、玄関の鍵開けとは料金の区分が違うことがあります。開けるだけで済むのか、レバーハンドルや錠ごとの交換になるのかで金額が変わるため、どこまでが見積もりに含まれるのかを先に示す方針かどうかが効いてきます。<Hl>鍵のレスキューは料金をホームページで明示し、現場での追加費用がない</Hl>と掲げています（鍵開け8,000円〜＋出張料0円〜8,800円）。また、<Hl>鍵の生活救急車は出張・見積もり・キャンセルが無料</Hl>のため、提示された金額を見てから依頼するかどうかを判断できます。
          </p>
          <p className="leading-loose mb-4">
          ...
          <p className="leading-loose mb-4">
            鍵業者には、依頼を受けて加盟店を手配する「紹介型」と、自社のスタッフが直接対応する「自社対応型」があります。紹介型は対応範囲が広い一方、店舗によって技術・対応に差が出ることがあります。今回の紹介では、<Hl>鍵のレスキューが全国約20拠点を自社社員で対応する自社対応型</Hl>で、女性スタッフの指名にも対応しています。室内の間仕切り錠や浴室の錠は玄関錠とは構造も部材も違うため、依頼時に「自社スタッフか協力店か」とあわせて、室内の錠も扱えるか、部材が取り寄せになるかを確認してみましょう。
          </p>

          {/* 6｜エリア特有 */}
          <H2 id="soka-tips" num="6">草加市で鍵業者を呼ぶ前に確認したいこと（家の中の錠は「非常解錠の仕組み」を先に探す）</H2>
          <p className="leading-loose mb-4">
            家の中の錠は、玄関の錠とは<Hl>目的そのものが違います</Hl>。防犯のためではなく、使用中であることを示し、不意に開けられないようにするための錠です。そのため多くの製品には、外側から開けられる非常解錠の仕組みが最初から備わっています。ドアノブやレバーの中心にある小さな穴、細い溝、押し込む形のボタン。コインやマイナスドライバー、細い棒で操作できる製品が一般的です。困ってから探し始めるのではなく、<Hl>平常時に自宅の室内錠のどこにその仕組みがあるかを確かめておく</Hl>と、いざというときに数分で終わります。室内錠の構造は<Link href="/shitsunai-toilet-kagi/" className="text-primary underline">室内・トイレの鍵の解説</Link>、錠の型の見分け方は<Link href="/joumae-type-zukan/" className="text-primary underline">錠前タイプ図鑑</Link>で確認できます。
          </p>
          <p className="leading-loose mb-4">
            中に人がいる場合は、<Hl>鍵の問題として扱ってよいかどうかをまず見極めてください</Hl>。声をかけて応答があり、落ち着いていられる状態なら、非常解錠を試し、それでも開かなければ業者に依頼するという順番で構いません。一方、応答が乏しい、様子がおかしい、浴室で湯を張っている、暑さや寒さが厳しいといった状況では、開けるまでの時間そのものが危険につながります。その場合は鍵屋を探すより先に119番を検討してください。小さな子どもや高齢の家族がいる家では、どの部屋に外から開けられない錠があるかを事前に把握しておくことが、いちばんの備えになります。子ども側の備えは<Link href="/kodomo-pet-kagi-taisaku/" className="text-primary underline">子どもとペットの鍵対策</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4">
            業者に頼むときは、<Hl>玄関ではないことを最初に伝える</Hl>のが要点です。電話口で「鍵が開かない」とだけ言うと玄関の鍵開けとして話が進み、到着してから対象が違うと分かって料金区分が変わる、部材がなくてその日は開けるだけになる、といったずれが起きます。対象の部屋、扉の形（開き戸・引き戸・折れ戸）、錠の形、外側に穴や溝があるか、中に人がいるか。この5つを伝えれば、対応できるかどうかと概算がその場で分かります。料金の区分は業者ごとに違うため、総額の目安も電話の段階で確認しておきましょう。相場感は<Link href="/ryokin/" className="text-primary underline">鍵開け・鍵交換の料金相場</Link>で解説しています。
          </p>
          <p className="leading-loose mb-4">
            開いたあとのことも決めておきましょう。<Hl>同じ錠で二度目が起きるかどうかは、原因によって変わります</Hl>。単に内側のつまみが回されていただけなら開けて終わりですが、ハンドルが空回りする、つまみが戻らない、扉を閉めると勝手にかかるといった症状があるなら、錠やハンドルの側が傷んでいます。その場合は交換を検討する場面で、部材の取り寄せが必要なら日を改めることになります。ドアノブごと替えるのか、錠の部分だけを替えるのかで費用も変わるため、見積もりは選択肢を並べて出してもらいましょう。交換の考え方は<Link href="/doorknob-koukan/" className="text-primary underline">ドアノブ交換の解説</Link>、替えどきの目安は<Link href="/kagi-koukan-timing/" className="text-primary underline">鍵交換のタイミング</Link>で扱っています。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">草加市の鍵業者の失敗しない選び方</H2>
          <p className="leading-loose mb-6">
            鍵業者選びで後悔しないためには、次の4つのステップを踏むことが大切です。室内の錠は製品ごとに構造が違い、玄関の鍵開けとは扱いも料金区分も変わるぶん、伝える情報の精度が結果を左右します。
          </p>
          {steps.map((s) => (
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">草加市の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            草加市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝の受付ならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            家の中の錠は、防犯のためではなく使用中を示すための錠で、多くは外から開けられる仕組みを備えています。自宅のどの室内錠にその仕組みがあるかを平常時に確かめておく、中に人がいて応答が乏しいときは開けることより安全を優先する、業者には玄関ではないと最初に伝える、開いたあとは同じことが起きる錠かどうかを見ておく。この4つを押さえておけば、慌てる場面が減ります。そのうえで、本記事の一次確認値を出発点に、目的と予算に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["草加市", "間仕切り錠", "非常解錠", "子どもの閉じ込め", "ドアノブ交換", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-3">
              {[
                ...
                { href: "/area/saitama/", label: "さいたまの鍵開け・鍵交換業者おすすめ5選" },
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/doorknob-koukan/", label: "ドアノブ交換の解説" },
