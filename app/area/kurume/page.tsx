...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】久留米市の鍵開け・鍵交換業者おすすめ5選！火災保険や共済の付帯サービスで鍵開けを頼めないかの確かめ方も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "久留米市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、火災保険や共済・クレジットカードに付いていることがある鍵の駆けつけサービスの確かめ方、使う場合の手配の順番まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】久留米市の鍵開け・鍵交換業者おすすめ5選！火災保険や共済の付帯サービスで鍵開けを頼めないかの確かめ方も分かる鍵屋比較",
    description:
      "久留米市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。火災保険や共済に付いていることがある鍵の駆けつけサービスの確かめ方と、使う場合の手配の順番も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、久留米市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（福岡県対応）", note: "福岡県対応の一次確認値。久留米市での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 加入している保険・共済・カードの付帯サービスを先に思い出す",
    b: "鍵開けの費用は、必ずしも全額を自分で出すものとは限りません。火災保険や共済、クレジットカード、住宅の会員サービスに「鍵開けの駆けつけ」が付いていることがあります。ただし多くは保険金（補償）ではなくサービスの付帯で、有無・回数・作業範囲は契約ごとに違います。締め出しで屋外にいる、家の中に人がいるといった急ぎの場面では安全を優先し、確認は後回しでかまいません。賃貸の場合は、業者より先に管理会社・大家への連絡が基本です。",
  },
  {
    t: "② 出張費・夜間料金を含めた総額の見積もりを取る",
    b: "広告の「◯◯円〜」は最低価格で、実際は鍵の種類・出張距離・時間帯で変わります。付帯サービスを使わずに自分で頼む場合はもちろん、使う場合でも部材費などが自己負担になることがあります。作業前に、出張費・部材費・深夜割増まで含めた総額を必ず確認しましょう。見積もり無料・キャンセル無料の業者なら、金額を見てから断ることもできます。",
  },
  {
    t: "③ 運営会社を確認する",
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "締め出しなどの緊急時以外は、2〜3社から見積もりを取って総額・条件を比較するのがおすすめです。玄関錠の交換や合鍵の作製は日程に余裕を持てる依頼なので、じっくり比較する価値があります。今回の5社はいずれも全国対応型で、久留米市からも依頼できます（対応エリアは「福岡県」としての一次確認値のため、詳細条件は各社へ確認を）。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "久留米市の鍵開け料金の相場はいくらですか？",
    a: "当サイトが一次確認した各社の公式表示では、鍵開けの基本料金はカギ110番6,600円〜、鍵のレスキュー8,000円〜、鍵の生活救急車・JBR8,800円〜（いずれも税込）、カギの救急車は公式目安11,000〜44,000円です。ただしこれは最低価格や目安で、鍵の種類（ディンプルキー等）・時間帯・出張距離で総額は変わります。加入している保険や共済に鍵の駆けつけサービスが付いている場合は自己負担が変わることもあるため、作業前に総額の見積もりを取ったうえで比べましょう。",
    link: { href: "/ryokin/", label: "料金相場の詳細はこちら" },
  },
  {
    q: "火災保険や共済に鍵開けのサービスが付いていることがあると聞きました。本当ですか？",
    a: "契約によっては、火災保険や共済に暮らしのトラブルの駆けつけサービスが付帯していて、その中に鍵開けが含まれていることがあります。ただしこれは損害を補償する保険金とは性格が異なり、あくまで付帯サービスです。付いているかどうか、何回まで使えるか、どこまでの作業が対象かは契約ごとに違うため、保険証券や会員ページ、契約先のコールセンターで確認するのが確実です。",
    link: { href: "/kasai-hoken-kagi/", label: "火災保険の鍵開けサポートの解説はこちら" },
  },
  {
    q: "付帯サービスを使いたいとき、自分で鍵業者を呼んでから請求してもいいですか？",
    a: "付帯サービスは、そのサービスの窓口に連絡して手配してもらう形が一般的です。先に自分で業者を呼んで作業を終えてしまうと、対象外として扱われることがあります。使うつもりなら、業者に電話する前にサービスの窓口へ連絡し、手配の方法と自己負担になる範囲（部材費や時間帯の割増など）を聞いてから進めてください。",
    link: { href: "/kasai-hoken-kagi/", label: "付帯サービスの確認手順はこちら" },
  },
  {
    q: "賃貸に住んでいます。付帯サービスと管理会社、どちらが先ですか？",
    a: "賃貸の鍵は大家・管理会社の管理物にあたるため、締め出しや紛失のときはまず管理会社・大家の連絡先に相談するのが基本です。合鍵やマスターキーで開けてもらえれば費用がかからずに済む場合もあります。そのうえで自分で業者を手配することになったら、加入している保険や共済の付帯サービスが使えるかを確認しましょう。鍵を交換する場合の費用を誰が負担するかも、あわせて確認しておくと後の行き違いを防げます。",
    link: { href: "/chintai-kagi-koukan-hiyou/", label: "賃貸の鍵交換費用の考え方はこちら" },
  },
  {
    q: "深夜や早朝でも久留米市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「福岡県」としての一次確認値のため、久留米市での詳細は依頼時に各社へご確認ください。",
  },
  {
    q: "付帯サービスが使えないと分かりました。費用を抑える方法はありますか？",
    a: "急ぎでなければ、複数社から総額の見積もりを取って比べるのが基本です。一次確認値では、鍵の生活救急車が出張・見積もり・キャンセル無料、鍵のレスキューが料金のホームページ明示と現場での追加費用なしを掲げており、金額を見てから判断しやすい方針です。また、深夜にすぐ入る必要がないなら、時間帯をずらして依頼することで割増を避けられる場合もあります。",
    link: { href: "/ryokin-index/", label: "主要業者の料金一次確認まとめはこちら" },
  },
];
...
export default function AreaPageKurume() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】久留米市の鍵開け・鍵交換業者おすすめ5選！火災保険や共済の付帯サービスで鍵開けを頼めないかの確かめ方も分かる鍵屋比較",
    description:
      "久留米市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。火災保険や共済に付いていることがある鍵の駆けつけサービスの確かめ方も解説します。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "久留米市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜久留米市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "久留米市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#tips", label: "6｜久留米市で鍵業者を呼ぶ前に確認したいこと（その費用、全額自分で払うとは限らない）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜久留米市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">久留米市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <header className="grid gap-4">
            ...
            <ul className="flex flex-wrap gap-2">
              {["久留米市", "鍵開け", "鍵交換", "火災保険の付帯サービス", "業者比較"].map((t) => (
                <li
                  key={t}
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              久留米市は福岡県の南部にある中核市で、中心部の集合住宅から郊外の戸建てまで、住まいの形に幅があるまちです。鍵をなくした、玄関が開かない、鍵が回らない——そんなとき、多くの人は反射的に「いくらかかるのか」を考えます。ところが、その費用を全額自分で払うとは限らない、ということはあまり知られていません。加入している火災保険や共済、持っているクレジットカードに、鍵開けの駆けつけが付いていることがあるからです。
            </p>
            <p>
              本記事では、久留米市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、保険や共済の付帯サービスに鍵開けが含まれているかをどう確かめるか、使う場合に手配の順番をどうすればよいかを整理しています。
            </p>
          </div>
          ...
          {/* 1｜業者一覧 */}
          <H2 id="top5" num="1">久留米市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            久留米市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「福岡県」としての一次確認値のため、久留米市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※近隣エリアの比較は<Link href="/area/fukuoka/" className="text-primary underline">福岡版</Link>・<Link href="/area/kitakyushu/" className="text-primary underline">北九州版</Link>・<Link href="/area/saga/" className="text-primary underline">佐賀版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">久留米市の鍵業者をとにかく急いで開けてほしいなら</H2>
          <p className="leading-loose mb-4">
            締め出しなどで一刻も早く開けてほしい場合は、保険や共済の付帯サービスを調べている余裕はありません。駆けつけスピードの目安を公表している業者を先に押さえておきましょう。<Hl>鍵の生活救急車は最短15分の駆けつけと全国約2,270店の拠点網</Hl>をうたっており、拠点数の多さは到着スピードの裏付けになります。また、<Hl>カギ110番は電話一本で最短5分の手配</Hl>（全国47都道府県の加盟店ネットワークから近隣の業者を手配）を掲げています。
          </p>
          ...
          <p className="leading-loose mb-4">
            帰宅した夜に「鍵がない」と気づくのは、久留米市に限らず起こりがちなトラブルです。深夜・早朝の依頼では、24時間受付かどうかがまず重要です。一次確認値では、<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、夜間の緊急依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          <p className="leading-loose mb-4">
            付帯サービスを使う場合でも、部材費など一部が自己負担になることがあります。だからこそ、内訳を示す方針の業者かどうかが効いてきます。<Hl>鍵のレスキューは料金をホームページで明示し、現場での追加費用がない</Hl>と掲げています（鍵開け8,000円〜＋出張料0円〜8,800円）。また、<Hl>鍵の生活救急車は出張・見積もり・キャンセルが無料</Hl>のため、提示された金額を見てから依頼するかどうかを判断できます。
          </p>
          <p className="leading-loose mb-4">
          ...
          {/* 6｜エリア特有 */}
          <H2 id="tips" num="6">久留米市で鍵業者を呼ぶ前に確認したいこと（その費用、全額自分で払うとは限らない）</H2>
          <p className="leading-loose mb-4">
            鍵のトラブルで業者を探し始める前に、一度だけ思い出してほしいことがあります。<Hl>加入している火災保険や共済、持っているクレジットカード、住宅メーカーや管理会社の会員サービスに、鍵開けの駆けつけが付いていることがある</Hl>という点です。ここで大事なのは、多くの場合それが損害を補償する保険金ではなく、契約に付いてくる「サービス」だということ。だから、付いているかどうか、何回まで使えるか、どこまでの作業が対象かは契約ごとにばらばらです。確かめ方は決まっていて、保険証券や共済の加入者証、カード会員ページ、契約先のコールセンターのいずれかに当たります。仕組みの全体像は<Link href="/kasai-hoken-kagi/" className="text-primary underline">火災保険の鍵開けサポートの解説</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4">
            使うと決めたら、<Hl>手配はそのサービスの窓口を通すのが原則</Hl>です。先に自分で業者を呼んで作業を終えてから請求しても、対象外として扱われることがあります。窓口に電話したときに聞いておきたいのは、鍵開けだけが対象なのか交換も含むのか、部材費や時間帯の割増は自己負担になるのか、対象は玄関だけなのか勝手口や物置も含むのか、そして年に何回まで使えるのかです。ここまで確かめておけば、届いた請求書を見て驚くことはなくなります。
          </p>
          <p className="leading-loose mb-4">
            ただし、<Hl>確認より安全が優先される場面</Hl>があります。締め出されて外にいる、家の中に小さな子どもや高齢の家族がいる、体調がすぐれない——こうしたときは、付帯サービスの有無を調べる前に、まず開けてもらうことを優先してください。賃貸にお住まいなら、そもそも業者より先に管理会社・大家へ連絡するのが基本です。合鍵やマスターキーで開けてもらえれば費用がかからずに済む場合もあります。手順は<Link href="/shimedashi/" className="text-primary underline">鍵の閉じ込め・締め出しの対処法</Link>と<Link href="/chintai-kagi-koukan-hiyou/" className="text-primary underline">賃貸の鍵交換費用の考え方</Link>で確認できます。
          </p>
          <p className="leading-loose mb-4">
            調べた結果、付帯サービスがなかった、あるいは今回の作業は対象外だった、という結論になることも当然あります。そのときは<Hl>相場を知ってから複数社を比べる</Hl>という通常のやり方に戻るだけです。急ぎでなければ2〜3社に総額を出してもらい、条件を並べて選びましょう。目安は<Link href="/ryokin/" className="text-primary underline">鍵開け・鍵交換の料金相場</Link>、各社の一次確認値は<Link href="/ryokin-index/" className="text-primary underline">主要業者の料金一次確認まとめ</Link>で確認できます。なお、外出先で鍵をなくした可能性があるときは、業者を呼ぶ前に立ち寄り先への問い合わせと警察への遺失届を先に済ませてください。詳しくは<Link href="/kagi-funshitsu/" className="text-primary underline">鍵をなくしたときの対処法</Link>をご覧ください。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">久留米市の鍵業者の失敗しない選び方</H2>
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">久留米市の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            久留米市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝の受付ならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            そして、業者を選ぶ前にもう一段階あります。火災保険や共済、クレジットカードに鍵の駆けつけが付いていないか。付いているなら、手配はその窓口を通す。自己負担の範囲と使える回数を聞いてから進める。急ぎのときは安全を優先して先に開けてもらい、賃貸ならまず管理会社へ。この順番を頭に入れておけば、同じトラブルでも支払う金額と気持ちの余裕が変わります。本記事の一次確認値を出発点に、状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["久留米市", "火災保険と鍵", "共済の付帯サービス", "鍵開け費用", "業者比較", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                { href: "/kasai-hoken-kagi/", label: "火災保険の鍵開けサポート" },
                ...
                { href: "/chintai-kagi-koukan-hiyou/", label: "賃貸の鍵交換費用の考え方" },
              ].map((l) => (
                <li key={l.href}>
                  <Link
                    href={l.href}
