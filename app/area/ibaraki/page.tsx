...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】茨木市の鍵開け・鍵交換業者おすすめ5選！離れて暮らす子の下宿の鍵トラブルを親が代わりに手配するときの本人確認と支払いの段取りも分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "茨木市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、親元を離れて暮らす子の下宿で鍵のトラブルが起きたときに親が電話で代わりに手配する段取り、現地で立ち会う本人の本人確認と遠くにいる親の支払い方法の確かめ方まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】茨木市の鍵開け・鍵交換業者おすすめ5選！離れて暮らす子の下宿の鍵トラブルを親が代わりに手配するときの本人確認と支払いの段取りも分かる鍵屋比較",
    description:
      "茨木市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。離れて暮らす子の下宿の鍵トラブルを親が代わりに手配するときの本人確認と支払いの段取りも解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、茨木市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（大阪府対応）", note: "大阪府対応の一次確認値。茨木市での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 状況と鍵の種類を整理する",
    b: "「開かない」「なくした」といった状況に加えて、電話をかけるのが誰で、現地に立ち会うのが誰か、支払いを誰がどの方法で行うのかを整理してから電話しましょう。親が遠くから代わりに手配する場合は、その旨を最初に伝えるのが段取りの出発点です。立ち会う本人が住所の分かる身分証を持っているか、賃貸の契約者が親と本人のどちらの名義かも確かめておきます。交換まで考えている場合は、扉側面の金属プレートに刻印された錠前のメーカー名・型番も控えておくと話が早く進みます。賃貸であれば、業者より先に管理会社への連絡が必要です。",
  },
  {
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "緊急時以外は、2〜3社から見積もりを取って総額・条件を比較するのがおすすめです。依頼者と立会人が別になる場合の扱いや、遠くにいる親が支払える方法は業者によって違うため、同じ条件を伝えて比べると差が見えやすくなります。今回の5社はいずれも全国対応型で、茨木市からも依頼できます（対応エリアは「大阪府」としての一次確認値のため、詳細条件は各社へ確認を）。関西エリアでは鍵猿も候補になります。金額に納得できない場合は、その場で契約せず一度断る選択肢もあります。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "茨木市の鍵開け料金の相場はいくらですか？",
    a: "当サイトが一次確認した各社の公式表示では、鍵開けの基本料金はカギ110番6,600円〜、鍵のレスキュー8,000円〜、鍵の生活救急車・JBR8,800円〜（いずれも税込）、カギの救急車は公式目安11,000〜44,000円です。ただしこれは最低価格や目安で、鍵の種類（ディンプルキー等）・時間帯・出張距離で総額は変わります。親が代わりに手配する場合も金額の決まり方は同じなので、作業前に総額の見積もりを取り、本人と親の両方がその金額を把握した状態で作業に進みましょう。",
    link: { href: "/ryokin/", label: "料金相場の詳細はこちら" },
  },
  {
    q: "離れて暮らす子から「鍵をなくした」と連絡がありました。親が代わりに業者を手配できますか？",
    a: "電話での依頼自体は親が行えますが、最初に「依頼者は親で、現地に立ち会うのは本人」であることを伝えてください。業者は解錠時に、その部屋に住んでいる人であることを現地で確かめる必要があるため、立ち会う本人が住所の分かる身分証を用意できるかが要点になります。賃貸なら業者より先に管理会社へ連絡し、契約者が親名義であれば親から、本人名義であれば本人から連絡します。到着目安と本人の居場所を共有し、本人のスマートフォンの電池が残っているかも確かめておきましょう。",
    link: { href: "/kagi-funshitsu/", label: "鍵をなくしたときの対処はこちら" },
  },
  {
    q: "本人が持っている身分証が学生証だけです。本人確認はどうなりますか？",
    a: "学生証には下宿の住所が載っていないことが多く、それだけでは住所の確認になりません。免許証やマイナンバーカードで住所を下宿に移していればそれが使えます。移していない場合は、宛名入りの郵便物や賃貸借契約書など下宿の住所と本人の名前が分かるものを組み合わせる方法があり、どの書類で足りるかは電話の段階で業者に確認してください。賃貸で管理会社が本人を把握していれば、管理会社から業者へ確認してもらえることもあります。",
    link: { href: "/shimedashi/", label: "締め出されたときの対処はこちら" },
  },
  {
    q: "支払いは遠くにいる親が済ませられますか？",
    a: "現地で現金かカードで支払う方式が基本で、親が離れた場所から支払えるかは業者によって異なります。電話の段階で「支払うのは親で、現地にはいない」と伝え、事前の振り込みやカード決済、本人が立て替えて後日精算するなど、どの方法が取れるかを確認してください。本人が立て替える場合は、手持ちで足りるかを見積もりの金額と照らして先に確かめます。領収書の宛名や送り先も、このときに決めておくと後で手間が省けます。",
  },
  {
    q: "茨木市は「鍵猿」にも依頼できますか？",
  ...
  {
    q: "深夜や早朝でも茨木市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「大阪府」としての一次確認値のため、茨木市での詳細は依頼時に各社へご確認ください。",
  },
];
...
export default function AreaPageIbaraki() {
  const articleSchema = {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "茨木市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜茨木市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "茨木市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#tips", label: "6｜茨木市で鍵業者を呼ぶ前に確認したいこと（親が代わりに手配するなら「誰が立ち会い、誰が払うか」を先に決める）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜茨木市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">茨木市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <header className="grid gap-4">
            ...
            <ul className="flex flex-wrap gap-2">
              {["茨木市", "親が代わりに手配", "下宿の鍵", "本人確認と支払い", "業者比較"].map((t) => (
                <li
                  key={t}
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              茨木市は大阪府の北部、大阪市内と京都方面のどちらへも鉄道で通える位置にあり、大学のキャンパスがあることから、親元を離れて下宿やアパートで暮らす学生も住む街です。子から「鍵をなくした」「部屋に入れない」と連絡が来たとき、遠くに住む親が電話で業者を手配するという場面が生まれます。ところが鍵の依頼は、電話をかける人と現地で立ち会う人が別になると、本人確認を誰がどう受けるのか、支払いを誰がどの方法で行うのかという段取りが一気に増えます。本人が持っている身分証が学生証だけで住所の確認にならない、親が離れた場所から支払えない、といったつまずきは、電話の最初のひと言で防げるものがほとんどです。
            </p>
            <p>
              本記事では、茨木市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、離れて暮らす子の下宿の鍵トラブルを親が代わりに手配するときに、本人確認と支払いをどう段取りすればよいかを整理しています。
            </p>
          </div>
          ...
          {/* 1｜業者一覧 */}
          <H2 id="top5" num="1">茨木市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            茨木市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「大阪府」としての一次確認値のため、茨木市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-2">
            ※近隣エリアの比較は<Link href="/area/takatsuki/" className="text-primary underline">高槻市版</Link>・<Link href="/area/osaka/" className="text-primary underline">大阪版</Link>・<Link href="/area/kyoto/" className="text-primary underline">京都版</Link>もご覧ください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※茨木市を含む関西エリアでは、関西中心に対応する<Link href="/agents/kagizaru/" className="text-primary underline">鍵猿</Link>も選択肢になります（<Link href="/area/osaka/" className="text-primary underline">大阪版の比較記事</Link>に掲載しています）。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">茨木市の鍵業者をとにかく急いで開けてほしいなら</H2>
          <p className="leading-loose mb-4">
            親が遠くから手配する場合、現地で待つのは本人一人です。夜道や寒い時期に玄関前で長く待たせないためにも、駆けつけの目安は押さえておきましょう。駆けつけスピードの目安を公表している業者としては、<Hl>鍵の生活救急車が最短15分の駆けつけと全国約2,270店の拠点網</Hl>をうたっており、拠点数の多さは到着スピードの裏付けになります。また、<Hl>カギ110番は電話一本で最短5分の手配</Hl>（全国47都道府県の加盟店ネットワークから近隣の業者を手配）を掲げています。
          </p>
          ...
          <p className="leading-loose mb-4">
            子からの連絡が夜遅くになることは珍しくなく、管理会社の受付が終わっている時間帯に親が動かざるを得ない場面もあります。一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、遅い時間の依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          <p className="leading-loose mb-4">
            支払う人が現地にいない依頼では、本人と親の両方が同じ金額を把握していることが何より重要で、内訳を先に示す方針かどうかが効いてきます。<Hl>鍵のレスキューは料金をホームページで明示し、現場での追加費用がない</Hl>と掲げています（鍵開け8,000円〜＋出張料0円〜8,800円）。また、<Hl>鍵の生活救急車は出張・見積もり・キャンセルが無料</Hl>のため、提示された金額を見てから依頼するかどうかを判断できます。現地で提示された見積もりを本人から親へ電話で伝えてもらい、親が了承してから作業に進む流れを最初の電話で決めておくと、金額の食い違いを防げます。
          </p>
          <p className="leading-loose mb-4">
          ...
          <p className="leading-loose mb-4">
            鍵業者には、依頼を受けて加盟店を手配する「紹介型」と、自社のスタッフが直接対応する「自社対応型」があります。紹介型は対応範囲が広い一方、店舗によって技術・対応に差が出ることがあります。今回の紹介では、<Hl>鍵のレスキューが全国約20拠点を自社社員で対応する自社対応型</Hl>で、女性スタッフの指名にも対応しています。娘が一人で立ち会う場面では、女性スタッフを指名できることが親側の安心材料になることもあります。依頼時に「自社スタッフか協力店か」を確認してみましょう。
          </p>

          {/* 6｜エリア特有 */}
          <H2 id="tips" num="6">茨木市で鍵業者を呼ぶ前に確認したいこと（親が代わりに手配するなら「誰が立ち会い、誰が払うか」を先に決める）</H2>
          <p className="leading-loose mb-4">
            子から連絡が来たら、業者に電話する前に<Hl>本人がカバンやポケット、直前にいた場所を確かめ終えているか</Hl>を聞いてください。ここを飛ばして親が手配すると、業者が着いたあとに鍵が見つかり、キャンセル料だけが残ることがあります。見つからなければ、次に決めるのは「電話するのは誰か」「立ち会うのは誰か」「払うのは誰か」の3点です。親が電話し、本人が立ち会い、親が払う、という組み合わせになるなら、<Hl>最初のひと言で「依頼者は親で、現地に立ち会うのは本人です」と伝える</Hl>のが段取りの出発点になります。初動の全体像は<Link href="/kagi-funshitsu/" className="text-primary underline">鍵をなくしたときの対処</Link>と<Link href="/shimedashi/" className="text-primary underline">締め出されたときの対処</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4">
            解錠の現場では、その部屋に住んでいる人であることを確かめる本人確認が行われ、<Hl>確認を受けるのは電話をかけた親ではなく、立ち会う本人</Hl>です。学生証には下宿の住所が載っていないことが多く、それだけでは足りません。免許証やマイナンバーカードで住所を下宿に移していればそれが使え、移していなければ宛名入りの郵便物や賃貸借契約書など、下宿の住所と本人の名前が分かるものを組み合わせることになります。どの書類で足りるかは電話の段階で業者に確認し、本人に用意させてください。賃貸なら業者より先に管理会社へ連絡します。契約者が親名義なら親から、本人名義なら本人から連絡するのが筋で、管理会社が本人を把握していれば、業者への確認を管理会社が担ってくれることもあります。連絡先は契約書に書かれているため、入居時に親も控えておくと探す手間が省けます。
          </p>
          <p className="leading-loose mb-4">
            支払いは現地で現金かカードが基本で、<Hl>親が離れた場所から支払えるかどうかは業者によって違います</Hl>。電話の段階で「支払うのは親で、現地にはいない」と伝え、事前の振り込み、カード決済、本人が立て替えて後日精算のうち、どの方法が取れるかを確認してください。本人が立て替えるなら、見積もりの金額と手持ちを照らし合わせ、足りないときの手段を先に決めておきます。現地で提示された見積もりは、本人から親へ電話で伝えてもらい、親が了承してから作業に進む流れにしておくと、金額の食い違いが起きません。領収書の宛名と送り先もこのときに決めておきましょう。
          </p>
          <p className="leading-loose mb-4">
            同じことを繰り返さない備えとしては、<Hl>合鍵を実家に置いても遠方では当日の役に立たない</Hl>という前提で考えます。本人の生活圏に信頼できる預け先があればそこに一本、なければキーボックスを使い、暗証番号を知る人が増え続けない運用にします。賃貸の合鍵作成は管理会社の許可が前提です。考え方は<Link href="/aikagi/" className="text-primary underline">合鍵の作り方</Link>と<Link href="/key-box-kanri/" className="text-primary underline">キーボックスの管理</Link>で扱っています。なくした鍵が見つからないまま日が経つなら、賃貸の鍵交換の費用負担は<Link href="/chintai-kagi-koukan-hiyou/" className="text-primary underline">賃貸の鍵交換費用</Link>を参考に、管理会社と相談して決めてください。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">茨木市の鍵業者の失敗しない選び方</H2>
          <p className="leading-loose mb-6">
            鍵業者選びで後悔しないためには、次の4つのステップを踏むことが大切です。依頼者と立会人が別になる依頼は、最初の電話で伝える内容がそのまま結果につながります。
          </p>
          {steps.map((s) => (
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">茨木市の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            茨木市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝の受付ならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            大学のキャンパスがあり、親元を離れて暮らす学生も住む茨木市では、鍵の依頼で電話をかける人と現地に立つ人が別になることがあります。最初のひと言で依頼者と立会人が別だと伝える、本人確認は立ち会う本人が住所の分かる書類で受けると決めて用意させる、支払いの方法と見積もりの了承の流れを親と本人で共有する。この3つを押さえておけば、遠くにいても手配は進み、本人を玄関前で長く待たせずに済みます。そのうえで、本記事の一次確認値を出発点に、その段取りに応じてくれる業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["茨木市", "下宿の鍵", "本人確認", "支払い方法", "鍵紛失", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
