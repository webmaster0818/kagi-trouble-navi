...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】富士市の鍵開け・鍵交換業者おすすめ5選！在宅できる時間が限られる家の鍵交換の日程の決め方も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "富士市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、交代勤務などで在宅できる時間が限られる家が鍵交換・修理の日程と立ち会いをどう決めるかまで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】富士市の鍵開け・鍵交換業者おすすめ5選！在宅できる時間が限られる家の鍵交換の日程の決め方も分かる鍵屋比較",
    description:
      "富士市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。交代勤務などで在宅できる時間が限られる家の、鍵交換・修理の日程と立ち会いの決め方も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、富士市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
...
const steps = [
  {
    t: "① 状況と鍵の種類を整理する",
    b: "「重い」「引っかかる」「抜きにくい」など症状と、玄関・勝手口・物置といった対象、錠前のメーカー名・型番（扉の側面にある金属プレートの刻印）をメモしておくと、電話での見積もり精度が上がります。あわせて、在宅できる曜日・時間帯も最初に伝えましょう。賃貸の鍵交換は大家・管理会社の承諾が前提のため、業者より先に管理会社へ連絡するのが基本です。",
  },
  {
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "締め出しなどの緊急時以外は、2〜3社から見積もりを取って総額・条件を比較するのがおすすめです。鍵の交換・修理は日程を選べる依頼なので、同じ条件（錠の型・希望する時間帯・作業内容）を伝えて総額を比べる価値があります。今回の5社はいずれも全国対応型で富士市から依頼できます。金額に納得できない場合は、その場で契約せず一度断る選択肢もあります。",
  },
];

const faqs = [
  {
    q: "富士市の鍵開け料金の相場はいくらですか？",
  ...
  {
    q: "深夜や早朝でも富士市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。ただし深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「静岡県」としての一次確認値のため、富士市での詳細な対応可否は依頼時にご確認ください。",
  },
  {
    q: "鍵交換の作業にはどれくらい時間がかかりますか？",
    a: "作業時間は錠の種類・扉の状態・交換する範囲によって変わるため、一律の目安を示すことはできません。電話の段階で症状と錠前のメーカー名・型番を伝え、想定される作業時間と、見積もりと作業を同じ訪問で終えられるかを聞いておきましょう。部材の取り寄せが必要な錠では、訪問が2回に分かれることがあります。",
  },
  {
    q: "来てもらう時間帯を指定することはできますか？",
    a: "時間帯の指定に応じられるかは業者・加盟店によって異なります。緊急の鍵開けと違い、交換や修理は日程を選べる依頼なので、希望する曜日・時間帯を最初に伝えて調整できるかを確認しましょう。早朝・深夜には割増料金が設定されていることがあり、有無や適用される時間帯は業者ごとに異なります。総額とあわせて確認してください。",
  },
  {
    q: "家族が代わりに立ち会っても作業してもらえますか？",
    a: "立ち会いを契約者本人に限るかどうかは業者によって異なるため、電話の段階で確認してください。家族が立ち会う場合は、当日に追加費用が出たときに誰が判断するか、支払いはどの方法で行うかを先に決めておくと、現地で話が止まりません。なお賃貸で鍵交換を伴う作業は、大家・管理会社の承諾が前提です。",
  },
  {
...
export default function AreaFujiPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】富士市の鍵開け・鍵交換業者おすすめ5選！在宅できる時間が限られる家の鍵交換の日程の決め方も分かる鍵屋比較",
    description:
      "富士市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "富士市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#fuji5",
      label: "1｜富士市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "富士市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#fuji-tips", label: "6｜富士市で鍵業者を呼ぶ前に確認したいこと（在宅できる時間が限られる家の鍵交換の日程と立ち会い）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜富士市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">富士市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              「玄関の鍵が前より重いけれど、業者に来てもらう時間が作れない」「日中は寝ているので、その時間に来られると困る」——工場の交代勤務など、家族それぞれの生活時間がずれている家では、鍵の交換や修理は「頼むかどうか」より「いつ来てもらうか」でつまずきがちです。緊急の鍵開けと違い、交換や修理は日程を選べる依頼です。だからこそ、電話の段階で時間の条件を先に出しておくと、話が一度で進みます。
            </p>
            <p>
              本記事では、富士市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、在宅できる時間が限られる家が鍵の交換・修理の日程と立ち会いをどう決めるかを整理しています。ぜひ鍵業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="fuji5" num="1">富士市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            富士市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「静岡県」としての一次確認値のため、富士市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※他の都市の比較は、<Link href="/area/shizuoka/" className="text-primary underline">富士市版</Link>・<Link href="/area/hamamatsu/" className="text-primary underline">浜松版</Link>・<Link href="/area/numazu/" className="text-primary underline">沼津市版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">富士市の鍵業者をとにかく急いで開けてほしいなら</H2>
          ...
          {/* 6｜エリア特有 */}
          <H2 id="fuji-tips" num="6">富士市で鍵業者を呼ぶ前に確認したいこと（在宅できる時間が限られる家の鍵交換の日程と立ち会い）</H2>
          <p className="leading-loose mb-4">
            交換や修理の依頼で最初に伝えたいのは、症状よりも<Hl>来てもらえる時間帯の条件</Hl>です。そのうえで、見積もりと作業を同じ訪問で終えられるか、作業にどれくらい時間がかかるか、希望する時間帯に対応できるかの3点を聞きます。早朝・深夜には割増料金が設定されていることがあり、有無・金額・適用される時間帯は業者や加盟店ごとに異なります（当サイトでは各社の深夜割増の金額までは一次確認していません）。時間帯を選べる依頼なら、割増の付かない時間に収めるほうが総額は抑えられます。料金の考え方は<Link href="/ryokin/" className="text-primary underline">鍵開け・鍵交換の料金相場ページ</Link>で解説しています。
          </p>
          <p className="leading-loose mb-4">
            日程が読めなくなる原因の多くは、<Hl>錠の部材がすぐ手に入るかどうか</Hl>です。取り寄せが必要な錠では、見積もりの訪問と交換作業が別の日になることがあります。扉の側面に付いた金属プレートの刻印から錠前のメーカー名・型番を控えて電話で伝えておくと、部材の目処と訪問回数の見通しが立てやすくなります。錠の見分け方は<Link href="/joumae-type-zukan/" className="text-primary underline">錠前の種類図鑑</Link>と<Link href="/kagi-shurui-zukan/" className="text-primary underline">鍵の種類図鑑</Link>にまとめています。交換まで進めるかどうかの判断は<Link href="/kagi-koukan-timing/" className="text-primary underline">鍵交換のタイミング</Link>が目安になります。
          </p>
          <p className="leading-loose mb-4">
            次に決めておきたいのが<Hl>誰が立ち会うか</Hl>です。家族が代わりに立ち会う場合は、当日に追加費用が出たときに誰が判断するかと、支払いの方法を先に決めておくと、現地で電話をやり取りせずに済みます。賃貸にお住まいなら、そもそも鍵の交換は大家・管理会社の承諾が前提で、承諾を得る前に日程だけ押さえても話は進みません。費用の負担区分もあわせて確認しておきましょう。考え方は<Link href="/chintai-kagi-koukan-hiyou/" className="text-primary underline">賃貸の鍵交換費用の解説記事</Link>で整理しています。
          </p>
          <p className="leading-loose mb-4">
            生活時間がずれている家で見落とされやすいのが、<Hl>鍵の不調に気づいた人と、業者に電話する人が違う</Hl>ことです。「重い」「引っかかる」「抜きにくい」といった症状は、気づいた人がその場でメモに残さないと伝わりません。いつ・どの鍵で・どんなときに起きるかを一行書いておけば、電話口での説明が具体的になり、見積もりの精度も上がります。放置すると、ある日突然開かなくなることがあります。時間が取れる日を待つあいだも、症状の進み方は見ておきましょう。判断の材料は<Link href="/kagi-mawaranai/" className="text-primary underline">鍵が回らないときの対処法</Link>と<Link href="/kagi-jumyou/" className="text-primary underline">鍵の寿命の解説記事</Link>にあります。
          </p>


          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">富士市の鍵業者の失敗しない選び方</H2>
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">富士市の鍵業者でよくある質問</H2>
              ...
              <div key={f.q} className="rounded-[2px] border border-border">
                ...
                <p className="flex gap-3 px-5 py-4 text-sm leading-relaxed">
                  ...
                  <span>
                    ...
                    {f.q.includes("時間がかかります") && (
                      <>
                        {" "}
                        <Link href="/joumae-type-zukan/" className="text-primary underline">錠前の種類図鑑はこちら</Link>
                      </>
                    )}
                    {f.q.includes("時間帯を指定") && (
                      <>
                    ...
                    {f.q.includes("立ち会って") && (
                      <>
                        {" "}
                        <Link href="/chintai-kagi-koukan-hiyou/" className="text-primary underline">賃貸の鍵交換費用の解説はこちら</Link>
                      </>
                    )}
          ...
          <p className="leading-loose mb-4">
            富士市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝のトラブルならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            在宅できる時間が限られていても、鍵の交換・修理は日程を選べる依頼です。時間帯の条件を最初に伝える、錠のメーカー名・型番を控えて部材と訪問回数の見通しを立てる、立ち会いと支払いの担当を家族で決めておく。この3つを先に押さえておけば、勤務の合間でも段取りが組めます。依頼時は作業前に総額の見積もりを確認することが失敗しないための共通ルールです。本記事の一次確認値を出発点に、状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["富士市", "鍵交換", "日程調整", "立ち会い", "業者比較", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-3">
              {[
                ...
                { href: "/area/numazu/", label: "沼津市の鍵開け・鍵交換業者おすすめ5選" },
