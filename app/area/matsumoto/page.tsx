...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】松本市の鍵開け・鍵交換業者おすすめ5選！ドアチェーン・ドアガードが原因で開かないときの見分け方も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "松本市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、鍵は回るのに扉が数センチで止まるときにドアチェーン・ドアガードを疑う見分け方と頼み方まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】松本市の鍵開け・鍵交換業者おすすめ5選！ドアチェーン・ドアガードが原因で開かないときの見分け方も分かる鍵屋比較",
    description:
      "松本市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。ドアチェーン・ドアガードが原因で扉が開かないときの見分け方、やってはいけない対処、再発の防ぎ方も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、松本市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（長野県対応）", note: "長野県対応の一次確認値。松本市での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 止めているものが何かを見てから電話する",
    b: "鍵は回るのか回らないのか。扉はまったく動かないのか、数センチ開いて止まるのか。隙間から金具が見えるか、見えるならそれは上のほうか中ほどか。中に人やペットがいるか。この4点を確かめてから電話すると、業者の側も必要な道具を持って来られます。「鍵が開かない」とだけ伝えると、錠の前提で準備されるため、現場で見立てをやり直すことになります。",
  },
  {
    t: "② 出張費・夜間料金を含めた総額の見積もりを取る",
    b: "広告の「◯◯円〜」は最低価格で、実際は作業の内容・出張距離・時間帯で変わります。チェーンやガードの場合は、取り外しだけで済むのか、金具の交換や扉の調整まで含むのかで金額が変わります。取り外したあとの復旧費が別なのかどうかも含め、内訳の分かる形で総額を出してもらいましょう。",
  },
  {
    t: "③ 運営会社を確認する",
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "中に人がいる場合は急ぎの依頼になりますが、そうでなければ2〜3社に状況を伝えて、扱えるかどうかと金額を比べる余地があります。今回の5社はいずれも全国対応型で、松本市からも依頼できます（対応エリアは「長野県」としての一次確認値のため、詳細条件は各社へ確認を）。チェーンやガードは建具側の部品なので、錠だけを扱う業者と扉まわりの金物まで見る業者で対応範囲が分かれます。同じ状況を伝えて、対応の差を確かめてください。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "松本市の鍵開け料金の相場はいくらですか？",
    a: "当サイトが一次確認した各社の公式表示では、鍵開けの基本料金はカギ110番6,600円〜、鍵のレスキュー8,000円〜、鍵の生活救急車・JBR8,800円〜（いずれも税込）、カギの救急車は公式目安11,000〜44,000円です。ただしこれは最低価格や目安で、鍵の種類（ディンプルキー等）・時間帯・出張距離で総額は変わります。チェーンやドアガードの取り外しは広告の料金区分に当てはまらないことがあるため、状況を伝えたうえで総額の見積もりを取りましょう。",
    link: { href: "/ryokin/", label: "料金相場の詳細はこちら" },
  },
  {
    q: "鍵は回るのに扉が少ししか開きません。原因は何ですか？",
    a: "内側のドアチェーンやU字型のドアガードが掛かっている可能性が高い状況です。開いた隙間から中をのぞくと、金具が斜めに渡っているのが見えます。掛かる原因は、中にいる人が掛けた、扉を勢いよく閉めた拍子に緩んだ金具が落ちた、ガードの軸が摩耗して自然に下りてきた、などです。錠の不調とは対処がまったく違うため、電話の段階で伝えてください。",
    link: { href: "/kagi-mawaranai/", label: "鍵が回らないときの対処はこちら" },
  },
  {
    q: "ドアチェーンが外れなくなりました。自分で外せますか？",
    a: "おすすめしません。隙間から針金や定規を差し込む方法は、うまくいかないまま扉や金具を傷めることが多く、あとの作業と費用が増えます。力ずくで押し開けるのも避けてください。金具は外れても枠がゆがむと錠の掛かり方まで悪くなります。専用の工具を使えば短時間で外せる作業なので、業者に状況を伝えて任せるほうが結果的に安く済みます。",
  },
  {
    q: "中に家族がいる状態でチェーンが掛かってしまいました。どうすればいいですか？",
    a: "電話の最初に「中に人がいる」と伝えてください。子どもや高齢の家族、体調の心配がある人が中にいる場合は、作業の優先度も進め方も変わります。中の人が自分で外せる状態かどうか（外し方が分かるか、手が届くか）も伝えると、到着前に電話でできることを案内してもらえる場合があります。あわせて、火を使ったままでないかも確認してください。",
    link: { href: "/shimedashi/", label: "締め出されたときの対処はこちら" },
  },
  {
    q: "ドアガードごと交換してもらえますか？",
    a: "対応できることが多い作業です。掛かりが甘くなった金具や、軸がぐらつくガードは消耗した部品なので、締め直しか交換で直ります。ただし、自然に落ちてくる原因が扉の側にある場合、金具だけ替えても再発します。丁番が緩んで扉が下がっている、ドアクローザーの閉まる勢いが強すぎるといった場合は、扉の建て付けのほうを直す必要があります。",
    link: { href: "/door-closer/", label: "ドアクローザーの不具合はこちら" },
  },
  {
    q: "深夜や早朝でも松本市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「長野県」としての一次確認値のため、松本市での詳細は依頼時に各社へご確認ください。",
  },
];
...
export default function AreaPageMatsumoto() {
  const articleSchema = {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "松本市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜松本市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "松本市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#matsumoto-tips", label: "6｜松本市で鍵業者を呼ぶ前に確認したいこと（ドアチェーン・ドアガードが原因で開かないときの見分け方）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜松本市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">松本市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <header className="grid gap-4">
            ...
            <ul className="flex flex-wrap gap-2">
              {["松本市", "ドアチェーン", "ドアガード", "扉が開かない", "業者比較"].map((t) => (
                <li
                  key={t}
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              松本市は長野県の中部、松本盆地に開けたまちで、北アルプスへの玄関口としても知られます。市街地には歴史のある建物と新しい住宅が混ざって並び、玄関まわりの造りもさまざまです。鍵のトラブルというと錠そのものを思い浮かべますが、実際の現場では「鍵は回っているのに扉が数センチで止まる」という相談が一定数あります。このとき止めているのは錠ではなく、内側に付いたドアチェーンやドアガードであることが少なくありません。
            </p>
            <p>
              本記事では、松本市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、扉が少ししか開かないときにドアチェーン・ドアガードを疑う見分け方と、自分でやらないほうがよいこと、業者に何を伝えればよいかを整理しています。
            </p>
          </div>
          ...
          {/* 1｜業者一覧 */}
          <H2 id="top5" num="1">松本市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            松本市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「長野県」としての一次確認値のため、松本市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※近隣エリアの比較は<Link href="/area/nagano/" className="text-primary underline">長野版</Link>・<Link href="/area/kofu/" className="text-primary underline">甲府版</Link>・<Link href="/area/joetsu/" className="text-primary underline">上越市版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">松本市の鍵業者をとにかく急いで開けてほしいなら</H2>
          <p className="leading-loose mb-4">
            扉の前で押したり引いたりを繰り返すほど、時間だけが過ぎていきます。原因が錠でないなら、その場で試せることも限られます。駆けつけスピードの目安を公表している業者としては、<Hl>鍵の生活救急車が最短15分の駆けつけと全国約2,270店の拠点網</Hl>をうたっており、拠点数の多さは到着スピードの裏付けになります。また、<Hl>カギ110番は電話一本で最短5分の手配</Hl>（全国47都道府県の加盟店ネットワークから近隣の業者を手配）を掲げています。
          </p>
          ...
          <p className="leading-loose mb-4">
            家に入れないまま夜を越すかどうかは、早い時間に決めたい判断です。中に人がいる状態でチェーンが掛かってしまった場合は、時間帯にかかわらず急ぐ理由があります。一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、遅い時間の依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          <p className="leading-loose mb-4">
            チェーンやガードの取り外しは、錠を開ける作業とは内容が違います。取り外しだけで済むのか、金具の交換まで含むのかで金額が変わるため、内訳を先に見たいところです。<Hl>鍵のレスキューは料金をホームページで明示し、現場での追加費用がない</Hl>と掲げています（鍵開け8,000円〜＋出張料0円〜8,800円）。また、<Hl>鍵の生活救急車は出張・見積もり・キャンセルが無料</Hl>のため、提示された金額を見てから依頼するかどうかを判断できます。
          </p>
          <p className="leading-loose mb-4">
          ...
          <p className="leading-loose mb-4">
            鍵業者には、依頼を受けて加盟店を手配する「紹介型」と、自社のスタッフが直接対応する「自社対応型」があります。紹介型は対応範囲が広い一方、店舗によって技術・対応に差が出ることがあります。今回の紹介では、<Hl>鍵のレスキューが全国約20拠点を自社社員で対応する自社対応型</Hl>で、女性スタッフの指名にも対応しています。チェーンやガードの金具は建具側の部品なので、錠だけを扱う業者と、扉まわりの金物まで見る業者では対応範囲が違います。電話の段階で「錠ではなくチェーンが掛かっている」と伝えて、扱えるかどうかを確かめてください。
          </p>

          {/* 6｜エリア特有 */}
          <H2 id="matsumoto-tips" num="6">松本市で鍵業者を呼ぶ前に確認したいこと（ドアチェーン・ドアガードが原因で開かないときの見分け方）</H2>
          <p className="leading-loose mb-4">
            鍵は回った、施錠は解けている。それなのに扉が数センチで止まる。この場合に疑うのが、内側に付いた<Hl>ドアチェーン、あるいはU字型のドアガード</Hl>です。掛かる原因はいくつかあります。中にいる人が掛けた。外出時に扉を勢いよく閉めた拍子に、緩んだ金具が振動で落ちた。ガードの軸が摩耗して、扉の開閉のたびに自然と下りてくるようになっていた。原因が錠でないのに「鍵が開かない」と伝えると、業者の側も錠の前提で準備してくるため、現場で見立てをやり直すことになります。錠の不調との切り分けは<Link href="/kagi-mawaranai/" className="text-primary underline">鍵が回らないときの対処</Link>が参考になります。
          </p>
          <p className="leading-loose mb-4">
            見分け方は難しくありません。開いた数センチの隙間から中をのぞくと、金具が斜めに渡っているのが見えます。<Hl>引っかかる位置が扉の上のほうならドアガード、中ほどの高さで金属のくさりが見えるならドアチェーン</Hl>であることが多い。扉を押したときに金属が当たる音がするかどうかも手がかりです。もうひとつ、最初に確かめるべきことがあります。中に人がいるかどうかです。子どもや高齢の家族、ペットが中にいるなら、その事実を電話の最初に伝えてください。作業の優先度も、進め方も変わります。締め出し全般の動き方は<Link href="/shimedashi/" className="text-primary underline">締め出されたときの対処</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4">
            自分でやらないほうがよいことが2つあります。ひとつは、隙間から針金や定規を差し込んで外そうとすること。<Hl>うまくいかないまま扉や金具を傷めると、あとの作業が増えて費用も上がります</Hl>。もうひとつは、力ずくで押し開けることです。金具は外れるかもしれませんが、枠がゆがむと錠の掛かり方まで悪くなり、結局は扉ごとの調整が必要になります。業者に頼んだ場合は、隙間から工具を入れて金具を外す方法や、状況によっては金具ごと取り外す方法が取られます。取り外したあとの復旧や部品の交換は別に費用がかかるため、作業の前に範囲と金額を確認してください。金額の目安は<Link href="/ryokin/" className="text-primary underline">鍵開け・鍵交換の料金相場</Link>で確認できます。
          </p>
          <p className="leading-loose mb-4">
            開いたあとは、同じことが起きないようにしておきましょう。掛かりが甘くなった金具、軸がぐらつくガードは<Hl>消耗した部品なので、締め直しか交換で直します</Hl>。外出するときにチェーンを掛けない習慣にするだけでも、外から掛かってしまう事故は防げます。自然に落ちてくる場合は、扉の側に原因があることもあります。丁番が緩んで扉が下がっている、ドアクローザーの閉まる勢いが強すぎる。この場合は金具だけ替えても再発するので、扉の建て付けのほうを直します。扉の閉まり方の調整は<Link href="/door-closer/" className="text-primary underline">ドアクローザーの不具合</Link>、防犯のために補助的な錠を足したい場合は<Link href="/hojo-jou/" className="text-primary underline">補助錠の選び方</Link>で扱っています。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">松本市の鍵業者の失敗しない選び方</H2>
          <p className="leading-loose mb-6">
            鍵業者選びで後悔しないためには、次の4つのステップを踏むことが大切です。原因が錠ではない依頼では、最初に何を伝えるかで到着後の作業がまるごと変わります。
          </p>
          {steps.map((s) => (
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">松本市の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            松本市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝の受付ならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            鍵は回るのに扉が数センチで止まるなら、止めているのは錠ではなくドアチェーンかドアガードかもしれません。隙間から金具を確かめ、中に人がいるかを最初に伝える。針金で外そうとしない、力ずくで押し開けない。開いたあとは、金具の締め直しか交換で再発を防ぎ、自然に落ちてくるなら扉の建て付けのほうを疑う。この4つを押さえたうえで、本記事の一次確認値を出発点に、目的と予算に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["松本市", "ドアチェーン", "U字ロック", "扉が数センチで止まる", "建て付け", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                ...
                { href: "/doorknob-koukan/", label: "ドアノブ交換" },
