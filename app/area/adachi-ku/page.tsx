...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】足立区の鍵開け・鍵交換業者おすすめ5選！賃貸の鍵交換の進め方も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "足立区で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、賃貸で入居時に鍵交換を希望するときの伝え方まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】足立区の鍵開け・鍵交換業者おすすめ5選！賃貸の鍵交換の進め方も分かる鍵屋比較",
    description:
      "足立区で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。賃貸の入居時に鍵交換を希望するときの伝え方と、入居中の交換の進め方も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、足立区内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（東京都対応）", note: "東京都対応の一次確認値。足立区での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 状況と鍵の種類を整理する",
    b: "「鍵をなくした」「入居にあわせて交換したい」など状況と、物件が賃貸か持ち家か、賃貸なら管理会社・大家の連絡先をメモしておくと、その後の動きがスムーズです。賃貸の場合は、業者より先に管理会社・大家への連絡が基本です。",
  },
  {
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "締め出しなどの緊急時以外は、2〜3社から見積もりを取って総額・条件を比較するのがおすすめです。今回の5社はいずれも全国対応型で、足立区からも依頼できます（対応エリアは「東京都」としての一次確認値のため、詳細条件は各社へ確認を）。金額に納得できない場合は、その場で契約せず一度断る選択肢もあります。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "足立区の鍵開け料金の相場はいくらですか？",
  ...
  {
    q: "深夜や早朝でも足立区に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。ただし深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「東京都」としての一次確認値のため、足立区での詳細は依頼時に各社へご確認ください。",
  },
  {
    q: "入居時に鍵交換をお願いしたいとき、どう伝えればよいですか？",
    a: "契約前の段階で「前の入居者から鍵は交換されますか。されない場合、交換をお願いできますか」と不動産会社に確認するのがスムーズです。費用や負担の扱いは物件・契約によって異なるため、見積書や契約書の記載を確認しましょう。交換される鍵の種類（ディンプルキーかどうかなど）もあわせて聞いておくと安心です。",
    link: { href: "/chintai-kagi-koukan-hiyou/", label: "賃貸の鍵交換費用の解説はこちら" },
  },
  {
    q: "賃貸で鍵をなくしました。自分の判断で交換してよいですか？",
    a: "無断での交換は避け、必ず先に管理会社・大家へ連絡しましょう。賃貸の鍵は大家・管理会社の管理物にあたるため、無断交換は契約上のトラブルにつながる恐れがあります。紛失の経緯を伝えれば、指定業者の案内やマスターキーでの解錠など、進め方を示してもらえる場合があります。",
    link: { href: "/kagi-funshitsu/", label: "鍵をなくしたときの対処はこちら" },
  },
  {
    q: "賃貸の鍵交換の費用は誰が負担しますか？",
    a: "一律の決まりがあるわけではなく、契約内容や交換の理由（入居時の交換か、入居者都合の紛失かなど）によって扱いが異なります。契約書や重要事項説明書の記載を確認し、不明な場合は管理会社・不動産会社に確認しましょう。金額に納得できないときは、内訳の説明を求めることが大切です。",
  },
  {
...
export default function AreaAdachiKuPage() {
  const articleSchema = {
    ...
    headline:
      "【2026年最新】足立区の鍵開け・鍵交換業者おすすめ5選！賃貸の鍵交換の進め方も分かる鍵屋比較",
    description:
      "足立区で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較した記事です。",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "足立区の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜足立区で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "足立区の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#tips", label: "6｜足立区で鍵業者を呼ぶ前に確認したいこと（賃貸の鍵交換・入居時の伝え方）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜足立区の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">足立区の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              「入居する部屋の鍵が、前の入居者のときから替わっているのか気になる」「賃貸でも自分の判断で鍵を交換してよいのか分からない」——賃貸住宅で暮らす人にとって、鍵の交換は大家・管理会社との調整が絡む分かりにくいテーマです。入居時に交換を希望するときの伝え方と、入居中に交換したくなったときの進め方を整理します。
            </p>
            <p>
              本記事では、足立区内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、賃貸の鍵交換を進めるときの手順もまとめています。ぜひ鍵業者選びの参考にしてください。
            </p>
          </div>
          ...
          {/* 1｜5選 */}
          <H2 id="top5" num="1">足立区で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            足立区内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「東京都」としての一次確認値のため、足立区での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">足立区の鍵業者をとにかく急いで開けてほしいなら</H2>
          ...
          <p className="leading-loose mb-4">
            足立区でも、深夜の締め出しや帰宅後に紛失へ気づくトラブルは起こり得ます。この時間帯に頼れるのは24時間受付の業者で、一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、夜間の緊急依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          {/* 6｜区特有 */}
          <H2 id="tips" num="6">足立区で鍵業者を呼ぶ前に確認したいこと（賃貸の鍵交換・入居時の交換希望の伝え方）</H2>
          <p className="leading-loose mb-4">
            入居時の鍵交換は、<Hl>契約前の段階で「鍵交換の有無・費用・負担の扱い」を不動産会社に確認する</Hl>のがスタートです。交換を希望する場合は「前の入居者から鍵は交換されますか。されない場合、交換をお願いできますか」と契約時に申し出るとスムーズです。費用の扱いは物件・契約によって異なるため、見積書や契約書の記載で確認しましょう。費用の目安は<Link href="/chintai-kagi-koukan-hiyou/" className="text-primary underline">賃貸の鍵交換費用の解説</Link>で、入居前後の確認事項は<Link href="/hikkoshi-kagi-checklist/" className="text-primary underline">引っ越し時の鍵チェックリスト</Link>でまとめています。
          </p>
          <p className="leading-loose mb-4">
            入居中に交換したくなった場合の大原則は、<Hl>無断で交換せず、必ず事前に管理会社・大家へ相談する</Hl>ことです。賃貸の鍵は大家・管理会社の管理物にあたるため、無断交換は契約上のトラブルにつながる恐れがあります。「鍵をなくした」「防犯面が不安」など理由を具体的に伝えると話が進めやすく、管理会社指定の業者・鍵の種類を案内されることもあります。賃貸でできる防犯の工夫は<Link href="/chintai-bouhan/" className="text-primary underline">賃貸の防犯対策</Link>をご覧ください。
          </p>
          <p className="leading-loose mb-4">
            緊急の締め出し・紛失のときも、<Hl>鍵業者より先に管理会社・大家の連絡先に電話する</Hl>のが基本です。合鍵やマスターキーで開けてもらえれば、費用がかからずに済む場合があります。連絡がつかず業者に依頼する場合は、作業前に総額の見積もりを確認し、後日必ず管理会社へ報告しましょう。動き方の詳細は<Link href="/shimedashi/" className="text-primary underline">締め出されたときの対処</Link>と<Link href="/kagi-funshitsu/" className="text-primary underline">鍵をなくしたときの対処</Link>にまとめています。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">足立区の鍵業者の失敗しない選び方</H2>
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">足立区の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            足立区で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝のトラブルならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            賃貸の鍵交換は、入居時なら契約前の確認と契約時の申し出、入居中なら管理会社・大家への事前相談、という「先に確認する」姿勢がすべての基本です。緊急の締め出しや紛失でも、業者より先に管理会社へ連絡すれば費用をかけずに解決できる場合があります。業者に依頼する場合は、作業前に総額の見積もりを確認することが失敗しないためのポイントです。本記事の一次確認値を出発点に、状況に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["足立区", "東京23区", "鍵開け", "鍵交換", "24時間対応", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
