...
export const metadata: Metadata = {
  title: {
    absolute:
      "【2026年最新】倉敷市の鍵開け・鍵交換業者おすすめ5選！古い持ち家の引き戸錠を残したまま補助錠で防犯を上げる考え方も分かる鍵屋比較｜鍵トラブルナビ",
  },
  description:
    "倉敷市で鍵開け・鍵交換を頼める鍵業者5社を一次確認値で比較。カギ110番（鍵開け6,600円〜）・鍵の生活救急車（最短15分）・JBR・鍵のレスキュー・カギの救急車の料金と受付時間、古い住宅地の持ち家や実家に多い引き戸錠の弱点と、戸を替えずに補助錠で防犯性を上げる考え方まで編集部が中立にまとめました。",
  alternates: { canonical: `${SITE}${PATH}` },
  openGraph: {
    title:
      "【2026年最新】倉敷市の鍵開け・鍵交換業者おすすめ5選！古い持ち家の引き戸錠を残したまま補助錠で防犯を上げる考え方も分かる鍵屋比較",
    description:
      "倉敷市で鍵開け・鍵交換を頼める鍵業者5社を、料金・受付時間の一次確認値で比較。古い持ち家の引き戸錠の弱点と、補助錠で防犯性を上げる考え方も解説します。",
    url: `${SITE}${PATH}`,
    type: "article",
...
const agents: AreaAgent[] = [
  {
    ...
    intro: (
      <>
        ...
        で、24時間365日受付・電話一本で最短5分の手配をうたっています。全国47都道府県の加盟店ネットワークが対象のため、倉敷市内の依頼でも近隣の加盟店が手配される仕組みです。見積もりは無料で、出張費・作業費・部材費を含めた金額を事前に提示する明朗会計を掲げています。
      </>
    ),
    recommend: [
    ...
    table: [
      ...
      { k: "受付時間", v: "24時間365日" },
      { k: "対応エリア", v: "全国47都道府県（岡山県対応）", note: "岡山県対応の一次確認値。倉敷市での詳細な対応可否・条件は依頼時に各社へ確認" },
...
const steps = [
  {
    t: "① 状況と鍵の種類を整理する",
    b: "「開かない」「回りにくい」「防犯を上げたい」といった状況に加えて、玄関が開き戸なのか引き戸なのかを最初に伝えましょう。引き戸の場合は、鍵が戸の重なる部分（召合せ）に付いているのか、戸の端（戸先）に付いているのかも伝えるポイントです。交換や補助錠の追加まで考えている場合は、戸の厚みと錠の周りの写真を用意しておくと、対応できる製品があるかの相談が早く進みます。",
  },
  {
  ...
  {
    t: "④ 急ぎでなければ複数社を比較する",
    b: "締め出しなどの緊急時以外は、2〜3社から見積もりを取って総額・条件を比較するのがおすすめです。引き戸の錠の交換や補助錠の追加は日程に余裕を持てる依頼なので、じっくり比較する価値があります。引き戸に対応できる製品の選択肢は開き戸より限られるため、提案された製品名と理由も聞いておくと比較しやすくなります。今回の5社はいずれも全国対応型で、倉敷市からも依頼できます（対応エリアは「岡山県」としての一次確認値のため、詳細条件は各社へ確認を）。",
  },
];

const faqs: AreaFaq[] = [
  {
    q: "倉敷市の鍵開け料金の相場はいくらですか？",
    a: "当サイトが一次確認した各社の公式表示では、鍵開けの基本料金はカギ110番6,600円〜、鍵のレスキュー8,000円〜、鍵の生活救急車・JBR8,800円〜（いずれも税込）、カギの救急車は公式目安11,000〜44,000円です。ただしこれは最低価格や目安で、鍵の種類・時間帯・出張距離で総額は変わります。引き戸の錠は開き戸とは製品も作業も異なるため、玄関が引き戸であることを伝えたうえで総額の見積もりを取りましょう。",
    link: { href: "/ryokin/", label: "料金相場の詳細はこちら" },
  },
  {
    q: "古い引き戸の鍵は交換できますか？",
    a: "多くの場合、引き戸用の錠に交換できます。引き戸の錠には、戸が重なる部分に付ける召合せ錠と、戸の端に付ける戸先錠があり、今付いているものと同じ位置・同じ形の製品を選ぶのが基本です。ただし戸の厚みや古い規格によっては、そのまま合う製品がなく、加工や別の方法を検討することがあります。戸の厚みと錠の周りの写真を用意して相談すると、可否が早く分かります。",
    link: { href: "/hikido-kagi/", label: "引き戸の鍵交換・後付けの基礎はこちら" },
  },
  {
    q: "引き戸を替えずに防犯性を上げる方法はありますか？",
    a: "今の錠を残したまま補助錠を追加し、鍵を二つにする方法があります。鍵が二つあると開けるのに手間がかかるため、侵入をあきらめさせる効果が期待できます。引き戸用の補助錠には、戸の重なる部分に付けるものや、戸の内側からレールに固定するものなどがあり、戸の形や厚みで選べる製品が変わります。戸を替える場合に比べて費用を抑えやすいのも利点です。",
    link: { href: "/hojo-jou/", label: "補助錠の選び方はこちら" },
  },
  {
    q: "引き戸の鍵が回りにくくなりました。自分で直せますか？",
    a: "引き戸は建て付けのずれで戸の重なりが変わり、錠がかみ合いにくくなることがあります。この場合は錠そのものより戸の調整が必要なことがあるため、思いつきで潤滑剤を注すのは避けてください。油分を含む一般的な潤滑剤は、内部でほこりを抱き込んで動きをかえって悪くすることがあります。無理に力を入れて回すと鍵が折れて鍵穴に残り、作業の手数が増えます。",
    link: { href: "/kagi-mawaranai/", label: "鍵が回らないときの対処はこちら" },
  },
  {
    q: "深夜や早朝でも倉敷市に来てくれますか？",
    a: "カギ110番・JBR・鍵のレスキューは24時間365日受付を掲げており、カギの救急車も多くの加盟店が24時間受付です。深夜帯は割増料金や到着時間の変動があり得るため、電話の際に深夜料金の有無と到着目安を確認してから依頼するのがおすすめです。なお各社の対応エリアは「岡山県」としての一次確認値のため、倉敷市での詳細は依頼時に各社へご確認ください。",
  },
  {
    q: "実家の鍵を離れて暮らす家族でも持っておきたいのですが。",
    a: "古い引き戸錠の鍵はギザギザの刻みキーであることが多く、鍵の複製に対応する店舗や鍵業者で合鍵を作れることが一般的です。ただし、複製しやすい鍵はそれだけ第三者にも複製されやすいという面があります。家族の分を作る際は本数を決めて誰が持つかを記録し、玄関の外や植木鉢の下などに置いておく運用は避けてください。防犯性も上げたい場合は、合鍵を作るタイミングで補助錠の追加をあわせて検討する方法があります。",
...
export default function AreaPageKurashiki() {
  const articleSchema = {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "倉敷市の鍵開け・鍵交換業者おすすめ5選", item: `${SITE}${PATH}` },
    ],
  };
  ...
  const toc: { href: string; label: string; sub?: { href: string; label: string }[] }[] = [
    {
      href: "#top5",
      label: "1｜倉敷市で人気のおすすめ・優良の鍵業者5選",
      sub: [
        { href: "#hikaku", label: "倉敷市の鍵業者を一覧表で徹底比較" },
    ...
    { href: "#tips", label: "6｜倉敷市で鍵業者を呼ぶ前に確認したいこと（引き戸錠は「戸を替えない選択肢」から考える）" },
    { href: "#erabikata", label: "7｜失敗しない鍵業者の選び方" },
    { href: "#faq", label: "8｜倉敷市の鍵業者でよくある質問" },
        ...
        <div className="mx-auto max-w-4xl px-4 pt-4 pb-12 md:pb-16">
          ...
          <nav aria-label="パンくず" className="text-xs text-text-muted mb-4">
            <ol className="flex flex-wrap gap-1">
              ...
              <li>/</li>
              <li className="text-foreground">倉敷市の鍵開け・鍵交換業者おすすめ5選</li>
            </ol>
          </nav>
          ...
          <header className="grid gap-4">
            ...
            <ul className="flex flex-wrap gap-2">
              {["倉敷市", "引き戸の鍵", "古い持ち家", "補助錠", "業者比較"].map((t) => (
                <li
                  key={t}
          ...
          <div className="mt-6 leading-loose text-foreground">
            <p className="mb-4">
              倉敷市は岡山県南部の中核市で、白壁の町並みで知られる美観地区をはじめ、古くからの住宅地が市内の各所に残るエリアです。昔ながらの住まいや実家では、玄関が開き戸ではなく引き戸で、錠も長く使い続けたものがそのまま付いていることが珍しくありません。引き戸錠は開き戸の錠と構造が違い、防犯の考え方も交換のときの製品の選び方も変わります。「戸ごと替えるしかない」と思い込んで先送りにしているうちに、鍵が回りにくくなってから慌てる、という流れは避けたいところです。
            </p>
            <p>
              本記事では、倉敷市内から依頼できる主要な鍵業者5社を、当サイト編集部が各社公式サイト等で一次確認した料金・受付時間・運営会社の情報だけで比較しました。あわせて、古い持ち家の引き戸錠にどんな弱点があるか、戸を替えずに補助錠で防犯性を上げるにはどう考えればよいかを整理しています。
            </p>
          </div>
          ...
          {/* 1｜業者一覧 */}
          <H2 id="top5" num="1">倉敷市で人気のおすすめ・優良の鍵業者5選</H2>
          <p className="leading-loose mb-2">
            倉敷市内から依頼できる主要な鍵業者5社を紹介します。掲載している料金・受付時間・運営会社は、いずれも編集部が各社公式サイト等で一次確認した値です（確認日は各社の欄に記載）。各社の対応エリアは「岡山県」としての一次確認値のため、倉敷市での詳細な対応可否・条件は依頼時に各社へご確認ください。実際の総額は鍵の種類・時間帯・出張距離で変わるため、必ず作業前に見積もりで確認してください。
          </p>
          <p className="text-sm text-text-muted mb-8">
            ※近隣エリアの比較は<Link href="/area/okayama/" className="text-primary underline">岡山版</Link>・<Link href="/area/hiroshima/" className="text-primary underline">広島版</Link>・<Link href="/area/himeji/" className="text-primary underline">姫路市版</Link>もご覧ください。
          </p>
          ...
          {/* 2｜急ぎ */}
          <H2 id="isogi" num="2">倉敷市の鍵業者をとにかく急いで開けてほしいなら</H2>
          <p className="leading-loose mb-4">
            長く使った引き戸の錠が急にかみ合わなくなり、外出も帰宅もその場で止まることがあります。急ぎで開けてほしい場面に備えて、駆けつけの目安は押さえておきましょう。駆けつけスピードの目安を公表している業者としては、<Hl>鍵の生活救急車が最短15分の駆けつけと全国約2,270店の拠点網</Hl>をうたっており、拠点数の多さは到着スピードの裏付けになります。また、<Hl>カギ110番は電話一本で最短5分の手配</Hl>（全国47都道府県の加盟店ネットワークから近隣の業者を手配）を掲げています。
          </p>
          ...
          <p className="leading-loose mb-4">
            実家に泊まった夜や早朝の外出時に鍵が動かなくなると、時間帯を選ぶ余裕がありません。一次確認値では<Hl>カギ110番・JBR・鍵のレスキューが24時間365日受付</Hl>を掲げており、カギの救急車も多くの加盟店が24時間受付です。特にJBRは賠償責任保険に加入した大手グループで、遅い時間の依頼でも相談しやすい体制です。
          </p>
          <p className="leading-loose mb-4 text-sm text-text-muted">
          ...
          <p className="leading-loose mb-4">
            引き戸の錠は、同じ位置に収まる製品で済むのか、戸の加工が必要になるのかで金額の幅が大きく変わります。だからこそ内訳を示す方針かどうかが効いてきます。<Hl>鍵のレスキューは料金をホームページで明示し、現場での追加費用がない</Hl>と掲げています（鍵開け8,000円〜＋出張料0円〜8,800円）。また、<Hl>鍵の生活救急車は出張・見積もり・キャンセルが無料</Hl>のため、提示された金額を見てから依頼するかどうかを判断できます。玄関が引き戸であることと戸の厚みを先に伝えて見積もりを取れば、比較の土台がそろいます。
          </p>
          <p className="leading-loose mb-4">
          ...
          {/* 6｜エリア特有 */}
          <H2 id="tips" num="6">倉敷市で鍵業者を呼ぶ前に確認したいこと（引き戸錠は「戸を替えない選択肢」から考える）</H2>
          <p className="leading-loose mb-4">
            引き戸の錠でまず知っておきたいのは、<Hl>戸が重なる部分に付く召合せ錠と、戸の端に付く戸先錠という二つの位置がある</Hl>ことです。古い住まいの引き戸には、片方だけが付いているものや、長年の使用で刻みが浅くなった単純な鍵が使われているものがあります。こうした鍵は複製が容易で、こじ開けにも弱い傾向があるため、玄関の防犯上の弱点になりやすい場所です。錠の種類と交換・後付けの基本は<Link href="/hikido-kagi/" className="text-primary underline">引き戸の鍵交換・後付けの基礎</Link>にまとめています。
          </p>
          <p className="leading-loose mb-4">
            防犯性を上げたいとき、<Hl>戸ごと替えなくても、今の錠を残して補助錠を追加する</Hl>という選択肢があります。鍵が二つあると開けるのに手間がかかるため、侵入をあきらめさせる効果が期待できます。引き戸用の補助錠には、戸の重なる部分に付けるものや、戸の内側からレールに固定するものなどがあり、戸の形や厚みで選べる製品が変わります。戸を替える場合に比べて費用を抑えやすく、日程にも余裕を持てます。考え方は<Link href="/hojo-jou/" className="text-primary underline">補助錠の選び方</Link>、引き戸用を含む後付けの選択肢は<Link href="/genkan-kagi-atozuke/" className="text-primary underline">玄関ドアの鍵の後付け方法</Link>で扱っています。
          </p>
          <p className="leading-loose mb-4">
            長く使った引き戸で気をつけたいのが、<Hl>建て付けのずれによる錠のかみ合わせの悪さ</Hl>です。戸の重なりが変わると、錠そのものに問題がなくても鍵が回りにくくなります。この状態で思いつきの潤滑剤を注すと、内部でほこりを抱き込んで動きをかえって悪くすることがあります。無理に力を入れて回すと鍵が折れて鍵穴に残り、作業の手数が増えます。症状ごとの対処は<Link href="/kagi-mawaranai/" className="text-primary underline">鍵が回らないときの対処</Link>で確認できます。相談のときは、玄関が引き戸であること、錠の位置、戸の厚み、錠の周りの写真を用意しておくと、対応できる製品があるかの話が早く進みます。
          </p>
          <p className="leading-loose mb-4">
            玄関の錠を見直すなら、<Hl>勝手口や縁側の掃き出し窓もあわせて見ておく</Hl>ことをおすすめします。古い住まいでは、玄関より人目に付きにくい裏手のほうが侵入に狙われやすく、窓のクレセント錠だけでは防犯錠として十分でないことがあります。要点は<Link href="/katteguchi-mado-bouhan/" className="text-primary underline">勝手口・窓の鍵の防犯対策</Link>、侵入の手口と鍵の関係は<Link href="/akisu-shinnyu-teguchi/" className="text-primary underline">空き巣の侵入手口と鍵の関係</Link>で扱っています。離れて暮らす家族が実家の鍵を持つ場合は、本数を決めて誰が持つかを記録し、玄関の外に置いておく運用は避けてください。
          </p>

          {/* 7｜選び方 */}
          <H2 id="erabikata" num="7">倉敷市の鍵業者の失敗しない選び方</H2>
          <p className="leading-loose mb-6">
            鍵業者選びで後悔しないためには、次の4つのステップを踏むことが大切です。引き戸の錠は開き戸より選べる製品が限られるため、事前に情報をそろえておくことがそのまま比較のしやすさにつながります。
          </p>
          {steps.map((s) => (
          ...
          {/* 8｜FAQ */}
          <H2 id="faq" num="8">倉敷市の鍵業者でよくある質問</H2>
          ...
          <p className="leading-loose mb-4">
            倉敷市で鍵開け・鍵交換を頼める主要5社を、一次確認した料金・受付時間・運営会社の情報で比較しました。スピード重視なら鍵の生活救急車やカギ110番、深夜・早朝の受付ならカギ110番・JBR・鍵のレスキュー、料金の明確さ重視なら鍵のレスキュー、というように、目的によって向いている業者は変わります。
          </p>
          <p className="leading-loose mb-8">
            古い住宅地が各所に残る倉敷市では、引き戸の玄関と長く使った錠が身近にあります。錠の位置と種類を知る、戸を替えずに補助錠を足す選択肢を持つ、回りにくくなっても無理に回さず建て付けを疑う。この3つを押さえておけば、実家や持ち家の引き戸錠を「どうにもならないもの」と先送りにせずに済みます。そのうえで、本記事の一次確認値を出発点に、戸の状態と予算に合った業者を選んでください。
          </p>
          ...
          <div className="mt-12">
            ...
            <ul className="flex flex-wrap gap-2">
              {["倉敷市", "引き戸錠", "補助錠", "古い持ち家", "防犯", "エリア別"].map((t) => (
                <li
                  key={t}
                  className="rounded-[2px] border border-border bg-white px-3 py-1.5 text-xs md:text-sm font-bold tracking-wide text-foreground shadow-[0px_2px_2px_0px_rgba(0,0,0,0.12)]"
                >
          ...
          <div className="mt-10">
            ...
            <ul className="grid gap-3 md:grid-cols-2">
              {[
                { href: "/hikido-kagi/", label: "引き戸の鍵交換・後付けの基礎" },
                { href: "/hojo-jou/", label: "補助錠の選び方" },
                { href: "/genkan-kagi-atozuke/", label: "玄関ドアの鍵の後付け方法" },
