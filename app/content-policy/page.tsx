          ...
          <div className="space-y-8 text-foreground">
            <section>
              <p className="leading-relaxed text-text-muted">
                「鍵トラブルナビ」は、鍵のトラブルで困っている方に、正確で信頼性の高い情報と優良業者をお届けすることを使命としています。本ポリシーでは、当サイトのコンテンツ制作における基準・方針を明示します。
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-text-muted leading-relaxed">
                本サービスは株式会社MediaXが運営しています。コンテンツの企画・執筆・編集は、鍵・セキュリティ分野の知識を持つ編集スタッフが担当しています。専門的な判断が必要な内容については、外部の専門家・実務経験者の監修を受けることがあります。
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-3 text-text-muted">
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1 shrink-0">●</span>
                  <span><span className="font-medium text-foreground">料金透明性：</span>見積もり方法、料金体系の明確さ、ぼったくりリスクの低さ</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1 shrink-0">●</span>
                  <span><span className="font-medium text-foreground">対応スピード：</span>受付時間（24時間対応か）、到着時間の速さ</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1 shrink-0">●</span>
                  <span><span className="font-medium text-foreground">技術力：</span>対応できる鍵の種類・難易度の幅広さ</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1 shrink-0">●</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1 shrink-0">●</span>
                  <span><span className="font-medium text-foreground">安心・安全：</span>保険加入、キャンセルポリシー</span>
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-3 text-text-muted">
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1 shrink-0">●</span>
                  <span>鍵トラブルで困っている読者の利益を最優先に考え、誇大広告や不正確な情報は掲載しません。</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary mt-1 shrink-0">●</span>
            ...
            <section>
              ...
              <div className="bg-white border border-border rounded-lg p-4 space-y-1 text-text-muted text-sm">
