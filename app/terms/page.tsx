          ...
          <div className="space-y-8 text-foreground">
            <section>
              <p className="leading-relaxed text-text-muted">
                本利用規約（以下「本規約」）は、株式会社MediaX（以下「当社」）が運営する「鍵トラブルナビ」（以下「本サービス」）の利用条件を定めるものです。ユーザーの皆さまには、本規約に同意のうえ、本サービスをご利用いただきます。
              </p>
            </section>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-3 text-text-muted">
                ...
                <li className="leading-relaxed">本サービスは、鍵業者に関する情報提供を目的としており、特定の業者を推薦・保証するものではありません。ユーザーと業者との間で生じた問題については、当社は一切の責任を負いません。</li>
              </ol>
            </section>
