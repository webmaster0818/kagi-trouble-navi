        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                政令市の区: <Link href="/area/yokohama-kohoku/" className="hover:text-white transition-colors">横浜市港北区</Link>・<Link href="/area/yokohama-tsurumi/" className="hover:text-white transition-colors">横浜市鶴見区</Link>・<Link href="/area/yokohama-totsuka/" className="hover:text-white transition-colors">横浜市戸塚区</Link>・<Link href="/area/yokohama-aoba/" className="hover:text-white transition-colors">横浜市青葉区</Link>・<Link href="/area/osaka-kita/" className="hover:text-white transition-colors">大阪市北区</Link>・<Link href="/area/osaka-chuo/" className="hover:text-white transition-colors">大阪市中央区</Link>・<Link href="/area/osaka-yodogawa/" className="hover:text-white transition-colors">大阪市淀川区</Link>・<Link href="/area/osaka-hirano/" className="hover:text-white transition-colors">大阪市平野区</Link>・<Link href="/area/nagoya-naka/" className="hover:text-white transition-colors">名古屋市中区</Link>・<Link href="/area/nagoya-chikusa/" className="hover:text-white transition-colors">名古屋市千種区</Link>・<Link href="/area/nagoya-meito/" className="hover:text-white transition-colors">名古屋市名東区</Link>・<Link href="/area/sapporo-chuo/" className="hover:text-white transition-colors">札幌市中央区</Link>・<Link href="/area/sapporo-kita/" className="hover:text-white transition-colors">札幌市北区</Link>・<Link href="/area/fukuoka-chuo/" className="hover:text-white transition-colors">福岡市中央区</Link>・<Link href="/area/fukuoka-hakata/" className="hover:text-white transition-colors">福岡市博多区</Link>・<Link href="/area/fukuoka-nishi/" className="hover:text-white transition-colors">福岡市西区</Link>・<Link href="/area/kawasaki-kawasaki/" className="hover:text-white transition-colors">川崎市川崎区</Link>・<Link href="/area/kawasaki-nakahara/" className="hover:text-white transition-colors">川崎市中原区</Link>・<Link href="/area/kobe-chuo/" className="hover:text-white transition-colors">神戸市中央区</Link>・<Link href="/area/kobe-nada/" className="hover:text-white transition-colors">神戸市灘区</Link>・<Link href="/area/kyoto-nakagyo/" className="hover:text-white transition-colors">京都市中京区</Link>・<Link href="/area/kyoto-fushimi/" className="hover:text-white transition-colors">京都市伏見区</Link>・<Link href="/area/hiroshima-naka/" className="hover:text-white transition-colors">広島市中区</Link>・<Link href="/area/saitama-omiya/" className="hover:text-white transition-colors">さいたま市大宮区</Link>
              </li>
              <li>
                東京23区: <Link href="/area/shinjuku-ku/" className="hover:text-white transition-colors">新宿区</Link>・<Link href="/area/setagaya-ku/" className="hover:text-white transition-colors">世田谷区</Link>・<Link href="/area/ota-ku/" className="hover:text-white transition-colors">大田区</Link>・<Link href="/area/nerima-ku/" className="hover:text-white transition-colors">練馬区</Link>・<Link href="/area/edogawa-ku/" className="hover:text-white transition-colors">江戸川区</Link>・<Link href="/area/adachi-ku/" className="hover:text-white transition-colors">足立区</Link>・<Link href="/area/suginami-ku/" className="hover:text-white transition-colors">杉並区</Link>・<Link href="/area/itabashi-ku/" className="hover:text-white transition-colors">板橋区</Link>・<Link href="/area/koto-ku/" className="hover:text-white transition-colors">江東区</Link>・<Link href="/area/katsushika-ku/" className="hover:text-white transition-colors">葛飾区</Link>・<Link href="/area/shinagawa-ku/" className="hover:text-white transition-colors">品川区</Link>・<Link href="/area/kita-ku/" className="hover:text-white transition-colors">北区</Link>・<Link href="/area/nakano-ku/" className="hover:text-white transition-colors">中野区</Link>・<Link href="/area/toshima-ku/" className="hover:text-white transition-colors">豊島区</Link>・<Link href="/area/meguro-ku/" className="hover:text-white transition-colors">目黒区</Link>・<Link href="/area/bunkyo-ku/" className="hover:text-white transition-colors">文京区</Link>・<Link href="/area/shibuya-ku/" className="hover:text-white transition-colors">渋谷区</Link>・<Link href="/area/minato-ku/" className="hover:text-white transition-colors">港区</Link>・<Link href="/area/chuo-ku/" className="hover:text-white transition-colors">中央区</Link>・<Link href="/area/chiyoda-ku/" className="hover:text-white transition-colors">千代田区</Link>・<Link href="/area/taito-ku/" className="hover:text-white transition-colors">台東区</Link>・<Link href="/area/sumida-ku/" className="hover:text-white transition-colors">墨田区</Link>・<Link href="/area/arakawa-ku/" className="hover:text-white transition-colors">荒川区</Link>
              </li>
            </ul>
          </div>
        </div>
